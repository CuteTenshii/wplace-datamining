...
function oe(e, r, t = !1) {
  ...
  const _ = (d, i) => {
    ...
    var v = K(),
      o = n;
    if (v && (u = document.createDocumentFragment(), u.append(o = q())), l ? a ?? (a = i && O(() => i(o))) : f ?? (f = i && O(() => i(o))), v) {
      var h = C,
        g = l ? a : f,
        s = l ? f : a;
...
function ve(e, r, t, n) {
  ...
  var _, d = !1;
  f ? [_, d] = fe(() => e[r]) : _ = e[r], _ === void 0 && n !== void 0 && (_ = S(), u && (a && $(), u(_)));
  var i;
  if (a ? i = () => {
      var s = e[r];
  ...
  if (u) {
    var E = e.$$legacy;
    return (function(s, b) {
      return arguments.length > 0 ? ((!a || !b || E || d) && u(b ? i() : s), s) : i()
    })
  }
  var v = !1,
    o = ((t & se) !== 0 ? H : V)(() => (v = !1, i()));
