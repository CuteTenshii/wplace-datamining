...
const s = () => "All Frames",
  ...
  lr = (t = {}, e = {}) => {
    const r = e.locale ?? n();
    return r === "en" ? s() : r === "pt" ? u() : r === "ch" ? a() : r === "de" ? o() : r === "es" ? c() : r === "fr" ? i() : r === "it" ? _() : r === "jp" ? l() : r === "pl" ? f() : r === "ru" ? d() : r === "uk" ? m() : p()
  },
  b = () => "Back to list",
  ...
  ur = () => "まだ購入できるフレームはありません。今後のアップデートをお待ちくださいね ;)",
  ...
  pr = (t = {}, e = {}) => {
    const r = e.locale ?? n();
    return r === "en" ? P() : r === "pt" ? $() : r === "ch" ? rr() : r === "de" ? er() : r === "es" ? tr() : r === "fr" ? nr() : r === "it" ? sr() : r === "jp" ? ur() : r === "pl" ? ar() : r === "ru" ? or() : r === "uk" ? cr() : ir()
  };
export {
