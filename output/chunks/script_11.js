...
class N {
  constructor(e, s = !0) {
    ...
    l(this, _, () => {
      ...
      if (t(this, n).has(e)) {
        ...
        if (a) S(a), t(this, u).delete(s);
          ...
          o && (t(this, c).set(s, o.effect), t(this, r).delete(s), o.fragment.lastChild.remove(), this.anchor.before(o.fragment), a = o.effect)
        }
        for (const [f, h] of t(this, n)) {
          if (t(this, n).delete(f), f === e) break;
          const d = t(this, r).get(h);
          d && (v(d.effect), t(this, r).delete(h))
        }
        for (const [f, h] of t(this, c)) {
          if (f === s || t(this, u).has(f)) continue;
          const d = () => {
            if (Array.from(t(this, n).values()).includes(f)) {
              var g = document.createDocumentFragment();
              R(h, g), g.append(I()), t(this, r).set(f, {
                effect: h,
                fragment: g
              })
            } else v(h);
            t(this, u).delete(f), t(this, c).delete(f)
          };
          t(this, p) || !a ? (t(this, u).add(f), T(h, d, !1)) : d()
        }
      }
    });
    l(this, m, e => {
    ...
    var a = E,
      o = C();
    if (s && !t(this, c).has(e) && !t(this, r).has(e))
      if (o) {
        var f = document.createDocumentFragment(),
          h = I();
        f.append(h), t(this, r).set(e, {
          effect: M(() => s(h)),
          fragment: f
        })
      } else t(this, c).set(e, M(() => s(this.anchor)));
    if (t(this, n).set(a, e), o) {
      for (const [d, b] of t(this, c)) d === e ? a.unskip_effect(b) : a.skip_effect(b);
...
n = new WeakMap, c = new WeakMap, r = new WeakMap, u = new WeakMap, p = new WeakMap, _ = new WeakMap, m = new WeakMap;
export {
  N as B
};