...
function W(r) {
  ...
  if (typeof r == "string" || typeof r == "number") t += r;
    ...
    if (Array.isArray(r)) {
      var f = r.length;
      for (i = 0; i < f; i++) r[i] && (e = W(r[i])) && (t && (t += " "), t += e)
    } else
...
function Or() {
  for (var r, i, e = 0, t = "", f = arguments.length; e < f; e++)(r = arguments[e]) && (i = W(r)) && (t && (t += " "), t += i);
  return t
}
  ...
  if (i) {
    ...
    if (Array.isArray(i) ? (t = i[0], f = i[1]) : t = i, r) {
      ...
      var a = !1,
        ...
        c = !1,
        n = [];
      t && n.push(...Object.keys(t).map(G)), f && n.push(...Object.keys(f).map(G));
      var b = 0,
        _ = -1;
      const E = r.length;
      for (var d = 0; d < E; d++) {
        var u = r[d];
        if (c ? u === "/" && r[d - 1] === "*" && (c = !1) : a ? a === u && (a = !1) : u === "/" && r[d + 1] === "*" ? c = !0 : u === '"' || u === "'" ? a = u : u === "(" ? s++ : u === ")" && s--, !c && a === !1 && s === 0) {
          if (u === ":" && _ === -1) _ = d;
          else if (u === ";" || d === E - 1) {
            if (_ !== -1) {
              var T = G(r.substring(b, _).trim());
              if (!n.includes(T)) {
                u !== ";" && d++;
                var S = r.substring(b, d).trim();
                e += " " + S + ";"
              }
            }
            b = d + 1, _ = -1
    ...
    return t && (e += F(t)), f && (e += F(f, !0)), e = e.trim(), e === "" ? null : e
  }
  return r == null ? null : String(r)
}

function Pr(r, i, e, t, f, a) {
  var s = r.__className;
  if (y || s !== e || s === void 0) {
    var c = wr(e, t, a);
    ...
    for (var n in a) {
      var b = !!a[n];
      (f == null || b !== !!f[n]) && r.classList.toggle(n, b)
    }
  return a
}
...
function R(r, i = {}, e, t) {
  for (var f in e) {
    var a = e[f];
    i[f] !== a && (e[f] == null ? r.style.removeProperty(f) : r.style.setProperty(f, a, t))
  }
}
...
function k(r, i, e, t) {
  var f = j(r);
  y && (f[i] = r.getAttribute(i), i === "src" || i === "srcset" || i === "href" && r.nodeName === Mr) || f[i] !== (f[i] = e) && (i === "loading" && (r[ur] = e), e == null ? r.removeAttribute(i) : typeof e != "string" && U(r).includes(i) ? r[i] = e : r.setAttribute(i, e))
}
...
function $r(r, i, e, t, f = !1, a = !1) {
  if (y && f && r.nodeName === Gr) {
    var s = r,
    ...
    if (!(l === h && !(l === void 0 && r.hasAttribute(o)))) {
      ...
      if ($ !== "$$")
        if ($ === "on") {
          ...
          let g = o.slice(2);
          var B = Nr(g);
          if (vr(g) && (g = g.slice(0, -7), A.capture = !0), !B && h) {
            if (l != null) continue;
      ...
      else if (!b && (o === "__value" || o === "value" && l != null)) r.value = r.__value = l;
      else if (o === "selected" && T) Ur(r, l);
      else {
        var v = o;
        _ || (v = Sr(v));
        var K = v === "defaultValue" || v === "defaultChecked";
        if (l == null && !b && !K)
          if (n[o] = null, v === "value" || v === "checked") {
            let A = r;
            const N = i === void 0;
            if (v === "value") {
              let g = A.defaultValue;
              A.removeAttribute(v), A.defaultValue = g, A.value = A.__value = N ? g : null
            } else {
              let g = A.defaultChecked;
              A.removeAttribute(v), A.defaultChecked = g, A.checked = N ? g : !1
            }
          } else r.removeAttribute(o);
        else K || E.includes(v) && (b || typeof l != "string") ? (r[v] = l, v in n && (n[v] = yr)) : typeof l != "function" && k(r, v, l)
      }
    }
  }
  return d && C(!0), u
...
function Fr(r, i, e = [], t = [], f = [], a, s = !1, c = !1) {
  cr(f, e, t, n => {
    var b = void 0,
      _ = {},
      d = r.nodeName === Dr,
...
function U(r) {
  ...
  if (e) return e;
  q.set(i, e = []);
  for (var t, f = r, a = Element.prototype; a !== f;) {
    t = dr(f);
