...
function i(q) {
  ...
  return new Promise((w, s) => {
    try {
      ...
      const r = t => {
        var A;
        ((A = t.data) == null ? void 0 : A.id) === V && (w(void 0), o.removeEventListener("message", r))
      };
      o.addEventListener("message", r);
      const g = navigator.serviceWorker.controller;
      g ? g.postMessage(e) : navigator.serviceWorker.ready.then(t => {
        const A = t.active;
...
export {
  Y as A, p as a, G as c, x as g, T as p, I as r, L as s
};