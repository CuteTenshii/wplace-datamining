  ...
  for (l = 0; l < y; l += 1) {
    if (A = r[l], _ = c(A, l), a = w.get(_), a === void 0) {
      ...
      if (h !== void 0) {
        ...
        n = z(R, e, n, n === null ? e.first : n.next, A, _, l, d, t, b)
      }
...
function z(f, r, e, s, u, d, t, c, b, m, o) {
  var y = B,
    w = (b & O) !== 0,
    S = (b & Te) === 0,
  ...
  try {
    ...
    return n.e = U(() => c(f, i, p, m), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    B = y
  }
}
