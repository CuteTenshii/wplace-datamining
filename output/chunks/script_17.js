...
var Hn = (t, n, e) => n in t ? Kn(t, n, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: e
}) : t[n] = e;
var F = (t, n, e) => Hn(t, typeof n != "symbol" ? n + "" : n, e),
  Yn = (t, n, e) => n.has(t) || xt("Cannot " + e);
var b = (t, n, e) => (Yn(t, n, "read from private field"), e ? e.call(t) : n.get(t)),
...
(function() {
  try {
    ...
    n && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[n] = "ff0f5e7a-14d2-4c7b-bc89-40e8b180f37e", t._sentryDebugIdIdentifier = "sentry-dbid-ff0f5e7a-14d2-4c7b-bc89-40e8b180f37e")
  } catch {}
})();
...
const tr = Jn.toLowerCase() !== "false",
  nr = "" + new URL("../assets/pawtect_wasm_bg.9gmZk8aU.wasm", import.meta.url).href;
var gt = function() {
  ...
  return e === void 0 && (e = 16), Q(this, void 0, void 0, function() {
    ...
    return ee(this, function(s) {
      switch (s.label) {
        ...
        case 1:
          return i < t.length ? (r[i] = n(t[i], i), o = Date.now(), o >= a + e ? (a = o, [4, rr()]) : [3, 3]) : [3, 4];
        case 2:
          s.sent(), s.label = 3;
        case 3:
          return ++i, [3, 1];
...
var ur = [4283543511, 3981806797],
  lr = [3301882366, 444984403];

function Ut(t) {
  var n = [0, t[0] >>> 1];
  L(t, n), Y(t, ur), n[1] = t[0] >>> 1, L(t, n), Y(t, lr), n[1] = t[0] >>> 1, L(t, n)
}
...
function fr(t, n) {
  ...
  var r = [0, e.length],
    ...
    l = [0, 0],
    _;
  for (_ = 0; _ < i; _ = _ + 16) u[0] = e[_ + 4] | e[_ + 5] << 8 | e[_ + 6] << 16 | e[_ + 7] << 24, u[1] = e[_] | e[_ + 1] << 8 | e[_ + 2] << 16 | e[_ + 3] << 24, l[0] = e[_ + 12] | e[_ + 13] << 8 | e[_ + 14] << 16 | e[_ + 15] << 24, l[1] = e[_ + 8] | e[_ + 9] << 8 | e[_ + 10] << 16 | e[_ + 11] << 24, Y(u, et), me(u, 31), Y(u, tt), L(o, u), me(o, 27), ie(o, s), Y(o, Ct), ie(o, dr), Y(l, tt), me(l, 33), Y(l, et), L(s, l), me(s, 31), ie(s, o), Y(s, Ct), ie(s, _r);
...
function yr() {
  var t = window,
    n = navigator;
  return q(["msWriteProfilerMark" in t, "MSStream" in t, "msLaunchUri" in n, "msSaveBlob" in n]) >= 3 && !yn()
}
...
function Xe() {
  var t = window;
  return pr(t.print) && String(t.browser) === "[object WebPageNamespace]"
}
...
function kr() {
  ...
  var s = xr(a),
    ...
    _ = Se(u.then(function(d) {
      return Dr(d.getChannelData(0).subarray(e))
    }, function(d) {
...
function Lr(t) {
  for (var n = sr(t), e = n[0], r = n[1], a = document.createElement(e ?? "div"), i = 0, o = Object.keys(r); i < o.length; i++) {
    var s = o[i],
      u = r[s].join(" ");
    s === "style" ? Mr(a.style, u) : a.setAttribute(s, u)
  }
  return a
}
...
function jr() {
  var t = this;
  return bn(function(n, e) {
    var r = e.document;
    return Q(t, void 0, void 0, function() {
      var a, i, o, s, u, l, _, d, p, y, E, g;
      return ee(this, function(T) {
        for (a = r.body, a.style.fontSize = Cr, i = r.createElement("div"), i.style.setProperty("visibility", "hidden", "important"), o = {}, s = {}, u = function(S) {
            var N = r.createElement("span"),
              C = N.style;
            return C.position = "absolute", C.top = "0", C.left = "0", C.fontFamily = S, N.textContent = Ur, i.appendChild(N), N
          }, l = function(S, N) {
            return u("'".concat(S, "',").concat(N))
          }, _ = function() {
            return pe.map(u)
          }, d = function() {
            for (var S = {}, N = function(w) {
            ...
            return pe.some(function(N, C) {
              return S[C].offsetWidth !== o[N] || S[C].offsetHeight !== s[N]
            })
...
function zr(t) {
  var n, e = !1,
    ...
    o = i[0],
    s = i[1];
  return Gr(o, s) ? (e = Wr(s), t ? r = a = "skipped" : (n = qr(o, s), r = n[0], a = n[1])) : r = a = "unsupported", {
    winding: e,
    geometry: r,
    text: a
  }
...
function Jr() {
  ...
  if (e !== void 0 && n.push([e]), Array.isArray(t.languages)) Je() && vr() || n.push(t.languages);
...
function aa() {
  if (ft === void 0) {
    var t = function() {
      var n = wt();
      yt(n) ? ft = setTimeout(t, na) : (nt = n, ft = void 0)
    };
    t()
  }
}
    ...
    function() {
      return Q(t, void 0, void 0, function() {
        ...
        return ee(this, function(e) {
          switch (e.label) {
            case 0:
              return n = wt(), yt(n) ? nt ? [2, pn([], nt, !0)] : Or() ? [4, Sr()] : [3, 2] : [3, 2];
            case 1:
...
function pa() {
  ...
  return t === "MacIntel" && X() && !Tt() ? Tr() ? "iPad" : "iPhone" : t
}
...
function va(t) {
  ...
  return Q(this, void 0, void 0, function() {
    ...
    return ee(this, function(l) {
      switch (l.label) {
        case 0:
          return ba() ? (r = ya(), a = Object.keys(r), i = (u = []).concat.apply(u, a.map(function(_) {
            return r[_]
          })), [4, Ea(i)]) : [2, void 0];
        case 1:
          return o = l.sent(), e && Ta(r, o), s = a.filter(function(_) {
            var d = r[_],
...
function Ea(t) {
  ...
  return Q(this, void 0, void 0, function() {
    ...
    return ee(this, function(l) {
      switch (l.label) {
        case 0:
          for (e = document, r = e.createElement("div"), a = new Array(t.length), i = {}, Bt(r), u = 0; u < t.length; ++u) o = Lr(t[u]), o.tagName === "DIALOG" && o.show(), s = e.createElement("div"), Bt(s), s.appendChild(o), r.appendChild(s), a[u] = o;
          l.label = 1;
        case 1:
...
function Pa() {
  return Ua(function(t, n) {
    ...
    for (var S = 0, N = Object.keys(mt); S < N.length; S++) {
      var o = N[S];
...
function Ua(t, n) {
  return n === void 0 && (n = 4e3), bn(function(e, r) {
    var a = r.document,
      i = a.body,
      o = i.style;
    ...
    return s.textContent = pn([], Array(n / 20 << 0), !0).map(function() {
      return "word"
...
var En = -1,
  ...
  qa = ["FRAGMENT_SHADER", "VERTEX_SHADER"],
  Ka = ["LOW_FLOAT", "MEDIUM_FLOAT", "HIGH_FLOAT", "LOW_INT", "MEDIUM_INT", "HIGH_INT"],
  On = "WEBGL_debug_renderer_info",
  Ha = "WEBGL_polygon_mode";
...
function Ya(t) {
  ...
  if (!u) return En;
  if (!An(u)) return Tn;
  var l = In() ? null : u.getExtension(On);
  return {
...
function Za(t) {
  ...
  for (var y = Kt(e), E = 0, g = y; E < g.length; E++) {
    var T = g[E],
      S = e[T];
    s.push("".concat(T, "=").concat(S).concat(Ga.has(S) ? "=".concat(e.getParameter(S)) : ""))
  }
  if (r)
    for (var N = 0, C = r; N < C.length; N++) {
      ...
      if (!(j === On && In() || j === Ha && Xa())) {
        ...
        for (var w = 0, O = Kt(H); w < O.length; w++) {
          var T = O[w],
            S = H[T];
          u.push("".concat(T, "=").concat(S).concat(Wa.has(S) ? "=".concat(e.getParameter(S)) : ""))
        }
      }
    }
  for (var v = 0, $ = qa; v < $.length; v++)
    for (var G = $[v], V = 0, te = Ka; V < te.length; V++) {
      var fe = te[V],
        dt = $a(e, G, fe);
...
var ti = {
  ...
  contrast: Ra,
  reducedMotion: Na,
  reducedTransparency: xa,
  hdr: Da,
  math: La,
  pdfViewerEnabled: Ca,
  architecture: ja,
  applePay: Fa,
  privateClickMeasurement: Va,
  audioBaseLatency: Qa,
  dateTimeLocale: ei,
  webGlBasics: Ya,
  webGlExtensions: Za
...
var ri = "$ if upgrade to Pro: https://fpjs.dev/pro";
...
function kn(t) {
  return JSON.stringify(t, function(n, e) {
    return e instanceof Error ? mr(e) : e
  }, 2)
}
...
function ci(t) {
  ...
  return {
    get visitorId() {
      return n === void 0 && (n = Rn(this.components)), n
    },
    set visitorId(r) {
      n = r
    },
      ...
      return Q(this, void 0, void 0, function() {
        ...
        return ee(this, function(s) {
          switch (s.label) {
            ...
            case 1:
              return i = s.sent(), o = ci(i), (n || r != null && r.debug) && console.log("Copy the text below to get the debug data:\n\n```\nversion: ".concat(o.version, `
userAgent: `).concat(navigator.userAgent, `
timeBetweenLoadAndGet: `).concat(a - e, `
visitorId: `).concat(o.visitorId, `
components: `).concat(kn(i), "\n```")), [2, o]
          }
        })
      })
    }
...
function di() {
  if (!(window.__fpjs_d_m || Math.random() >= .001)) try {
    ...
    t.open("get", "https://m1.openfpcdn.io/fingerprintjs/v".concat(hn, "/npm-monitoring"), !0), t.send()
  } catch (n) {
    console.error(n)
  }
}
...
function _i(t) {
  ...
  return t === void 0 && (t = {}), Q(this, void 0, void 0, function() {
    ...
    return ee(this, function(i) {
      switch (i.label) {
        case 0:
          return (!((n = t.monitoring) !== null && n !== void 0) || n) && di(), e = t.delayFallback, r = t.debug, [4, ui(e)];
        case 1:
          return i.sent(), a = ni({
            cache: {},
            debug: r
...
let pt = null,
  ot;
async function fi() {
  return pt || (pt = Nn.load()), pt
}
async function st() {
  return ot || mi().then(t => t.visitorId)
}
async function mi() {
  const n = await (await fi()).get(),
    {
      languages: e,
      fontPreferences: r,
      dateTimeLocale: a,
...
const pi = () => "Your account has been suspended for breaking the rules",
  hi = () => "Sua conta foi suspensa por quebrar as regras",
  gi = () => "您的账号因违反规则已被暂停",
  wi = () => "Dein Konto wurde wegen Regelverstößen gesperrt",
  yi = () => "Tu cuenta ha sido suspendida por infringir las regras",
  vi = () => "Votre compte a été suspendu pour avoir enfreint les règles",
  bi = () => "Il tuo account è stato sospeso per aver infranto le regole",
  Ei = () => "ルール違反により、あなたのアカウントは一時停止されています。",
  Ti = () => "Twoje konto zostało zawieszone za łamanie zasad",
  Oi = () => "Ваш аккаунт был временно заблокирован за нарушение правил",
  Si = () => "Ваш обліковий запис було призупинено за порушення правил",
  Ii = () => "Tài khoản của bạn đã bị tạm đình chỉ vì vi phạm luật",
  Ai = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? pi() : e === "pt" ? hi() : e === "ch" ? gi() : e === "de" ? wi() : e === "es" ? yi() : e === "fr" ? vi() : e === "it" ? bi() : e === "jp" ? Ei() : e === "pl" ? Ti() : e === "ru" ? Oi() : e === "uk" ? Si() : Ii()
  },
  ki = () => "Alliance name already taken",
  Ri = () => "Já possui uma aliança com esse nome",
  Ni = () => "该联盟名称已被占用",
  xi = () => "Der Allianzname ist bereits vergeben",
  Di = () => "Ese nombre de alianza ya está en uso",
  Li = () => "Ce nom d’alliance est déjà pris",
  Mi = () => "Esiste già un'alleanza con questo nome",
  Pi = () => "このアライアンス名は既に使用されています。",
  Ui = () => "Nazwa sojuszu jest już zajęta",
  Ci = () => "Такое название альянса уже используется",
  ji = () => "Назва альянсу вже зайнята",
  Fi = () => "Tên liên minh đã được sử dụng",
  Bi = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? ki() : e === "pt" ? Ri() : e === "ch" ? Ni() : e === "de" ? xi() : e === "es" ? Di() : e === "fr" ? Li() : e === "it" ? Mi() : e === "jp" ? Pi() : e === "pl" ? Ui() : e === "ru" ? Ci() : e === "uk" ? ji() : Fi()
  },
  zi = () => "Alliance name exceeded the maximum number of characters",
  Vi = () => "O nome da aliança excedeu o número máximo de caracteres",
  Gi = () => "联盟名称超过最大字符数限制",
  Wi = () => "Der Allianzname überschreitet die maximale Zeichenanzahl",
  qi = () => "El nombre de la alianza superó el número máximo de caracteres",
  Ki = () => "Le nom de l’alliance a dépassé le nombre maximal de caractères",
  Hi = () => "Il nome dell'alleanza ha superato il numero massimo di caratteri",
  Yi = () => "アライアンス名が最大文字数を超えています。",
  Zi = () => "Nazwa sojuszu przekroczyła maksymalną liczbę znaków",
  $i = () => "Название альянса превышает максимальную длину",
  Ji = () => "Назва альянсу перевищує максимально допустиму кількість символів",
  Xi = () => "Tên liên minh vượt quá số ký tự cho phép",
  Qi = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? zi() : e === "pt" ? Vi() : e === "ch" ? Gi() : e === "de" ? Wi() : e === "es" ? qi() : e === "fr" ? Ki() : e === "it" ? Hi() : e === "jp" ? Yi() : e === "pl" ? Zi() : e === "ru" ? $i() : e === "uk" ? Ji() : Xi()
  },
  eo = () => "Alliance with empty name",
  to = () => "Aliança com nome vazio",
  no = () => "名称为空的联盟",
  ro = () => "Allianz mit leerem Namen",
  ao = () => "Alianza con nombre vacío",
  io = () => "Alliance avec nom vide",
  oo = () => "Alleanza con nome vuoto",
  so = () => "名前が空のアライアンスです。",
  co = () => "Sojusz z pustą nazwą",
  uo = () => "Альянс с пустым названием",
  lo = () => "Альянс із порожньою назвою",
  _o = () => "Liên minh không có tên",
  fo = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? eo() : e === "pt" ? to() : e === "ch" ? no() : e === "de" ? ro() : e === "es" ? ao() : e === "fr" ? io() : e === "it" ? oo() : e === "jp" ? so() : e === "pl" ? co() : e === "ru" ? uo() : e === "uk" ? lo() : _o()
  },
  mo = () => "Botting",
  po = () => "Uso de bots",
  ho = () => "脚本",
  ...
  Io = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? mo() : e === "pt" ? po() : e === "ch" ? ho() : e === "de" ? go() : e === "es" ? wo() : e === "fr" ? yo() : e === "it" ? vo() : e === "jp" ? bo() : e === "pl" ? Eo() : e === "ru" ? To() : e === "uk" ? Oo() : So()
  },
  Ao = () => "Use of software to completely automate painting",
  ko = () => "Uso de software para pintar de forma completamente automatizada ",
  Ro = () => "使用软件完全自动化绘制",
  No = () => "Verwendung von Software, um das Malen vollständig zu automatisieren",
  xo = () => "Uso de software para automatizar completamente la pintura",
  Do = () => "Utilisation de logiciels pour automatiser complètement la peinture",
  Lo = () => "Uso di software per dipingere in modo completamente automatizzato",
  Mo = () => "ペイントを完全に自動化するソフトウェアの使用",
  Po = () => "Używanie oprogramowania do całkowicie zautomatyzowanego malowania",
  Uo = () => "Использование программ для полной автоматизации рисования",
  Co = () => "Використання програм, які повністю автоматизують малювання",
  jo = () => "Sử dụng phần mềm để tự động hóa hoàn toàn việc tô pixel",
  Fo = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Ao() : e === "pt" ? ko() : e === "ch" ? Ro() : e === "de" ? No() : e === "es" ? xo() : e === "fr" ? Do() : e === "it" ? Lo() : e === "jp" ? Mo() : e === "pl" ? Po() : e === "ru" ? Uo() : e === "uk" ? Co() : jo()
  },
  Bo = () => "Breaking the rules",
  zo = () => "Quebrar as regras",
  Vo = () => "违反规则",
  Go = () => "Regeln brechen",
  Wo = () => "Romper las reglas",
  qo = () => "Violation des règles",
  Ko = () => "Violazione delle regole",
  Ho = () => "ルール違反",
  Yo = () => "Łamanie zasad",
  Zo = () => "Нарушение правил",
  $o = () => "Порушення правил",
  ...
  Xo = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Bo() : e === "pt" ? zo() : e === "ch" ? Vo() : e === "de" ? Go() : e === "es" ? Wo() : e === "fr" ? qo() : e === "it" ? Ko() : e === "jp" ? Ho() : e === "pl" ? Yo() : e === "ru" ? Zo() : e === "uk" ? $o() : Jo()
  },
  Qo = () => "You have broken one of Wplace's rules",
  es = () => "Você quebrou uma das regras do Wplace",
  ts = () => "你违反了 Wplace 的一项规则",
  ns = () => "Du hast gegen eine der Wplace-Regeln verstoßen",
  rs = () => "Has infringido una de las reglas de Wplace",
  as = () => "Vous avez enfreint l’une des règles de Wplace",
  is = () => "Hai infranto una delle regole di Wplace",
  os = () => "Wplaceのルールのいずれかに違反しました。",
  ss = () => "Złamałeś jedną z zasad Wplace",
  cs = () => "Вы нарушили одно из правил Wplace",
  us = () => "Ви порушили одне з правил Wplace",
  ls = () => "Bạn đã vi phạm một trong các luật của Wplace",
  ds = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Qo() : e === "pt" ? es() : e === "ch" ? ts() : e === "de" ? ns() : e === "es" ? rs() : e === "fr" ? as() : e === "it" ? is() : e === "jp" ? os() : e === "pl" ? ss() : e === "ru" ? cs() : e === "uk" ? us() : ls()
  },
  _s = () => "You cannot paint over event pixels",
  fs = () => "Você não pode pintar sobre pixels de eventos",
  ms = () => "你不能覆盖活动像素",
  ps = () => "Du kannst nicht über Event-Pixel malen",
  hs = () => "No puedes pintar sobre píxeles de evento",
  gs = () => "Vous ne pouvez pas peindre sur des pixels d’événement",
  ws = () => "Non puoi dipingere sopra i pixel dell'evento",
  ys = () => "イベント用のピクセルの上には塗れません。",
  vs = () => "Nie możesz malować po pikselach wydarzenia",
  bs = () => "Вы не можете рисовать по пикселям события",
  Es = () => "Ви не можете малювати поверх пікселів події",
  Ts = () => "Bạn không thể tô lên pixel sự kiện",
  Ht = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? _s() : e === "pt" ? fs() : e === "ch" ? ms() : e === "de" ? ps() : e === "es" ? hs() : e === "fr" ? gs() : e === "it" ? ws() : e === "jp" ? ys() : e === "pl" ? vs() : e === "ru" ? bs() : e === "uk" ? Es() : Ts()
  },
  Os = () => "Can't reach the server. Maybe you are without internet connection or the server is down. Try again later",
  Ss = () => "Não é possível acessar o servidor. Talvez você esteja sem conexão com a internet ou o servidor esteja fora do ar. Tente novamente mais tarde.",
  Is = () => "无法连接到服务器。可能是你没有网络，或服务器已离线。请稍后重试。",
  As = () => "Server nicht erreichbar. Vielleicht hast du keine Internetverbindung oder der Server ist offline. Versuche es später erneut.",
  ks = () => "No se puede conectar con el servidor. Puede que estés sin internet o el servidor esté caído. Inténtalo de nuevo más tarde.",
  Rs = () => "Impossible d’atteindre le serveur. Vous n’êtes peut-être pas connecté à Internet ou le serveur est hors ligne. Réessayez plus tard.",
  Ns = () => "Impossibile contattare il server. Forse sei senza connessione o il server è offline. Riprova più tardi.",
  xs = () => "サーバーに接続できません。インターネットに接続されていないか、サーバーが停止している可能性があります。しばらくしてからもう一度お試しください。",
  Ds = () => "Nie można połączyć się z serwerem. Być może nie masz internetu lub serwer nie działa. Spróbuj ponownie później.",
  Ls = () => "Не удаётся подключиться к серверу. Возможно, у вас нет доступа к интернету или сервер недоступен. Попробуйте позже.",
  Ms = () => "Не вдається підключитися до сервера. Можливо, у вас немає інтернет-зʼєднання або сервер недоступний. Спробуйте пізніше.",
  Ps = () => "Không thể kết nối tới máy chủ. Có thể bạn đang mất kết nối mạng hoặc máy chủ đang tạm ngưng. Hãy thử lại sau",
  Us = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Os() : e === "pt" ? Ss() : e === "ch" ? Is() : e === "de" ? As() : e === "es" ? ks() : e === "fr" ? Rs() : e === "it" ? Ns() : e === "jp" ? xs() : e === "pl" ? Ds() : e === "ru" ? Ls() : e === "uk" ? Ms() : Ps()
  },
  Cs = () => "Challenge verification not completed",
  js = () => "Verificação do desafio não concluída",
  Fs = () => "挑战验证未完成",
  Bs = () => "Herausforderungsverifizierung nicht abgeschlossen",
  zs = () => "Verificación del desafío no completada",
  Vs = () => "Vérification du défi non terminée",
  Gs = () => "Verifica della sfida non completata",
  Ws = () => "チャレンジ検証が完了していません",
  qs = () => "Weryfikacja wyzwania niezakończona",
  Ks = () => "Верификация вызова не завершена",
  Hs = () => "Перевірку виклику не завершено",
  Ys = () => "Xác minh thử thách chưa hoàn thành",
  Yt = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Cs() : e === "pt" ? js() : e === "ch" ? Fs() : e === "de" ? Bs() : e === "es" ? zs() : e === "fr" ? Vs() : e === "it" ? Gs() : e === "jp" ? Ws() : e === "pl" ? qs() : e === "ru" ? Ks() : e === "uk" ? Hs() : Ys()
  },
  Zs = () => "Couldn't complete the purchase. This item does not exist.",
  $s = () => "Não foi possível concluir a compra. Este item não existe.",
  Js = () => "无法完成购买。该物品不存在。",
  Xs = () => "Kauf konnte nicht abgeschlossen werden. Dieses Item existiert nicht.",
  Qs = () => "No se pudo completar la compra. Este ítem no existe.",
  ec = () => "Achat impossible. Cet objet n’existe pas.",
  tc = () => "Impossibile completare l'acquisto. Questo oggetto non esiste.",
  nc = () => "購入を完了できませんでした。このアイテムは存在しません。",
  rc = () => "Nie udało się dokończyć zakupu. Ten przedmiot nie istnieje.",
  ac = () => "Не удалось завершить покупку. Этот предмет не существует.",
  ic = () => "Не вдалося завершити покупку. Цей предмет не існує.",
  oc = () => "Không thể hoàn tất giao dịch. Vật phẩm này không tồn tại.",
  Zt = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Zs() : e === "pt" ? $s() : e === "ch" ? Js() : e === "de" ? Xs() : e === "es" ? Qs() : e === "fr" ? ec() : e === "it" ? tc() : e === "jp" ? nc() : e === "pl" ? rc() : e === "ru" ? ac() : e === "uk" ? ic() : oc()
  },
  sc = () => "We’re currently experiencing high traffic. Some requests may not be processed at this time—please try again later. Thank you for your patience.",
  cc = () => "Estamos enfrentando um volume alto de acessos no momento. Algumas solicitações podem não ser processadas agora — por favor, tente novamente mais tarde. Agradecemos a sua compreensão.",
  uc = () => "我们当前正遭遇高流量。一些请求可能无法立即处理——请稍后再试。感谢你的耐心。",
  lc = () => "Wir haben gerade sehr viel Traffic. Einige Anfragen können momentan nicht verarbeitet werden – bitte versuche es später erneut. Danke für deine Geduld.",
  dc = () => "Actualmente estamos recibiendo mucho tráfico. Es posible que algunas solicitudes no se procesen en este momento; inténtalo de nuevo más tarde. Gracias por tu paciencia.",
  _c = () => "Nous subissons actuellement un trafic élevé. Certaines requêtes peuvent ne pas être traitées pour le moment — veuillez réessayer plus tard. Merci pour votre patience.",
  fc = () => "Stiamo affrontando un elevato volume di accessi in questo momento. Alcune richieste potrebbero non essere elaborate ora — riprova più tardi. Grazie per la comprensione.",
  mc = () => "現在アクセスが集中しています。一部のリクエストが処理されない場合があります。しばらくしてからもう一度お試しください。ご理解ありがとうございます。",
  pc = () => "Obecnie doświadczamy dużego ruchu. Niektóre żądania mogą nie zostać teraz przetworzone — spróbuj ponownie później. Dziękujemy za cierpliwość.",
  hc = () => "Сейчас мы испытываем очень высокую нагрузку. Некоторые запросы могут не обрабатываться — попробуйте позже. Спасибо за ваше терпение.",
  gc = () => "Зараз ми отримуємо великий обсяг трафіку. Деякі запити можуть тимчасово не оброблятися — будь ласка, спробуйте пізніше. Дякуємо за розуміння.",
  wc = () => "Hiện chúng tôi đang chịu lượng truy cập rất cao. Một số yêu cầu có thể không được xử lý ngay bây giờ — hãy thử lại sau. Cảm ơn bạn đã thông cảm.",
  $t = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? sc() : e === "pt" ? cc() : e === "ch" ? uc() : e === "de" ? lc() : e === "es" ? dc() : e === "fr" ? _c() : e === "it" ? fc() : e === "jp" ? mc() : e === "pl" ? pc() : e === "ru" ? hc() : e === "uk" ? gc() : wc()
  },
  yc = () => "Doxxing",
  vc = () => "Doxxing",
  bc = () => "人肉搜索",
  ...
  xc = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? yc() : e === "pt" ? vc() : e === "ch" ? bc() : e === "de" ? Ec() : e === "es" ? Tc() : e === "fr" ? Oc() : e === "it" ? Sc() : e === "jp" ? Ic() : e === "pl" ? Ac() : e === "ru" ? kc() : e === "uk" ? Rc() : Nc()
  },
  Dc = () => "Released other's personal information without their consent",
  Lc = () => "Vazar informações pessoais de terceiros sem consentimento",
  Mc = () => "在未获同意的情况下公开他人个人信息",
  Pc = () => "Persönliche Daten anderer ohne deren Zustimmung veröffentlicht",
  Uc = () => "Divulgó información personal de otra persona sin su consentimiento",
  Cc = () => "Diffusion des informations personnelles de quelqu’un sans son consentement",
  jc = () => "Diffusione di informazioni personali di terzi senza consenso",
  Fc = () => "他人の個人情報を同意なく公開した。",
  Bc = () => "Udostępnianie cudzych danych osobowych bez ich zgody",
  zc = () => "Публикация личной информации других людей без их согласия",
  Vc = () => "Розповсюдження особистої інформації інших людей без їхньої згоди",
  Gc = () => "Công khai thông tin cá nhân của người khác mà không có sự cho phép",
  Wc = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Dc() : e === "pt" ? Lc() : e === "ch" ? Mc() : e === "de" ? Pc() : e === "es" ? Uc() : e === "fr" ? Cc() : e === "it" ? jc() : e === "jp" ? Fc() : e === "pl" ? Bc() : e === "ru" ? zc() : e === "uk" ? Vc() : Gc()
  },
  qc = () => "This email is already in use.",
  Kc = () => "Este e-mail já está em uso.",
  Hc = () => "This email is already in use.",
  Yc = () => "This email is already in use.",
  Zc = () => "Este correo electrónico ya está en uso.",
  $c = () => "This email is already in use.",
  Jc = () => "Questa email è già in uso.",
  Xc = () => "This email is already in use.",
  Qc = () => "This email is already in use.",
  eu = () => "This email is already in use.",
  tu = () => "This email is already in use.",
  nu = () => "This email is already in use.",
  ru = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? qc() : e === "pt" ? Kc() : e === "ch" ? Hc() : e === "de" ? Yc() : e === "es" ? Zc() : e === "fr" ? $c() : e === "it" ? Jc() : e === "jp" ? Xc() : e === "pl" ? Qc() : e === "ru" ? eu() : e === "uk" ? tu() : nu()
  },
  au = t => `This email is already in use by user #${t.userId}.`,
  iu = t => `Este e-mail já está em uso pelo usuário #${t.userId}.`,
  ou = t => `This email is already in use by user #${t.userId}.`,
  su = t => `This email is already in use by user #${t.userId}.`,
  cu = t => `Este correo electrónico ya está en uso por el usuario #${t.userId}.`,
  uu = t => `This email is already in use by user #${t.userId}.`,
  lu = t => `Questa email è già in uso dall'utente #${t.userId}.`,
  ...
  pu = t => `This email is already in use by user #${t.userId}.`,
  hu = (t, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? au(t) : e === "pt" ? iu(t) : e === "ch" ? ou(t) : e === "de" ? su(t) : e === "es" ? cu(t) : e === "fr" ? uu(t) : e === "it" ? lu(t) : e === "jp" ? du(t) : e === "pl" ? _u(t) : e === "ru" ? fu(t) : e === "uk" ? mu(t) : pu(t)
  },
  gu = () => "Enter a valid email address.",
  wu = () => "Informe um endereço de e-mail válido.",
  yu = () => "Enter a valid email address.",
  vu = () => "Enter a valid email address.",
  bu = () => "Introduce una dirección de correo electrónico válida.",
  ...
  ku = () => "Enter a valid email address.",
  Ru = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? gu() : e === "pt" ? wu() : e === "ch" ? yu() : e === "de" ? vu() : e === "es" ? bu() : e === "fr" ? Eu() : e === "it" ? Tu() : e === "jp" ? Ou() : e === "pl" ? Su() : e === "ru" ? Iu() : e === "uk" ? Au() : ku()
  },
  Nu = t => `Error while painting: ${t.err}`,
  xu = t => `Erro enquanto pinta: ${t.err}`,
  Du = t => `绘制时出错：${t.err}`,
  Lu = t => `Fehler beim Malen: ${t.err}`,
  Mu = t => `Error al pintar: ${t.err}`,
  Pu = t => `Erreur lors de la peinture : ${t.err}`,
  Uu = t => `Errore durante la pittura: ${t.err}`,
  Cu = t => `ペイント中にエラーが発生しました: ${t.err}`,
  ju = t => `Błąd podczas malowania: ${t.err}`,
  Fu = t => `Ошибка при рисовании: ${t.err}`,
  Bu = t => `Помилка під час малювання: ${t.err}`,
  zu = t => `Lỗi khi tô: ${t.err}`,
  Vu = (t, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Nu(t) : e === "pt" ? xu(t) : e === "ch" ? Du(t) : e === "de" ? Lu(t) : e === "es" ? Mu(t) : e === "fr" ? Pu(t) : e === "it" ? Uu(t) : e === "jp" ? Cu(t) : e === "pl" ? ju(t) : e === "ru" ? Fu(t) : e === "uk" ? Bu(t) : zu(t)
  },
  Gu = () => "Exceeded maximum number of characters",
  Wu = () => "Excedeu o número máximo de caracteres permitidos",
  qu = () => "超出最大字符数",
  Ku = () => "Maximale Zeichenanzahl überschritten",
  Hu = () => "Se excedió el número máximo de caracteres",
  Yu = () => "Nombre maximal de caractères dépassé",
  Zu = () => "Numero massimo di caratteri superato",
  $u = () => "最大文字数を超過しました",
  Ju = () => "Przekroczono maksymalną liczbę znaków",
  Xu = () => "Превышено максимальное количество символов",
  Qu = () => "Перевищено максимальну кількість символів",
  el = () => "Đã vượt quá số ký tự tối đa",
  tl = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Gu() : e === "pt" ? Wu() : e === "ch" ? qu() : e === "de" ? Ku() : e === "es" ? Hu() : e === "fr" ? Yu() : e === "it" ? Zu() : e === "jp" ? $u() : e === "pl" ? Ju() : e === "ru" ? Xu() : e === "uk" ? Qu() : el()
  },
  nl = () => "Verification code expired. Please request a new one.",
  rl = () => "Código de verificação expirado. Por favor, solicite um novo.",
  al = () => "验证码已过期，请重新获取。",
  il = () => "Bestätigungscode abgelaufen. Bitte fordern Sie einen neuen an.",
  ol = () => "Código de verificación expirado. Por favor, solicita uno nuevo.",
  sl = () => "Code de vérification expiré. Veuillez en demander un nouveau.",
  cl = () => "Codice di verifica scaduto. Per favore, richiedine uno nuovo.",
  ul = () => "確認コードの有効期限が切れました。新しいコードをリクエストしてください。",
  ll = () => "Kod weryfikacyjny wygasł. Poproś o nowy.",
  dl = () => "Код подтверждения истёк. Пожалуйста, запросите новый.",
  _l = () => "Код підтвердження закінчився. Будь ласка, запросіть новий.",
  fl = () => "Mã xác minh đã hết hạn. Vui lòng yêu cầu mã mới.",
  ml = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? nl() : e === "pt" ? rl() : e === "ch" ? al() : e === "de" ? il() : e === "es" ? ol() : e === "fr" ? sl() : e === "it" ? cl() : e === "jp" ? ul() : e === "pl" ? ll() : e === "ru" ? dl() : e === "uk" ? _l() : fl()
  },
  pl = () => "Griefing",
  hl = () => "Griefing",
  gl = () => "破坏行为",
  ...
  Al = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? pl() : e === "pt" ? hl() : e === "ch" ? gl() : e === "de" ? wl() : e === "es" ? yl() : e === "fr" ? vl() : e === "it" ? bl() : e === "jp" ? El() : e === "pl" ? Tl() : e === "ru" ? Ol() : e === "uk" ? Sl() : Il()
  },
  kl = () => "Messed up artworks for no reason",
  Rl = () => "Estragar desenho dos outros sem motivo",
  Nl = () => "无缘无故毁坏他人的作品",
  xl = () => "Kunstwerke ohne Grund zerstört",
  Dl = () => "Arruinó obras de arte sin motivo",
  Ll = () => "Gâcher les dessins des autres sans raison",
  Ml = () => "Rovinare il disegno degli altri senza motivo",
  Pl = () => "理由もなく他人の作品を荒らした。",
  Ul = () => "Niszczenie cudzych prac bez powodu",
  Cl = () => "Преднамеренная порча чужих рисунков без причины",
  jl = () => "Псування чужих робіт без причини",
  Fl = () => "Phá hỏng tranh của người khác mà không có lý do",
  Bl = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? kl() : e === "pt" ? Rl() : e === "ch" ? Nl() : e === "de" ? xl() : e === "es" ? Dl() : e === "fr" ? Ll() : e === "it" ? Ml() : e === "jp" ? Pl() : e === "pl" ? Ul() : e === "ru" ? Cl() : e === "uk" ? jl() : Fl()
  },
  zl = () => "Hate speech",
  Vl = () => "Discurso de Ódio",
  Gl = () => "仇恨言论",
  ...
  Ql = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? zl() : e === "pt" ? Vl() : e === "ch" ? Gl() : e === "de" ? Wl() : e === "es" ? ql() : e === "fr" ? Kl() : e === "it" ? Hl() : e === "jp" ? Yl() : e === "pl" ? Zl() : e === "ru" ? $l() : e === "uk" ? Jl() : Xl()
  },
  ed = () => "Racism, homophobia, hate groups, ...",
  td = () => "Racismo, homofobia, grupos de ódio, ...",
  nd = () => "种族主义、恐同、仇恨团体等",
  rd = () => "Rassismus, Homophobie, Hassgruppen, ...",
  ad = () => "Racismo, homofobia, grupos de odio, ...",
  id = () => "Racisme, homophobie, groupes haineux, ...",
  od = () => "Razzismo, omofobia, gruppi d'odio, ...",
  sd = () => "人種差別、同性愛差別、ヘイト団体など。",
  cd = () => "Rasizm, homofobia, grupy nienawiści, ...",
  ud = () => "Расизм, гомофобия, группы ненависти и т.п.",
  ld = () => "Расизм, гомофобія, групи ненависті, ...",
  dd = () => "Phân biệt chủng tộc, kỳ thị LGBT, nhóm thù hận, ...",
  _d = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? ed() : e === "pt" ? td() : e === "ch" ? nd() : e === "de" ? rd() : e === "es" ? ad() : e === "fr" ? id() : e === "it" ? od() : e === "jp" ? sd() : e === "pl" ? cd() : e === "ru" ? ud() : e === "uk" ? ld() : dd()
  },
  fd = () => "Inappropriate content",
  md = () => "Conteúdo inapropriado",
  pd = () => "不当内容",
  hd = () => "Unangemessene Inhalte",
  gd = () => "Contenido inapropiado",
  wd = () => "Contenu inapproprié",
  yd = () => "Contenuto inappropriato",
  vd = () => "不適切なコンテンツ",
  bd = () => "Nieodpowiednie treści",
  Ed = () => "Неприемлемый контент",
  Td = () => "Неприйнятний вміст",
  Od = () => "Nội dung không phù hợp",
  Sd = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? fd() : e === "pt" ? md() : e === "ch" ? pd() : e === "de" ? hd() : e === "es" ? gd() : e === "fr" ? wd() : e === "it" ? yd() : e === "jp" ? vd() : e === "pl" ? bd() : e === "ru" ? Ed() : e === "uk" ? Td() : Od()
  },
  Id = () => "+18, inappropriate link, highly suggestive content, ...",
  Ad = () => "+18, links inapropriados, conteúdo altamente sugestivo, ...",
  kd = () => "+18、违规链接、高度暗示性内容等",
  Rd = () => "+18, unangemessene Links, stark anzügliche Inhalte, ...",
  Nd = () => "+18, enlace inapropiado, contenido muy sugerente, ...",
  xd = () => "+18, lien inapproprié, contenu très suggestif, ...",
  Dd = () => "+18, link inappropriati, contenuto altamente esplicito, ...",
  Ld = () => "18禁コンテンツ、不適切なリンク、過度に性的な内容など。",
  Md = () => "+18, nieodpowiedni link, mocno sugestywne treści, ...",
  Pd = () => "+18, неприемлемые ссылки, крайне откровенный контент и т.п.",
  Ud = () => "+18, неприйнятні посилання, дуже відвертий контент, ...",
  Cd = () => "+18, liên kết không phù hợp, nội dung khiêu gợi mạnh, ...",
  jd = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Id() : e === "pt" ? Ad() : e === "ch" ? kd() : e === "de" ? Rd() : e === "es" ? Nd() : e === "fr" ? xd() : e === "it" ? Dd() : e === "jp" ? Ld() : e === "pl" ? Md() : e === "ru" ? Pd() : e === "uk" ? Ud() : Cd()
  },
  Fd = () => "Invalid captcha",
  Bd = () => "Captcha inválido",
  zd = () => "验证码无效",
  Vd = () => "Ungültiges Captcha",
  Gd = () => "Captcha inválido. Por favor, inténtelo de nuevo.",
  Wd = () => "Captcha invalide",
  qd = () => "Captcha non valido. Riprova.",
  Kd = () => "キャプチャが無効です。",
  Hd = () => "Nieprawidłowy captcha",
  Yd = () => "Неверная капча",
  Zd = () => "Неправильна капча",
  $d = () => "Captcha không hợp lệ",
  Jd = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Fd() : e === "pt" ? Bd() : e === "ch" ? zd() : e === "de" ? Vd() : e === "es" ? Gd() : e === "fr" ? Wd() : e === "it" ? qd() : e === "jp" ? Kd() : e === "pl" ? Hd() : e === "ru" ? Yd() : e === "uk" ? Zd() : $d()
  },
  Xd = () => "Invalid challenge response",
  Qd = () => "Resposta de desafio inválida",
  e_ = () => "质询响应无效",
  t_ = () => "Ungültige Challenge-Antwort",
  n_ = () => "Respuesta de desafío inválida",
  r_ = () => "Réponse au défi invalide",
  a_ = () => "Risposta alla sfida non valida",
  i_ = () => "無効なチャレンジ応答",
  o_ = () => "Nieprawidłowa odpowiedź na wyzwanie",
  s_ = () => "Неверный ответ на вызов",
  c_ = () => "Недійсна відповідь на виклик",
  u_ = () => "Phản hồi thử thách không hợp lệ",
  l_ = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Xd() : e === "pt" ? Qd() : e === "ch" ? e_() : e === "de" ? t_() : e === "es" ? n_() : e === "fr" ? r_() : e === "it" ? a_() : e === "jp" ? i_() : e === "pl" ? o_() : e === "ru" ? s_() : e === "uk" ? c_() : u_()
  },
  d_ = () => "Invalid code",
  __ = () => "Código inválido",
  f_ = () => "验证码无效",
  ...
  p_ = () => "Código inválido",
  h_ = () => "Code invalide",
  g_ = () => "Codice non valido",
  w_ = () => "無効なコードです。",
  y_ = () => "Nieprawidłowy kod",
  v_ = () => "Неверный код",
  b_ = () => "Невірний код",
  E_ = () => "Mã không hợp lệ",
  T_ = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? d_() : e === "pt" ? __() : e === "ch" ? f_() : e === "de" ? m_() : e === "es" ? p_() : e === "fr" ? h_() : e === "it" ? g_() : e === "jp" ? w_() : e === "pl" ? y_() : e === "ru" ? v_() : e === "uk" ? b_() : E_()
  },
  O_ = () => "Invalid discord.",
  S_ = () => "Discord inválido.",
  I_ = () => "无效的 Discord。",
  A_ = () => "Ungültiger Discord.",
  k_ = () => "Discord inválido.",
  R_ = () => "Discord invalide.",
  N_ = () => "Discord non valido.",
  x_ = () => "無効なDiscordアカウントです。",
  D_ = () => "Nieprawidłowy Discord.",
  L_ = () => "Неверный Discord.",
  M_ = () => "Некоректний Discord.",
  P_ = () => "Discord không hợp lệ.",
  U_ = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? O_() : e === "pt" ? S_() : e === "ch" ? I_() : e === "de" ? A_() : e === "es" ? k_() : e === "fr" ? R_() : e === "it" ? N_() : e === "jp" ? x_() : e === "pl" ? D_() : e === "ru" ? L_() : e === "uk" ? M_() : P_()
  },
  C_ = () => "The name contains disallowed characters or words. Please choose a different name.",
  j_ = () => "O nome contém caracteres ou palavras não permitidas. Por favor, escolha outro nome.",
  F_ = () => "名称包含禁止的字符或词语，请选择其他名称。",
  B_ = () => "Der Name enthält nicht erlaubte Zeichen oder Wörter. Bitte wähle einen anderen Namen.",
  ...
  G_ = () => "Il nome contiene caratteri o parole non consentiti. Scegli un altro nome.",
  W_ = () => "この名前には使用できない文字または単語が含まれています。別の名前を選んでください。",
  q_ = () => "Nazwa zawiera niedozwolone znaki lub słowa. Wybierz inną nazwę.",
  K_ = () => "Имя содержит запрещённые символы или слова. Пожалуйста, выберите другое имя.",
  H_ = () => "Імʼя містить заборонені символи або слова. Оберіть інше імʼя.",
  Y_ = () => "Tên chứa ký tự hoặc từ không được phép. Hãy chọn tên khác.",
  Jt = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? C_() : e === "pt" ? j_() : e === "ch" ? F_() : e === "de" ? B_() : e === "es" ? z_() : e === "fr" ? V_() : e === "it" ? G_() : e === "jp" ? W_() : e === "pl" ? q_() : e === "ru" ? K_() : e === "uk" ? H_() : Y_()
  },
  Z_ = () => "Invalid phone number",
  $_ = () => "Número de telefone inválido",
  J_ = () => "无效的电话号码",
  X_ = () => "Ungültige Telefonnummer",
  Q_ = () => "Número de teléfono inválido",
  ef = () => "Numéro de téléphone invalide",
  tf = () => "Numero di telefono non valido",
  nf = () => "無効な電話番号です。",
  rf = () => "Nieprawidłowy numer telefonu",
  af = () => "Неверный номер телефона",
  of = () => "Некоректний номер телефону",
  sf = () => "Số điện thoại không hợp lệ",
  cf = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Z_() : e === "pt" ? $_() : e === "ch" ? J_() : e === "de" ? X_() : e === "es" ? Q_() : e === "fr" ? ef() : e === "it" ? tf() : e === "jp" ? nf() : e === "pl" ? rf() : e === "ru" ? af() : e === "uk" ? of() : sf()
  },
  uf = () => "This phone number appears to be a landline. Please use a mobile number that can receive SMS.",
  lf = () => "Este número de telefone parece ser fixo. Por favor, use um número de celular que possa receber SMS.",
  df = () => "此电话号码似乎是固定电话。请使用可以接收短信的手机号码。",
  _f = () => "Diese Telefonnummer scheint ein Festnetzanschluss zu sein. Bitte verwende eine Mobilnummer, die SMS empfangen kann.",
  ff = () => "Este número de teléfono parece ser fijo. Por favor, usa un número de celular que pueda recibir SMS.",
  mf = () => "Ce numéro de téléphone semble être un fixe. Veuillez utiliser un numéro de mobile pouvant recevoir des SMS.",
  pf = () => "Questo numero di telefono sembra essere un fisso. Utilizza un numero di cellulare che possa ricevere SMS.",
  hf = () => "この電話番号は固定電話のようです。SMSを受信できる携帯電話番号をご使用ください。",
  gf = () => "Ten numer telefonu wydaje się być stacjonarny. Użyj numeru komórkowego, który może odbierać SMS-y.",
  wf = () => "Этот номер телефона является стационарным. Пожалуйста, используйте мобильный номер, который может принимать SMS.",
  yf = () => "Цей номер телефону є стаціонарним. Будь ласка, використовуйте мобільний номер, який може отримувати SMS.",
  vf = () => "Số điện thoại này có vẻ là số cố định. Vui lòng sử dụng số di động có thể nhận SMS.",
  bf = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? uf() : e === "pt" ? lf() : e === "ch" ? df() : e === "de" ? _f() : e === "es" ? ff() : e === "fr" ? mf() : e === "it" ? pf() : e === "jp" ? hf() : e === "pl" ? gf() : e === "ru" ? wf() : e === "uk" ? yf() : vf()
  },
  Ef = () => "The new leader must be a member of the alliance",
  Tf = () => "O novo líder deve ser um membro da aliança",
  Of = () => "新盟主必须是联盟成员",
  Sf = () => "Der neue Anführer muss Mitglied der Allianz sein",
  If = () => "El nuevo líder debe ser miembro de la alianza",
  Af = () => "Le nouveau chef doit être membre de l’alliance",
  kf = () => "Il nuovo leader deve essere un membro dell'alleanza",
  Rf = () => "新しいリーダーはアライアンスのメンバーである必要があります。",
  Nf = () => "Nowy lider musi być członkiem sojuszu",
  xf = () => "Новый лидер должен быть участником альянса",
  Df = () => "Новий лідер має бути учасником альянсу",
  Lf = () => "Thủ lĩnh mới phải là thành viên của liên minh",
  Mf = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Ef() : e === "pt" ? Tf() : e === "ch" ? Of() : e === "de" ? Sf() : e === "es" ? If() : e === "fr" ? Af() : e === "it" ? kf() : e === "jp" ? Rf() : e === "pl" ? Nf() : e === "ru" ? xf() : e === "uk" ? Df() : Lf()
  },
  Pf = () => "Leaderboard is temporarily disabled",
  Uf = () => "O ranking está temporariamente desativado",
  Cf = () => "排行榜已暂时停用",
  jf = () => "Die Bestenliste ist vorübergehend deaktiviert",
  Ff = () => "La clasificación está deshabilitada temporalmente",
  Bf = () => "Le classement est temporairement désactivé",
  zf = () => "La classifica è temporaneamente disattivata",
  Vf = () => "ランキングは一時的に無効になっています。",
  Gf = () => "Ranking jest tymczasowo wyłączony",
  Wf = () => "Таблица лидеров временно отключена",
  qf = () => "Таблиця лідерів тимчасово вимкнена",
  Kf = () => "Bảng xếp hạng tạm thời bị vô hiệu hóa",
  se = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Pf() : e === "pt" ? Uf() : e === "ch" ? Cf() : e === "de" ? jf() : e === "es" ? Ff() : e === "fr" ? Bf() : e === "it" ? zf() : e === "jp" ? Vf() : e === "pl" ? Gf() : e === "ru" ? Wf() : e === "uk" ? qf() : Kf()
  },
  Hf = () => "Location name is too big (max. 128 characters)",
  Yf = () => "Nome da localização é grande demais (max. 128 caracteres)",
  Zf = () => "位置名称过长（最大 128 个字符）",
  $f = () => "Ortsname ist zu lang (max. 128 Zeichen)",
  Jf = () => "El nombre de la ubicación es demasiado largo (máx. 128 caracteres)",
  Xf = () => "Le nom de l’emplacement est trop long (max. 128 caractères)",
  Qf = () => "Il nome della località è troppo lungo (max. 128 caratteri)",
  ...
  im = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Hf() : e === "pt" ? Yf() : e === "ch" ? Zf() : e === "de" ? $f() : e === "es" ? Jf() : e === "fr" ? Xf() : e === "it" ? Qf() : e === "jp" ? em() : e === "pl" ? tm() : e === "ru" ? nm() : e === "uk" ? rm() : am()
  },
  om = () => "Multi-accounting",
  sm = () => "Múltiplas contas",
  cm = () => "多账号",
  ...
  wm = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? om() : e === "pt" ? sm() : e === "ch" ? cm() : e === "de" ? um() : e === "es" ? lm() : e === "fr" ? dm() : e === "it" ? _m() : e === "jp" ? fm() : e === "pl" ? mm() : e === "ru" ? pm() : e === "uk" ? hm() : gm()
  },
  ...
  xm = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? ym() : e === "pt" ? vm() : e === "ch" ? bm() : e === "de" ? Em() : e === "es" ? Tm() : e === "fr" ? Om() : e === "it" ? Sm() : e === "jp" ? Im() : e === "pl" ? Am() : e === "ru" ? km() : e === "uk" ? Rm() : Nm()
  },
  Dm = t => `You can change your name again in ${t.days} days`,
  Lm = t => `Você pode alterar seu nome novamente em ${t.days} dias.`,
  Mm = t => `你可以在 ${t.days} 天后再次修改名称`,
  Pm = t => `Du kannst deinen Namen in ${t.days} Tagen erneut ändern`,
  Um = t => `Podrás cambiar tu nombre de nuevo en ${t.days} días`,
  Cm = t => `Vous pourrez changer votre nom à nouveau dans ${t.days} jours`,
  jm = t => `Potrai cambiare di nuovo il tuo nome tra ${t.days} giorni.`,
  Fm = t => `${t.days}日後に再び名前を変更できます。`,
  Bm = t => `Następną zmianę nazwy możesz wykonać za ${t.days} dni`,
  zm = t => `Вы сможете изменить имя снова через ${t.days} дн.`,
  Vm = t => `Ви зможете змінити імʼя знову через ${t.days} днів`,
  Gm = t => `Bạn có thể đổi tên lại sau ${t.days} ngày`,
  Wm = (t, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Dm(t) : e === "pt" ? Lm(t) : e === "ch" ? Mm(t) : e === "de" ? Pm(t) : e === "es" ? Um(t) : e === "fr" ? Cm(t) : e === "it" ? jm(t) : e === "jp" ? Fm(t) : e === "pl" ? Bm(t) : e === "ru" ? zm(t) : e === "uk" ? Vm(t) : Gm(t)
  },
  ...
  hp = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? ap() : e === "pt" ? ip() : e === "ch" ? op() : e === "de" ? sp() : e === "es" ? cp() : e === "fr" ? up() : e === "it" ? lp() : e === "jp" ? dp() : e === "pl" ? _p() : e === "ru" ? fp() : e === "uk" ? mp() : pp()
  },
  ...
  Rp = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? gp() : e === "pt" ? wp() : e === "ch" ? yp() : e === "de" ? vp() : e === "es" ? bp() : e === "fr" ? Ep() : e === "it" ? Tp() : e === "jp" ? Op() : e === "pl" ? Sp() : e === "ru" ? Ip() : e === "uk" ? Ap() : kp()
  },
  ...
  th = () => "This phone number's region is not supported",
  nh = () => "A região deste número de telefone não é suportada",
  rh = () => "此电话号码的地区不受支持",
  ah = () => "Die Region dieser Telefonnummer wird nicht unterstützt",
  ih = () => "La región de este número de teléfono no es compatible",
  oh = () => "La région de ce numéro de téléphone n'est pas prise en charge",
  sh = () => "La regione di questo numero di telefono non è supportata",
  ch = () => "この電話番号の地域はサポートされていません",
  uh = () => "Region tego numeru telefonu nie jest obsługiwany",
  lh = () => "Регион этого номера телефона не поддерживается",
  dh = () => "Регіон цього номера телефону не підтримується",
  _h = () => "Vùng của số điện thoại này không được hỗ trợ",
  fh = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? th() : e === "pt" ? nh() : e === "ch" ? rh() : e === "de" ? ah() : e === "es" ? ih() : e === "fr" ? oh() : e === "it" ? sh() : e === "jp" ? ch() : e === "pl" ? uh() : e === "ru" ? lh() : e === "uk" ? dh() : _h()
  },
  mh = () => "Refresh your page to get the latest update",
  ph = () => "Recarregue sua página para obter as últimas atualizações",
  hh = () => "刷新页面以获取最新更新",
  gh = () => "Aktualisiere die Seite, um die neuesten Updates zu erhalten",
  wh = () => "Actualiza la página para obtener la última versión",
  yh = () => "Actualisez la page pour obtenir les dernières mises à jour",
  vh = () => "Ricarica la pagina per ottenere gli ultimi aggiornamenti",
  bh = () => "最新の状態にするにはページを再読み込みしてください。",
  Eh = () => "Odśwież stronę, aby zobaczyć najnowszą aktualizację",
  Th = () => "Обновите страницу, чтобы получить последние изменения",
  Oh = () => "Оновіть сторінку, щоб отримати останні оновлення",
  Sh = () => "Hãy làm mới trang để nhận được cập nhật mới nhất",
  Qt = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? mh() : e === "pt" ? ph() : e === "ch" ? hh() : e === "de" ? gh() : e === "es" ? wh() : e === "fr" ? yh() : e === "it" ? vh() : e === "jp" ? bh() : e === "pl" ? Eh() : e === "ru" ? Th() : e === "uk" ? Oh() : Sh()
  },
  Ih = () => "The request timed out. Please try again.",
  Ah = () => "A solicitação expirou. Por favor, tente novamente.",
  kh = () => "请求超时。请重试。",
  Rh = () => "Die Anfrage hat ein Zeitlimit überschritten. Bitte versuchen Sie es erneut.",
  Nh = () => "La solicitud agotó el tiempo de espera. Por favor, inténtelo de nuevo.",
  xh = () => "La requête a expiré. Veuillez réessayer.",
  Dh = () => "La richiesta è scaduta. Riprova.",
  Lh = () => "リクエストがタイムアウトしました。もう一度お試しください。",
  Mh = () => "Żądanie przekroczyło limit czasu. Proszę spróbować ponownie.",
  Ph = () => "Время ожидания запроса истекло. Пожалуйста, попробуйте снова.",
  Uh = () => "Час очікування запиту вичерпано. Будь ласка, спробуйте ще раз.",
  Ch = () => "Yêu cầu đã hết thời gian. Vui lòng thử lại.",
  jh = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Ih() : e === "pt" ? Ah() : e === "ch" ? kh() : e === "de" ? Rh() : e === "es" ? Nh() : e === "fr" ? xh() : e === "it" ? Dh() : e === "jp" ? Lh() : e === "pl" ? Mh() : e === "ru" ? Ph() : e === "uk" ? Uh() : Ch()
  },
  Fh = () => "The service is currently unavailable. Please try again later.",
  Bh = () => "O serviço está indisponível no momento. Por favor, tente novamente mais tarde.",
  zh = () => "服务当前不可用。请稍后再试。",
  Vh = () => "Der Dienst ist derzeit nicht verfügbar. Bitte versuchen Sie es später erneut.",
  Gh = () => "El servicio no está disponible actualmente. Por favor, inténtelo de nuevo más tarde.",
  Wh = () => "Le service est actuellement indisponible. Veuillez réessayer plus tard.",
  qh = () => "Il servizio non è attualmente disponibile. Riprova più tardi.",
  Kh = () => "現在、サービスはご利用いただけません。後でもう一度お試しください。",
  Hh = () => "Usługa jest obecnie niedostępna. Proszę spróbować ponownie później.",
  Yh = () => "Сервис в настоящее время недоступен. Пожалуйста, попробуйте позже.",
  Zh = () => "Сервіс наразі недоступний. Будь ласка, спробуйте пізніше.",
  $h = () => "Dịch vụ hiện không khả dụng. Vui lòng thử lại sau.",
  Jh = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Fh() : e === "pt" ? Bh() : e === "ch" ? zh() : e === "de" ? Vh() : e === "es" ? Gh() : e === "fr" ? Wh() : e === "it" ? qh() : e === "jp" ? Kh() : e === "pl" ? Hh() : e === "ru" ? Yh() : e === "uk" ? Zh() : $h()
  },
  Xh = () => "Too many attempts. Please try again later",
  Qh = () => "Muitas tentativas. Por favor, tente novamente mais tarde.",
  eg = () => "尝试次数过多，请稍后再试",
  tg = () => "Zu viele Versuche. Bitte versuchen Sie es später erneut",
  ng = () => "Demasiados intentos. Por favor, inténtalo de nuevo más tarde",
  rg = () => "Trop de tentatives. Veuillez réessayer plus tard",
  ag = () => "Troppi tentativi. Riprova più tardi.",
  ig = () => "試行回数が多すぎます。後で再度お試しください。",
  og = () => "Zbyt wiele prób. Proszę spróbować ponownie później",
  sg = () => "Слишком много попыток. Пожалуйста, попробуйте позже",
  cg = () => "Забагато спроб. Будь ласка, спробуйте пізніше",
  ug = () => "Quá nhiều lần thử. Vui lòng thử lại sau.",
  en = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Xh() : e === "pt" ? Qh() : e === "ch" ? eg() : e === "de" ? tg() : e === "es" ? ng() : e === "fr" ? rg() : e === "it" ? ag() : e === "jp" ? ig() : e === "pl" ? og() : e === "ru" ? sg() : e === "uk" ? cg() : ug()
  },
  lg = () => "The typed username does not match your current username.",
  dg = () => "O nome de usuário digitado não corresponde ao seu nome de usuário atual.",
  _g = () => "输入的用户名与当前用户名不匹配。",
  fg = () => "Der eingegebene Benutzername stimmt nicht mit deinem aktuellen Benutzernamen überein.",
  mg = () => "El nombre de usuario ingresado no coincide con tu nombre de usuario actual.",
  pg = () => "Le nom d’utilisateur saisi ne correspond pas à votre nom d’utilisateur actuel.",
  hg = () => "Il nome utente inserito non corrisponde al tuo nome utente attuale.",
  gg = () => "入力されたユーザー名が、現在のユーザー名と一致しません。",
  wg = () => "Wpisana nazwa użytkownika nie zgadza się z obecną nazwą.",
  yg = () => "Введённое имя пользователя не совпадает с текущим.",
  vg = () => "Введене імʼя користувача не збігається з поточним.",
  bg = () => "Tên người dùng nhập vào không trùng với tên hiện tại.",
  Eg = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? lg() : e === "pt" ? dg() : e === "ch" ? _g() : e === "de" ? fg() : e === "es" ? mg() : e === "fr" ? pg() : e === "it" ? hg() : e === "jp" ? gg() : e === "pl" ? wg() : e === "ru" ? yg() : e === "uk" ? vg() : bg()
  },
  Tg = () => "Unexpected server error. Try again later.",
  Og = () => "Erro inesperado do servidor. Tente novamente mais tarde.",
  Sg = () => "服务器出现意外错误。请稍后再试。",
  Ig = () => "Unerwarteter Serverfehler. Versuche es später erneut.",
  Ag = () => "Error inesperado del servidor. Inténtalo de nuevo más tarde.",
  kg = () => "Erreur serveur inattendue. Réessayez plus tard.",
  Rg = () => "Errore imprevisto del server. Riprova più tardi.",
  Ng = () => "予期しないサーバーエラーが発生しました。時間をおいて再度お試しください。",
  xg = () => "Nieoczekiwany błąd serwera. Spróbuj ponownie później.",
  Dg = () => "Непредвиденная ошибка сервера. Попробуйте позже.",
  Lg = () => "Неочікувана помилка сервера. Спробуйте пізніше.",
  Mg = () => "Lỗi máy chủ không mong muốn. Hãy thử lại sau.",
  f = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Tg() : e === "pt" ? Og() : e === "ch" ? Sg() : e === "de" ? Ig() : e === "es" ? Ag() : e === "fr" ? kg() : e === "it" ? Rg() : e === "jp" ? Ng() : e === "pl" ? xg() : e === "ru" ? Dg() : e === "uk" ? Lg() : Mg()
  },
  Pg = () => "The phone number is unsubscribed from SMS notifications. Check the link for more info: https://www.twilio.com/docs/api/errors/21610",
  Ug = () => "O número de telefone foi desinscrito das notificações por SMS. Verifique o link para mais informações: https://www.twilio.com/docs/api/errors/21610",
  Cg = () => "电话号码已退订短信通知。请查看链接获取更多信息：https://www.twilio.com/docs/api/errors/21610",
  jg = () => "Die Telefonnummer wurde von SMS-Benachrichtigungen abgemeldet. Weitere Informationen finden Sie unter: https://www.twilio.com/docs/api/errors/21610",
  Fg = () => "El número de teléfono ha sido dado de baja de las notificaciones por SMS. Consulta el enlace para más información: https://www.twilio.com/docs/api/errors/21610",
  Bg = () => "Le numéro de téléphone est désabonné des notifications par SMS. Consultez le lien pour plus d'informations : https://www.twilio.com/docs/api/errors/21610",
  zg = () => "Il numero di telefono è stato disiscritto dalle notifiche SMS. Per maggiori informazioni, consulta il link: https://www.twilio.com/docs/api/errors/21610",
  Vg = () => "この電話番号はSMS通知から登録解除されました。詳細については、以下のリンクをご確認ください: https://www.twilio.com/docs/api/errors/21610",
  Gg = () => "Numer telefonu został wypisany z powiadomień SMS. Sprawdź link, aby uzyskać więcej informacji: https://www.twilio.com/docs/api/errors/21610",
  Wg = () => "Номер телефона отписан от SMS-уведомлений. Дополнительную информацию смотрите по ссылке: https://www.twilio.com/docs/api/errors/21610",
  qg = () => "Номер телефону відключено від SMS-сповіщень. Перегляньте посилання для отримання додаткової інформації: https://www.twilio.com/docs/api/errors/21610",
  Kg = () => "Số điện thoại này đã hủy đăng ký nhận thông báo SMS. Kiểm tra liên kết để biết thêm thông tin: https://www.twilio.com/docs/api/errors/21610",
  Hg = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Pg() : e === "pt" ? Ug() : e === "ch" ? Cg() : e === "de" ? jg() : e === "es" ? Fg() : e === "fr" ? Bg() : e === "it" ? zg() : e === "jp" ? Vg() : e === "pl" ? Gg() : e === "ru" ? Wg() : e === "uk" ? qg() : Kg()
  },
  Yg = () => "Failed to load WebAssembly module. Try to use another browser.",
  Zg = () => "Erro ao carregar módulo WebAssembly. Tente usar outro navegador.",
  $g = () => "WebAssembly 模块加载失败。请尝试使用其他浏览器。",
  Jg = () => "Fehler beim Laden des WebAssembly-Moduls. Versuche, einen anderen Browser zu verwenden.",
  Xg = () => "Error al cargar el módulo WebAssembly. Intenta usar otro navegador.",
  Qg = () => "Erreur lors du chargement du module WebAssembly. Essayez d’utiliser un autre navigateur.",
  ew = () => "Errore nel caricamento del modulo WebAssembly. Prova a usare un altro browser.",
  tw = () => "WebAssembly モジュールの読み込みに失敗しました。別のブラウザをお試しください。",
  ...
  aw = () => "Не вдалося завантажити модуль WebAssembly. Спробуйте інший браузер.",
  iw = () => "Lỗi tải mô-đun WebAssembly. Hãy thử dùng trình duyệt khác.",
  ow = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Yg() : e === "pt" ? Zg() : e === "ch" ? $g() : e === "de" ? Jg() : e === "es" ? Xg() : e === "fr" ? Qg() : e === "it" ? ew() : e === "jp" ? tw() : e === "pl" ? nw() : e === "ru" ? rw() : e === "uk" ? aw() : iw()
  },
  ...
  dw = () => "Ya tienes este ítem. Actualiza la página.",
  _w = () => "Vous possédez déjà cet objet. Actualisez la page.",
  fw = () => "Possiedi già questo oggetto. Aggiorna la pagina.",
  mw = () => "このアイテムはすでに所持しています。ページを更新してください。",
  pw = () => "Masz już ten przedmiot. Odśwież stronę.",
  hw = () => "У вас уже есть этот предмет. Обновите страницу.",
  gw = () => "У вас уже є цей предмет. Оновіть сторінку.",
  ww = () => "Bạn đã sở hữu vật phẩm này. Hãy tải lại trang.",
  tn = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? sw() : e === "pt" ? cw() : e === "ch" ? uw() : e === "de" ? lw() : e === "es" ? dw() : e === "fr" ? _w() : e === "it" ? fw() : e === "jp" ? mw() : e === "pl" ? pw() : e === "ru" ? hw() : e === "uk" ? gw() : ww()
  },
  yw = () => "You are already in an alliance",
  vw = () => "Você já está em uma aliança",
  bw = () => "你已经在一个联盟中",
  Ew = () => "Du bist bereits in einer Allianz",
  Tw = () => "Ya estás en una alianza",
  Ow = () => "Vous êtes déjà dans une alliance",
  Sw = () => "Sei già in un'alleanza",
  Iw = () => "すでにアライアンスに所属しています。",
  Aw = () => "Jesteś już w sojuszu",
  kw = () => "Вы уже состоите в альянсе",
  Rw = () => "Ви вже перебуваєте в альянсі",
  Nw = () => "Bạn đã ở trong một liên minh",
  xw = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? yw() : e === "pt" ? vw() : e === "ch" ? bw() : e === "de" ? Ew() : e === "es" ? Tw() : e === "fr" ? Ow() : e === "it" ? Sw() : e === "jp" ? Iw() : e === "pl" ? Aw() : e === "ru" ? kw() : e === "uk" ? Rw() : Nw()
  },
  Dw = () => "You are not allowed to do this",
  Lw = () => "Você não tem permissão para fazer isso",
  Mw = () => "你无权执行此操作",
  Pw = () => "Du bist dazu nicht berechtigt",
  Uw = () => "No tienes permiso para hacer esto",
  Cw = () => "Vous n’êtes pas autorisé à faire cela",
  jw = () => "Non hai il permesso di farlo",
  Fw = () => "この操作を行う権限がありません。",
  Bw = () => "Nie masz uprawnień, aby to zrobić",
  zw = () => "У вас нет прав для этого действия",
  Vw = () => "Ви не маєте права це робити",
  Gw = () => "Bạn không có quyền làm việc này",
  ce = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Dw() : e === "pt" ? Lw() : e === "ch" ? Mw() : e === "de" ? Pw() : e === "es" ? Uw() : e === "fr" ? Cw() : e === "it" ? jw() : e === "jp" ? Fw() : e === "pl" ? Bw() : e === "ru" ? zw() : e === "uk" ? Vw() : Gw()
  },
  Ww = () => "You do not have enough Droplets to buy this item.",
  qw = () => "Você não tem gotas suficientes para comprar este item.",
  Kw = () => "你的水滴不足，无法购买此物品。",
  Hw = () => "Du hast nicht genug Droplets, um dieses Item zu kaufen.",
  Yw = () => "No tienes suficientes gotas para comprar este ítem.",
  Zw = () => "Vous n’avez pas assez de droplets pour acheter cet objet.",
  $w = () => "Non hai abbastanza gocce per acquistare questo oggetto.",
  Jw = () => "このアイテムを購入するのに十分なドロップレットがありません。",
  Xw = () => "Nie masz wystarczającej liczby kropli, aby kupić ten przedmiot.",
  Qw = () => "У вас недостаточно droplets для покупки этого предмета.",
  ey = () => "У вас недостатньо дроплетів, щоб купити цей предмет.",
  ty = () => "Bạn không có đủ droplets để mua vật phẩm này.",
  nn = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Ww() : e === "pt" ? qw() : e === "ch" ? Kw() : e === "de" ? Hw() : e === "es" ? Yw() : e === "fr" ? Zw() : e === "it" ? $w() : e === "jp" ? Jw() : e === "pl" ? Xw() : e === "ru" ? Qw() : e === "uk" ? ey() : ty()
  },
  ny = () => "You need to be logged in to paint",
  ry = () => "Você precisa estar conectado para pintar",
  ay = () => "你需要登录才能进行绘制",
  iy = () => "Du musst eingeloggt sein, um zu malen",
  oy = () => "Debes iniciar sesión para pintar",
  sy = () => "Vous devez être connecté pour peindre",
  cy = () => "Devi avere effettuato l'accesso per dipingere",
  uy = () => "ペイントするにはログインが必要です。",
  ly = () => "Musisz być zalogowany, aby malować",
  dy = () => "Чтобы рисовать, нужно войти в аккаунт",
  _y = () => "Щоб малювати, необхідно увійти в акаунт",
  fy = () => "Bạn cần đăng nhập để tô",
  rn = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? ny() : e === "pt" ? ry() : e === "ch" ? ay() : e === "de" ? iy() : e === "es" ? oy() : e === "fr" ? sy() : e === "it" ? cy() : e === "jp" ? uy() : e === "pl" ? ly() : e === "ru" ? dy() : e === "uk" ? _y() : fy()
  },
  my = () => "You or someone in your network is making a lot of requests to the server. Try again later.",
  ...
  gy = () => "Du oder jemand in deinem Netzwerk sendet sehr viele Anfragen an den Server. Versuche es später erneut.",
  wy = () => "Tú o alguien en tu red está realizando demasiadas solicitudes al servidor. Inténtalo de nuevo más tarde.",
  yy = () => "Vous ou quelqu’un sur votre réseau envoie beaucoup de requêtes au serveur. Réessayez plus tard.",
  ...
  Ey = () => "Ty lub ktoś w Twojej sieci wysyła zbyt wiele żądań do serwera. Spróbuj ponownie później.",
  Ty = () => "Вы или кто-то в вашей сети делает слишком много запросов к серверу. Попробуйте позже.",
  Oy = () => "Ви або хтось у вашій мережі надсилає надто багато запитів до сервера. Спробуйте пізніше.",
  Sy = () => "Bạn hoặc ai đó trong mạng của bạn đang gửi quá nhiều yêu cầu đến máy chủ. Hãy thử lại sau.",
  Iy = (t = {}, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? my() : e === "pt" ? py() : e === "ch" ? hy() : e === "de" ? gy() : e === "es" ? wy() : e === "fr" ? yy() : e === "it" ? vy() : e === "jp" ? by() : e === "pl" ? Ey() : e === "ru" ? Ty() : e === "uk" ? Oy() : Sy()
  },
  Ay = t => `Your account has been suspended out until ${t.until}`,
  ky = t => `A sua conta está suspensa até ${t.until}`,
  Ry = t => `你的账号已被暂停至 ${t.until}`,
  Ny = t => `Dein Konto ist gesperrt bis ${t.until}`,
  xy = t => `Tu cuenta ha sido suspendida hasta ${t.until}`,
  Dy = t => `Votre compte est suspendu jusqu’au ${t.until}`,
  Ly = t => `Il tuo account è sospeso fino al ${t.until}`,
  My = t => `あなたのアカウントは${t.until}まで一時停止されています。`,
  Py = t => `Twoje konto zostało zawieszone do ${t.until}`,
  Uy = t => `Ваш аккаунт заблокирован до ${t.until}`,
  Cy = t => `Ваш акаунт призупинено до ${t.until}`,
  jy = t => `Tài khoản của bạn đã bị đình chỉ đến ${t.until}`,
  an = (t, n = {}) => {
    const e = n.locale ?? h();
    return e === "en" ? Ay(t) : e === "pt" ? ky(t) : e === "ch" ? Ry(t) : e === "de" ? Ny(t) : e === "es" ? xy(t) : e === "fr" ? Dy(t) : e === "it" ? Ly(t) : e === "jp" ? My(t) : e === "pl" ? Py(t) : e === "ru" ? Uy(t) : e === "uk" ? Cy(t) : jy(t)
  };
let R;
...
const xn = typeof TextDecoder < "u" ? new TextDecoder("utf-8", {
  ignoreBOM: !0,
  fatal: !0
}) : {
  decode: () => {
...
typeof TextDecoder < "u" && xn.decode();
let ye = null;
...
function ve(t, n) {
  return t = t >>> 0, xn.decode(Ee().subarray(t, t + n))
}
let Te = ae.length;
  ...
  const a = {
    ...
    i = (...o) => {
      ...
      try {
        ...
        --a.cnt === 0 ? (R.__wbindgen_export_1.get(a.dtor)(s, a.b), sn.unregister(a)) : a.a = s
      }
    };
...
const rt = typeof TextEncoder < "u" ? new TextEncoder("utf-8") : {
  ...
  zy = typeof rt.encodeInto == "function" ? function(t, n) {
...
function Vy(t) {
  const n = St(t, R.__wbindgen_export_2, R.__wbindgen_export_3),
    e = de;
...
function Wy(t) {
  const n = Gy(t, R.__wbindgen_export_2),
    e = de;
  R.set_telemetry(n, e)
}
...
function Ky(t) {
  ...
  try {
    const i = R.__wbindgen_add_to_stack_pointer(-16),
      o = St(t, R.__wbindgen_export_2, R.__wbindgen_export_3),
      s = de;
...
function Qy(t, n) {
  return R = t.exports, Dn.__wbindgen_wasm_module = n, le = null, ye = null, R
}
async function Dn(t) {
...
function ib() {
  cn || typeof window > "u" || (cn = !0, U.focusStartMs = performance.now(), U.windowStartMs = Date.now(), document.readyState === "complete" ? k = ln() : window.addEventListener("load", () => {
    k = ln()
  }, {
    once: !0
  }), window.addEventListener("pointermove", t => {
    const n = performance.now();
    n - U.lastMouseSampleMs < ev || (U.lastMouseSampleMs = n, Mn.push({
      x: t.clientX,
      y: t.clientY,
      t: n
    }))
    ...
    Pn.push(performance.now()), U.lastClickX = t.clientX, U.lastClickY = t.clientY
  }, {
    passive: !0
...
function cv(t) {
  ...
  for (let w = 1; w < t.length; w++) {
    ...
    if (w >= 2) {
      ...
      const qn = n[n.length - 2] || 0;
      r.push(Math.abs(V - qn))
    }
  }
  if (t.length - i > 2) {
    o++;
...
function ln() {
  ...
  try {
    ...
    if (T) {
      ...
      const S = g.toDataURL();
      let N = 0;
      for (let j = 0; j < S.length; j++) N = (N << 5) - N + S.charCodeAt(j) | 0;
      l = (N >>> 0).toString(16).padStart(8, "0"), T.clearRect(0, 0, 64, 16), T.fillText("wplace🐾", 2, 2);
      const C = g.toDataURL();
      _ = S === C
    }
  } catch {}
...
function mv() {
  ...
  function e(r) {
    if (t.push(r), t.length < 30) requestAnimationFrame(e);
      ...
      Un = a.reduce((o, s) => o + Math.abs(s - i), 0) / a.length
    }
  }
...
const Tv = [{
  ...
  vt = _e,
  Lv = _e.seasons,
  Fn = _e.seasons.length - 1,
  hb = _e.seasons[Fn].zoom,
  gb = _e.seasons[Fn].tileSize,
  wb = _e.permissions,
  Mv = _e.settings;
...
class Pv {
  ...
  async paint(n) {
    const e = fn(n, s => `t=(${s.tile[0]},${s.tile[1]}),s=${s.season}`),
      r = {
        season: n[0].season,
    ...
    if (o.status !== c.OK) {
      ...
      if (o.status === c.FORBIDDEN) {
        ...
        if ((s == null ? void 0 : s.error) === "challenge-required")
          if (s.tier) {
            if (await dn(s.tier)) return this.paint(n);
            throw new Error(Yt())
  ...
  async sendPaintRequests(n, e, r, a) {
    const i = fn(n, u => `t=(${u.tile[0]},${u.tile[1]}),s=${u.season}`),
  ...
  async sendOtp(n) {
    ...
    if (e.status === c.BAD_REQUEST) throw new Error(cf());
    if (e.status === c.CONFLICT) throw new Error(eh());
    if (e.status === c.FORBIDDEN) throw new Error(hp());
    if (e.status === c.TOO_MANY_REQUESTS) throw new Error(en());
    if (e.status === c.UNAVAILABLE_FOR_LEGAL_REASONS) throw new Error(fh());
    if (e.status === c.LOCKED) throw new Error(Hg());
    if (e.status === c.UNPROCESSABLE_ENTITY) throw new Error(bf());
  ...
  async verifyChallenge(n) {
    ...
    if (n.type === "otp") {
      if (r.status === c.GONE) throw new Error(ml());
      ...
      if (r.status === c.BAD_REQUEST) throw new Error(l_());
      if (r.status !== c.OK) throw new Error(f())
    }
  }
  async updateMe(n) {
    ...
    if (e.status === c.BAD_REQUEST) {
      ...
      if (a === "invalid_discord") throw new Error(U_());
  ...
  async deleteMe(n) {
    ...
    if (e.status === c.BAD_REQUEST) throw new Error(Eg());
    if (e.status !== c.OK) throw new Error(f())
  }
  ...
  async createAlliance(n) {
    ...
    if (e.status === c.BAD_REQUEST) {
      const r = await e.json();
      throw r.error === "max_characters" ? new Error(Qi()) : r.error === "name_taken" ? new Error(Bi()) : r.error == "empty_name" ? new Error(fo()) : new Error(f())
    } else throw e.status === c.FORBIDDEN ? new Error(xw()) : new Error(f())
  }
  async leaveAlliance() {
  ...
  async updateAllianceDescription(n) {
    ...
    if (e.status !== c.OK) throw e.status === c.FORBIDDEN ? new Error(ce()) : e.status === c.BAD_REQUEST ? new Error(tl()) : new Error(f())
  }
  ...
  async changeAllianceLeader(n, e) {
    ...
    if (r.status === c.BAD_REQUEST) {
      const a = await r.json();
      throw (a == null ? void 0 : a.error) === "user_not_in_alliance" ? new Error(Mf()) : new Error(f())
    } else if (r.status !== c.OK) throw new m(f(), r.status)
  }
  ...
  async generatePixQrCode(n) {
    ...
    if (e.status === c.BAD_REQUEST) {
      ...
      if (e.status === c.UNAVAILABLE_FOR_LEGAL_REASONS) throw new Error(Ai());
      if (e.status !== c.OK) throw new Error(f())
    }
    return await e.json()
  }
  ...
  async getModeratorTickets() {
    ...
    for (const r of e.tickets) r.reports.sort((a, i) => _n[a.reason] - _n[i.reason]);
    return e
  }
  ...
  async request(n, e) {
    ...
    try {
      ...
      throw console.error("Fetch error:", i), this.online = !1, new Error(Us(), {
        cause: i
      })
    }
    if ((e == null ? void 0 : e.throwOnStatus) ?? !0) {
      if (r.status === c.TOO_MANY_REQUESTS) throw new Error(Iy());
      if (r.status === c.REQUEST_TIMEOUT) throw new Error(jh());
      if (r.status === c.SERVICE_UNAVAILABLE) throw new Error(Jh())
    }
    return r
  }
  ...
  async postAdminChangeUserEmail(n, e) {
    ...
    if (r.status === c.BAD_REQUEST) {
      ...
      throw i === "email_required" || i === "invalid_email" ? new m(Ru(), c.BAD_REQUEST) : new m(typeof i == "string" && i ? i : f(), c.BAD_REQUEST)
    }
    if (r.status === c.CONFLICT) {
      const a = await r.json();
      if (((a == null ? void 0 : a.error) ?? "") === "email_already_in_use") {
        const o = new m(typeof(a == null ? void 0 : a.userId) == "number" ? hu({
          userId: a.userId
        }) : ru(), c.CONFLICT);
  ...
  async submitBanAppeal(n) {
    ...
    if (a.status === c.FORBIDDEN) {
      ...
      if ((i == null ? void 0 : i.error) === "challenge-required" && i.tier) {
        if (await dn(i.tier)) return this.submitBanAppeal(n);
  ...
  async postCaptchaSession(n) {
    ...
    if (!r.ok) throw r.status === 500 ? new m(f(), r.status) : new m(Jd(), r.status);
    return r.json()
  }
  validWaybackInput(n) {
  ...
  constructor() {
    ...
    F(this, "create", n => {
      ...
      const {
        message: e,
        ...r
      } = n, a = typeof(n == null ? void 0 : n.id) == "number" || n.id && ((s = n.id) == null ? void 0 : s.length) > 0 ? n.id : mn++, i = n.dismissable === void 0 ? !0 : n.dismissable, o = n.type === void 0 ? "default" : n.type;
      return Dt(() => {
...
class Yv {
  constructor() {
    ...
    D(this, He, we(() => {
      ...
      const e = n.count + Math.max((Qn.now - this.lastFetch) / n.cooldownMs, 0);
      return Math.min(n.max, e)
    }));
    D(this, Ye, we(() => this.charges !== void 0 && this.data ? (1 - this.charges % 1) * this.data.charges.cooldownMs : void 0));
    D(this, Ze, we(() => {
      var n;
      return new zv(zn(((n = this.data) == null ? void 0 : n.flagsBitmap) ?? "AA=="))
    }));
    D(this, $e, we(() => {
      var e;
  ...
  async refresh() {
    ...
    try {
      ...
      }), (e = this.data) != null && e.id && (Zn("userId", {
        id: this.data.id
      }), Zv(this.data.id)), !!this.data
    } catch (r) {
      return console.error(r), Hv.warning(rp(), {
        duration: 1e4
      }), !1
    } finally {
      this.loading = !1
  ...
  hasPermission(n) {
    var e;
    return Bn((e = this.data) == null ? void 0 : e.permissions, n)
  }
  hasAnyPermission(n) {
    var e;
...
async function Gn() {
  return be || (be = (async () => {
    var t;
    try {
      await Dn(nr), (t = Ie.data) != null && t.id && It(Ie.data.id), Zy(), Cn();
      const n = fetch;
      return Object.assign(window, {
        fetch: Wn((e, r) => {
          let a = null;
          return e instanceof Request ? a = e.url : a = e, a.startsWith("/") || Hy(a), n.call(window, e, r)
        })
      }), !0
    } catch (n) {
      return console.error("Error loading Pawtect WASM:", n), Vn = n, $n(n), be = void 0, !1
    }
  })()), be
}
async function Zv(t) {
...
async function $v(t, n) {
  if (!await Gn()) throw new Error(ow());
  const r = navigator.webdriver,
    a = await st();
  It(Ie.data.id), Vy(a), qy(r), Yy(At);
...
export {
  Eg as $, tr as A, Wc as B, Fn as C, Fo as D, xm as E, Bl as F, Z as G, Sb as H, Ib as I, ub as J, z as K, sb as L, ob as M, cb as N, nb as O, bt as P, ib as Q, Gn as R, wb as S, Rb as T, Tb as U, Ob as V, yb as W, Ab as X, ow as Y, kb as Z, mb as _, ge as a, bb as a0, an as a1, db as a2, pb as a3, fb as a4, vb as a5, hb as a6, tb as a7, Ai as a8, Bi as a9, Xt as aA, eh as aB, fh as aC, Qt as aD, jh as aE, Jh as aF, en as aG, Hg as aH, tn as aI, xw as aJ, ce as aK, nn as aL, rn as aM, Iy as aN, Qi as aa, fo as ab, Xo as ac, ds as ad, Ht as ae, Us as af, Zt as ag, $t as ah, ru as ai, hu as aj, Vu as ak, tl as al, ml as am, l_ as an, T_ as ao, U_ as ap, Jt as aq, cf as ar, bf as as, Mf as at, se as au, im as av, Wm as aw, rp as ax, hp as ay, Rp as az, lb as b, Io as c, xc as d, f as e, vt as f, Al as g, Ql as h, Sd as i, Qn as j, gb as k, ab as l, wm as m, Ru as n, st as o, Jd as p, rb as q, ht as r, _b as s, Hv as t, Ie as u, dn as v, Yt as w, Eb as x, jd as y, _d as z
};