...
var Pe = (n, t, e) => t in n ? je(n, t, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: e
}) : n[t] = e;
var g = (n, t, e) => Pe(n, typeof t != "symbol" ? t + "" : t, e),
  Ie = (n, t, e) => t.has(n) || se("Cannot " + e);
var m = (n, t, e) => (Ie(n, t, "read from private field"), e ? e.call(n) : t.get(n)),
...
class De {
  constructor() {
    ...
    g(this, "setHeight", t => {
      const e = m(this, B).call(this, t.toastId);
      if (e === null) {
        this.heights.push(t);
        return
      }
...
const $e = "" + new URL("../assets/pawtect_wasm_bg.BvxCe1S1.wasm", import.meta.url).href,
  Ue = () => "Your account has been suspended for breaking the rules",
  Re = () => "Sua conta foi suspensa por quebrar as regras",
  Ge = () => "您的账号因违反规则已被暂停",
  Fe = () => "Dein Konto wurde wegen Regelverstößen gesperrt",
  Ve = () => "Tu cuenta ha sido suspendida por infringir las regras",
  Je = () => "Votre compte a été suspendu pour avoir enfreint les règles",
  We = () => "Il tuo account è stato sospeso per aver infranto le regole",
  Ke = () => "ルール違反により、あなたのアカウントは一時停止されています。",
  He = () => "Twoje konto zostało zawieszone za łamanie zasad",
  Ye = () => "Ваш аккаунт был временно заблокирован за нарушение правил",
  Ze = () => "Ваш обліковий запис було призупинено за порушення правил",
  Xe = () => "Tài khoản của bạn đã bị tạm đình chỉ vì vi phạm luật",
  Qe = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Ue() : e === "pt" ? Re() : e === "ch" ? Ge() : e === "de" ? Fe() : e === "es" ? Ve() : e === "fr" ? Je() : e === "it" ? We() : e === "jp" ? Ke() : e === "pl" ? He() : e === "ru" ? Ye() : e === "uk" ? Ze() : Xe()
  },
  et = () => "Alliance name already taken",
  tt = () => "Já possui uma aliança com esse nome",
  nt = () => "该联盟名称已被占用",
  rt = () => "Der Allianzname ist bereits vergeben",
  at = () => "Ese nombre de alianza ya está en uso",
  st = () => "Ce nom d’alliance est déjà pris",
  ot = () => "Esiste già un'alleanza con questo nome",
  it = () => "このアライアンス名は既に使用されています。",
  ut = () => "Nazwa sojuszu jest już zajęta",
  ct = () => "Такое название альянса уже используется",
  dt = () => "Назва альянсу вже зайнята",
  lt = () => "Tên liên minh đã được sử dụng",
  _t = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? et() : e === "pt" ? tt() : e === "ch" ? nt() : e === "de" ? rt() : e === "es" ? at() : e === "fr" ? st() : e === "it" ? ot() : e === "jp" ? it() : e === "pl" ? ut() : e === "ru" ? ct() : e === "uk" ? dt() : lt()
  },
  ft = () => "Alliance name exceeded the maximum number of characters",
  mt = () => "O nome da aliança excedeu o número máximo de caracteres",
  ht = () => "联盟名称超过最大字符数限制",
  pt = () => "Der Allianzname überschreitet die maximale Zeichenanzahl",
  gt = () => "El nombre de la alianza superó el número máximo de caracteres",
  wt = () => "Le nom de l’alliance a dépassé le nombre maximal de caractères",
  yt = () => "Il nome dell'alleanza ha superato il numero massimo di caratteri",
  bt = () => "アライアンス名が最大文字数を超えています。",
  vt = () => "Nazwa sojuszu przekroczyła maksymalną liczbę znaków",
  kt = () => "Название альянса превышает максимальную длину",
  St = () => "Назва альянсу перевищує максимально допустиму кількість символів",
  xt = () => "Tên liên minh vượt quá số ký tự cho phép",
  Tt = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? ft() : e === "pt" ? mt() : e === "ch" ? ht() : e === "de" ? pt() : e === "es" ? gt() : e === "fr" ? wt() : e === "it" ? yt() : e === "jp" ? bt() : e === "pl" ? vt() : e === "ru" ? kt() : e === "uk" ? St() : xt()
  },
  Et = () => "Alliance with empty name",
  At = () => "Aliança com nome vazio",
  jt = () => "名称为空的联盟",
  Pt = () => "Allianz mit leerem Namen",
  It = () => "Alianza con nombre vacío",
  Nt = () => "Alliance avec nom vide",
  zt = () => "Alleanza con nome vuoto",
  qt = () => "名前が空のアライアンスです。",
  Ot = () => "Sojusz z pustą nazwą",
  Dt = () => "Альянс с пустым названием",
  Ct = () => "Альянс із порожньою назвою",
  Mt = () => "Liên minh không có tên",
  Bt = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Et() : e === "pt" ? At() : e === "ch" ? jt() : e === "de" ? Pt() : e === "es" ? It() : e === "fr" ? Nt() : e === "it" ? zt() : e === "jp" ? qt() : e === "pl" ? Ot() : e === "ru" ? Dt() : e === "uk" ? Ct() : Mt()
  },
  Lt = () => "Botting",
  $t = () => "Uso de bots",
  Ut = () => "脚本",
  ...
  Zt = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Lt() : e === "pt" ? $t() : e === "ch" ? Ut() : e === "de" ? Rt() : e === "es" ? Gt() : e === "fr" ? Ft() : e === "it" ? Vt() : e === "jp" ? Jt() : e === "pl" ? Wt() : e === "ru" ? Kt() : e === "uk" ? Ht() : Yt()
  },
  Xt = () => "Breaking the rules",
  Qt = () => "Quebrar as regras",
  en = () => "违反规则",
  tn = () => "Regeln brechen",
  nn = () => "Romper las reglas",
  rn = () => "Violation des règles",
  an = () => "Violazione delle regole",
  sn = () => "ルール違反",
  on = () => "Łamanie zasad",
  un = () => "Нарушение правил",
  cn = () => "Порушення правил",
  ...
  ln = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Xt() : e === "pt" ? Qt() : e === "ch" ? en() : e === "de" ? tn() : e === "es" ? nn() : e === "fr" ? rn() : e === "it" ? an() : e === "jp" ? sn() : e === "pl" ? on() : e === "ru" ? un() : e === "uk" ? cn() : dn()
  },
  _n = () => "You cannot paint over event pixels",
  fn = () => "Você não pode pintar sobre pixels de eventos",
  mn = () => "你不能覆盖活动像素",
  hn = () => "Du kannst nicht über Event-Pixel malen",
  pn = () => "No puedes pintar sobre píxeles de evento",
  gn = () => "Vous ne pouvez pas peindre sur des pixels d’événement",
  wn = () => "Non puoi dipingere sopra i pixel dell'evento",
  yn = () => "イベント用のピクセルの上には塗れません。",
  bn = () => "Nie możesz malować po pikselach wydarzenia",
  vn = () => "Вы не можете рисовать по пикселям события",
  kn = () => "Ви не можете малювати поверх пікселів події",
  Sn = () => "Bạn không thể tô lên pixel sự kiện",
  xn = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? _n() : e === "pt" ? fn() : e === "ch" ? mn() : e === "de" ? hn() : e === "es" ? pn() : e === "fr" ? gn() : e === "it" ? wn() : e === "jp" ? yn() : e === "pl" ? bn() : e === "ru" ? vn() : e === "uk" ? kn() : Sn()
  },
  Tn = () => "Can't reach the server. Maybe you are without internet connection or the server is down. Try again later",
  En = () => "Não é possível acessar o servidor. Talvez você esteja sem conexão com a internet ou o servidor esteja fora do ar. Tente novamente mais tarde.",
  An = () => "无法连接到服务器。可能是你没有网络，或服务器已离线。请稍后重试。",
  jn = () => "Server nicht erreichbar. Vielleicht hast du keine Internetverbindung oder der Server ist offline. Versuche es später erneut.",
  Pn = () => "No se puede conectar con el servidor. Puede que estés sin internet o el servidor esté caído. Inténtalo de nuevo más tarde.",
  In = () => "Impossible d’atteindre le serveur. Vous n’êtes peut-être pas connecté à Internet ou le serveur est hors ligne. Réessayez plus tard.",
  ...
  qn = () => "Nie można połączyć się z serwerem. Być może nie masz internetu lub serwer nie działa. Spróbuj ponownie później.",
  On = () => "Не удаётся подключиться к серверу. Возможно, у вас нет доступа к интернету или сервер недоступен. Попробуйте позже.",
  Dn = () => "Не вдається підключитися до сервера. Можливо, у вас немає інтернет-зʼєднання або сервер недоступний. Спробуйте пізніше.",
  Cn = () => "Không thể kết nối tới máy chủ. Có thể bạn đang mất kết nối mạng hoặc máy chủ đang tạm ngưng. Hãy thử lại sau",
  Mn = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Tn() : e === "pt" ? En() : e === "ch" ? An() : e === "de" ? jn() : e === "es" ? Pn() : e === "fr" ? In() : e === "it" ? Nn() : e === "jp" ? zn() : e === "pl" ? qn() : e === "ru" ? On() : e === "uk" ? Dn() : Cn()
  },
  Bn = () => "Couldn't complete the purchase. This item does not exist.",
  Ln = () => "Não foi possível concluir a compra. Este item não existe.",
  $n = () => "无法完成购买。该物品不存在。",
  Un = () => "Kauf konnte nicht abgeschlossen werden. Dieses Item existiert nicht.",
  Rn = () => "No se pudo completar la compra. Este ítem no existe.",
  Gn = () => "Achat impossible. Cet objet n’existe pas.",
  Fn = () => "Impossibile completare l'acquisto. Questo oggetto non esiste.",
  Vn = () => "購入を完了できませんでした。このアイテムは存在しません。",
  Jn = () => "Nie udało się dokończyć zakupu. Ten przedmiot nie istnieje.",
  Wn = () => "Не удалось завершить покупку. Этот предмет не существует.",
  Kn = () => "Не вдалося завершити покупку. Цей предмет не існує.",
  Hn = () => "Không thể hoàn tất giao dịch. Vật phẩm này không tồn tại.",
  Yn = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Bn() : e === "pt" ? Ln() : e === "ch" ? $n() : e === "de" ? Un() : e === "es" ? Rn() : e === "fr" ? Gn() : e === "it" ? Fn() : e === "jp" ? Vn() : e === "pl" ? Jn() : e === "ru" ? Wn() : e === "uk" ? Kn() : Hn()
  },
  Zn = () => "We’re currently experiencing high traffic. Some requests may not be processed at this time—please try again later. Thank you for your patience.",
  Xn = () => "Estamos enfrentando um volume alto de acessos no momento. Algumas solicitações podem não ser processadas agora — por favor, tente novamente mais tarde. Agradecemos a sua compreensão.",
  Qn = () => "我们当前正遭遇高流量。一些请求可能无法立即处理——请稍后再试。感谢你的耐心。",
  er = () => "Wir haben gerade sehr viel Traffic. Einige Anfragen können momentan nicht verarbeitet werden – bitte versuche es später erneut. Danke für deine Geduld.",
  tr = () => "Actualmente estamos recibiendo mucho tráfico. Es posible que algunas solicitudes no se procesen en este momento; inténtalo de nuevo más tarde. Gracias por tu paciencia.",
  nr = () => "Nous subissons actuellement un trafic élevé. Certaines requêtes peuvent ne pas être traitées pour le moment — veuillez réessayer plus tard. Merci pour votre patience.",
  rr = () => "Stiamo affrontando un elevato volume di accessi in questo momento. Alcune richieste potrebbero non essere elaborate ora — riprova più tardi. Grazie per la comprensione.",
  ar = () => "現在アクセスが集中しています。一部のリクエストが処理されない場合があります。しばらくしてからもう一度お試しください。ご理解ありがとうございます。",
  sr = () => "Obecnie doświadczamy dużego ruchu. Niektóre żądania mogą nie zostać teraz przetworzone — spróbuj ponownie później. Dziękujemy za cierpliwość.",
  or = () => "Сейчас мы испытываем очень высокую нагрузку. Некоторые запросы могут не обрабатываться — попробуйте позже. Спасибо за ваше терпение.",
  ir = () => "Зараз ми отримуємо великий обсяг трафіку. Деякі запити можуть тимчасово не оброблятися — будь ласка, спробуйте пізніше. Дякуємо за розуміння.",
  ur = () => "Hiện chúng tôi đang chịu lượng truy cập rất cao. Một số yêu cầu có thể không được xử lý ngay bây giờ — hãy thử lại sau. Cảm ơn bạn đã thông cảm.",
  cr = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Zn() : e === "pt" ? Xn() : e === "ch" ? Qn() : e === "de" ? er() : e === "es" ? tr() : e === "fr" ? nr() : e === "it" ? rr() : e === "jp" ? ar() : e === "pl" ? sr() : e === "ru" ? or() : e === "uk" ? ir() : ur()
  },
  dr = () => "Doxxing",
  lr = () => "Doxxing",
  _r = () => "人肉搜索",
  ...
  kr = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? dr() : e === "pt" ? lr() : e === "ch" ? _r() : e === "de" ? fr() : e === "es" ? mr() : e === "fr" ? hr() : e === "it" ? pr() : e === "jp" ? gr() : e === "pl" ? wr() : e === "ru" ? yr() : e === "uk" ? br() : vr()
  },
  Sr = n => `Error while painting: ${n.err}`,
  xr = n => `Erro enquanto pinta: ${n.err}`,
  Tr = n => `绘制时出错：${n.err}`,
  Er = n => `Fehler beim Malen: ${n.err}`,
  Ar = n => `Error al pintar: ${n.err}`,
  jr = n => `Erreur lors de la peinture : ${n.err}`,
  Pr = n => `Errore durante la pittura: ${n.err}`,
  Ir = n => `ペイント中にエラーが発生しました: ${n.err}`,
  Nr = n => `Błąd podczas malowania: ${n.err}`,
  zr = n => `Ошибка при рисовании: ${n.err}`,
  qr = n => `Помилка під час малювання: ${n.err}`,
  Or = n => `Lỗi khi tô: ${n.err}`,
  Dr = (n, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Sr(n) : e === "pt" ? xr(n) : e === "ch" ? Tr(n) : e === "de" ? Er(n) : e === "es" ? Ar(n) : e === "fr" ? jr(n) : e === "it" ? Pr(n) : e === "jp" ? Ir(n) : e === "pl" ? Nr(n) : e === "ru" ? zr(n) : e === "uk" ? qr(n) : Or(n)
  },
  Cr = () => "Griefing",
  Mr = () => "Griefing",
  Br = () => "破坏行为",
  ...
  Kr = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Cr() : e === "pt" ? Mr() : e === "ch" ? Br() : e === "de" ? Lr() : e === "es" ? $r() : e === "fr" ? Ur() : e === "it" ? Rr() : e === "jp" ? Gr() : e === "pl" ? Fr() : e === "ru" ? Vr() : e === "uk" ? Jr() : Wr()
  },
  Hr = () => "Hate speech",
  Yr = () => "Discurso de Ódio",
  Zr = () => "仇恨言论",
  ...
  ia = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Hr() : e === "pt" ? Yr() : e === "ch" ? Zr() : e === "de" ? Xr() : e === "es" ? Qr() : e === "fr" ? ea() : e === "it" ? ta() : e === "jp" ? na() : e === "pl" ? ra() : e === "ru" ? aa() : e === "uk" ? sa() : oa()
  },
  ua = () => "Inappropriate content",
  ca = () => "Conteúdo inapropriado",
  da = () => "不当内容",
  la = () => "Unangemessene Inhalte",
  _a = () => "Contenido inapropiado",
  fa = () => "Contenu inapproprié",
  ma = () => "Contenuto inappropriato",
  ha = () => "不適切なコンテンツ",
  pa = () => "Nieodpowiednie treści",
  ga = () => "Неприемлемый контент",
  wa = () => "Неприйнятний вміст",
  ya = () => "Nội dung không phù hợp",
  ba = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? ua() : e === "pt" ? ca() : e === "ch" ? da() : e === "de" ? la() : e === "es" ? _a() : e === "fr" ? fa() : e === "it" ? ma() : e === "jp" ? ha() : e === "pl" ? pa() : e === "ru" ? ga() : e === "uk" ? wa() : ya()
  },
  va = () => "Invalid code",
  ka = () => "Código inválido",
  Sa = () => "验证码无效",
  ...
  ja = () => "無効なコードです。",
  Pa = () => "Nieprawidłowy kod",
  Ia = () => "Неверный код",
  Na = () => "Невірний код",
  za = () => "Mã không hợp lệ",
  qa = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? va() : e === "pt" ? ka() : e === "ch" ? Sa() : e === "de" ? xa() : e === "es" ? Ta() : e === "fr" ? Ea() : e === "it" ? Aa() : e === "jp" ? ja() : e === "pl" ? Pa() : e === "ru" ? Ia() : e === "uk" ? Na() : za()
  },
  Oa = () => "Invalid discord.",
  Da = () => "Discord inválido.",
  Ca = () => "无效的 Discord。",
  Ma = () => "Ungültiger Discord.",
  Ba = () => "Discord inválido.",
  La = () => "Discord invalide.",
  $a = () => "Discord non valido.",
  Ua = () => "無効なDiscordアカウントです。",
  Ra = () => "Nieprawidłowy Discord.",
  Ga = () => "Неверный Discord.",
  Fa = () => "Некоректний Discord.",
  Va = () => "Discord không hợp lệ.",
  Ja = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Oa() : e === "pt" ? Da() : e === "ch" ? Ca() : e === "de" ? Ma() : e === "es" ? Ba() : e === "fr" ? La() : e === "it" ? $a() : e === "jp" ? Ua() : e === "pl" ? Ra() : e === "ru" ? Ga() : e === "uk" ? Fa() : Va()
  },
  Wa = () => "The name contains disallowed characters or words. Please choose a different name.",
  Ka = () => "O nome contém caracteres ou palavras não permitidas. Por favor, escolha outro nome.",
  Ha = () => "名称包含禁止的字符或词语，请选择其他名称。",
  Ya = () => "Der Name enthält nicht erlaubte Zeichen oder Wörter. Bitte wähle einen anderen Namen.",
  Za = () => "El nombre contiene caracteres o palabras no permitidas. Elige otro nombre.",
  Xa = () => "Le nom contient des caractères ou des mots non autorisés. Veuillez choisir un autre nom.",
  Qa = () => "Il nome contiene caratteri o parole non consentiti. Scegli un altro nome.",
  es = () => "この名前には使用できない文字または単語が含まれています。別の名前を選んでください。",
  ts = () => "Nazwa zawiera niedozwolone znaki lub słowa. Wybierz inną nazwę.",
  ns = () => "Имя содержит запрещённые символы или слова. Пожалуйста, выберите другое имя.",
  rs = () => "Імʼя містить заборонені символи або слова. Оберіть інше імʼя.",
  as = () => "Tên chứa ký tự hoặc từ không được phép. Hãy chọn tên khác.",
  ss = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Wa() : e === "pt" ? Ka() : e === "ch" ? Ha() : e === "de" ? Ya() : e === "es" ? Za() : e === "fr" ? Xa() : e === "it" ? Qa() : e === "jp" ? es() : e === "pl" ? ts() : e === "ru" ? ns() : e === "uk" ? rs() : as()
  },
  ...
  Ts = () => "Il nuovo leader deve essere un membro dell'alleanza",
  Es = () => "新しいリーダーはアライアンスのメンバーである必要があります。",
  ...
  Ns = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? ys() : e === "pt" ? bs() : e === "ch" ? vs() : e === "de" ? ks() : e === "es" ? Ss() : e === "fr" ? xs() : e === "it" ? Ts() : e === "jp" ? Es() : e === "pl" ? As() : e === "ru" ? js() : e === "uk" ? Ps() : Is()
  },
  ...
  $s = () => "Ranking jest tymczasowo wyłączony",
  Us = () => "Таблица лидеров временно отключена",
  Rs = () => "Таблиця лідерів тимчасово вимкнена",
  Gs = () => "Bảng xếp hạng tạm thời bị vô hiệu hóa",
  j = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? zs() : e === "pt" ? qs() : e === "ch" ? Os() : e === "de" ? Ds() : e === "es" ? Cs() : e === "fr" ? Ms() : e === "it" ? Bs() : e === "jp" ? Ls() : e === "pl" ? $s() : e === "ru" ? Us() : e === "uk" ? Rs() : Gs()
  },
  ...
  To = n => `Następną zmianę nazwy możesz wykonać za ${n.days} dni`,
  Eo = n => `Вы сможете изменить имя снова через ${n.days} дн.`,
  Ao = n => `Ви зможете змінити імʼя знову через ${n.days} днів`,
  jo = n => `Bạn có thể đổi tên lại sau ${n.days} ngày`,
  Po = (n, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? go(n) : e === "pt" ? wo(n) : e === "ch" ? yo(n) : e === "de" ? bo(n) : e === "es" ? vo(n) : e === "fr" ? ko(n) : e === "it" ? So(n) : e === "jp" ? xo(n) : e === "pl" ? To(n) : e === "ru" ? Eo(n) : e === "uk" ? Ao(n) : jo(n)
  },
  ...
  $o = () => "Немає доступу до інтернету або сервери недоступні. Спробуйте пізніше.",
  Uo = () => "Không có kết nối internet hoặc máy chủ đang ngoại tuyến. Hãy thử lại sau.",
  Ro = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? Io() : e === "pt" ? No() : e === "ch" ? zo() : e === "de" ? qo() : e === "es" ? Oo() : e === "fr" ? Do() : e === "it" ? Co() : e === "jp" ? Mo() : e === "pl" ? Bo() : e === "ru" ? Lo() : e === "uk" ? $o() : Uo()
  },
  ...
  Ti = () => "Номер телефону вже використовується",
  Ei = () => "Số điện thoại đã được sử dụng",
  Ai = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? hi() : e === "pt" ? pi() : e === "ch" ? gi() : e === "de" ? wi() : e === "es" ? yi() : e === "fr" ? bi() : e === "it" ? vi() : e === "jp" ? ki() : e === "pl" ? Si() : e === "ru" ? xi() : e === "uk" ? Ti() : Ei()
  },
  ...
  $i = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? ji() : e === "pt" ? Pi() : e === "ch" ? Ii() : e === "de" ? Ni() : e === "es" ? zi() : e === "fr" ? qi() : e === "it" ? Oi() : e === "jp" ? Di() : e === "pl" ? Ci() : e === "ru" ? Mi() : e === "uk" ? Bi() : Li()
  },
  ...
  he = () => "Failed to load WebAssembly module. Try to use another browser.",
  _u = () => "Erro ao carregar módulo WebAssembly. Tente usar outro navegador.",
  fu = () => "Fehler beim Laden des WebAssembly-Moduls. Versuche, einen anderen Browser zu verwenden.",
  mu = () => "Error al cargar el módulo WebAssembly. Intenta usar otro navegador.",
  hu = () => "Erreur lors du chargement du module WebAssembly. Essayez d’utiliser un autre navigateur.",
  pu = () => "Errore nel caricamento del modulo WebAssembly. Prova a usare un altro browser.",
  gu = () => "WebAssembly モジュールの読み込みに失敗しました。別のブラウザをお試しください。",
  wu = () => "Nie udało się załadować modułu WebAssembly. Spróbuj użyć innej przeglądarki.",
  yu = () => "Ошибка при загрузке модуля WebAssembly. Попробуйте использовать другой браузер.",
  bu = () => "Не вдалося завантажити модуль WebAssembly. Спробуйте інший браузер.",
  vu = () => "Lỗi tải mô-đun WebAssembly. Hãy thử dùng trình duyệt khác.",
  ku = he,
  Su = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? he() : e === "pt" ? _u() : e === "ch" ? ku() : e === "de" ? fu() : e === "es" ? mu() : e === "fr" ? hu() : e === "it" ? pu() : e === "jp" ? gu() : e === "pl" ? wu() : e === "ru" ? yu() : e === "uk" ? bu() : vu()
  },
  xu = () => "You already have this item. Please refresh the page.",
  ...
  Cu = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? xu() : e === "pt" ? Tu() : e === "ch" ? Eu() : e === "de" ? Au() : e === "es" ? ju() : e === "fr" ? Pu() : e === "it" ? Iu() : e === "jp" ? Nu() : e === "pl" ? zu() : e === "ru" ? qu() : e === "uk" ? Ou() : Du()
  },
  ...
  Sc = () => "你需要等待一段时间才能重新发送验证码",
  xc = () => "Du musst warten, bevor du einen Code erneut senden kannst",
  ...
  qc = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? vc() : e === "pt" ? kc() : e === "ch" ? Sc() : e === "de" ? xc() : e === "es" ? Tc() : e === "fr" ? Ec() : e === "it" ? Ac() : e === "jp" ? jc() : e === "pl" ? Pc() : e === "ru" ? Ic() : e === "uk" ? Nc() : zc()
  },
  ...
  sd = () => "Your account has been banned for violating the rules",
  od = () => "A sua conta foi banida por quebrar as regras",
  id = () => "你的账号因违反规则已被封禁",
  ud = () => "Dein Konto wurde wegen Regelverstößen gebannt",
  cd = () => "Tu cuenta ha sido baneada por infringir las reglas",
  dd = () => "Votre compte a été banni pour avoir enfreint les règles",
  ld = () => "Il tuo account è stato bannato per aver infranto le regole",
  _d = () => "ルール違反により、あなたのアカウントはBANされました。",
  fd = () => "Twoje konto zostało zbanowane za łamanie zasad",
  md = () => "Ваш аккаунт был забанен за нарушение правил",
  hd = () => "Ваш акаунт заблоковано за порушення правил",
  pd = () => "Tài khoản của bạn đã bị khóa vì vi phạm luật",
  gd = (n = {}, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? sd() : e === "pt" ? od() : e === "ch" ? id() : e === "de" ? ud() : e === "es" ? cd() : e === "fr" ? dd() : e === "it" ? ld() : e === "jp" ? _d() : e === "pl" ? fd() : e === "ru" ? md() : e === "uk" ? hd() : pd()
  },
  wd = n => `Your account has been suspended out until ${n.until}`,
  yd = n => `A sua conta está suspensa até ${n.until}`,
  bd = n => `你的账号已被暂停至 ${n.until}`,
  vd = n => `Dein Konto ist gesperrt bis ${n.until}`,
  kd = n => `Tu cuenta ha sido suspendida hasta ${n.until}`,
  Sd = n => `Votre compte est suspendu jusqu’au ${n.until}`,
  xd = n => `Il tuo account è sospeso fino al ${n.until}`,
  Td = n => `あなたのアカウントは${n.until}まで一時停止されています。`,
  Ed = n => `Twoje konto zostało zawieszone do ${n.until}`,
  Ad = n => `Ваш аккаунт заблокирован до ${n.until}`,
  jd = n => `Ваш акаунт призупинено до ${n.until}`,
  Pd = n => `Tài khoản của bạn đã bị đình chỉ đến ${n.until}`,
  Id = (n, t = {}) => {
    const e = t.locale ?? _();
    return e === "en" ? wd(n) : e === "pt" ? yd(n) : e === "ch" ? bd(n) : e === "de" ? vd(n) : e === "es" ? kd(n) : e === "fr" ? Sd(n) : e === "it" ? xd(n) : e === "jp" ? Td(n) : e === "pl" ? Ed(n) : e === "ru" ? Ad(n) : e === "uk" ? jd(n) : Pd(n)
  };
let p;
...
function D(n, t) {
  return n = n >>> 0, pe.decode(Z().subarray(n, n + t))
}
...
function qd(n) {
  const t = ge(n, p.__wbindgen_malloc, p.__wbindgen_realloc),
    e = ee;
  p.request_url(t, e)
}
...
function Dd(n) {
  let t, e;
  try {
    const r = ge(n, p.__wbindgen_malloc, p.__wbindgen_realloc),
      a = ee,
...
function Bd(n, t) {
  return p = n.exports, we.__wbindgen_wasm_module = t, O = null, p.__wbindgen_start(), p
}
async function we(n) {
...
class Rd {
  constructor() {
    ...
    w(this, G, z(() => {
      ...
      const e = t.count + Math.max((Ne.now - this.lastFetch) / t.cooldownMs, 0);
  ...
  async refresh() {
    ...
    try {
      ...
      }), (t = this.data) != null && t.id && ze("userId", {
        id: this.data.id
      }), !!this.data
    } catch (e) {
      return console.error(e), _e.warning(Ro(), {
        duration: 1e4
      }), !1
    } finally {
      this.loading = !1
  ...
  hasPermission(t) {
    var e;
    return ye((e = this.data) == null ? void 0 : e.permissions, t)
  }
  hasAnyPermission(t) {
    var e;
...
const gl = {
  ...
  ne = K,
  ve = K.seasons.length - 1,
  yl = K.seasons[ve].zoom,
  bl = K.seasons[ve].tileSize,
  vl = K.permissions;
...
class Qd {
  ...
  async sendPaintRequests(t, e, r) {
    ...
    const i = (await Promise.all(Object.values(a).map(l => {
      const [c, h] = l[0].tile, f = l[0].season, T = {
        colors: l.map(S => S.colorIdx),
        coords: l.flatMap(S => S.pixel),
        fp: e
      }, A = JSON.stringify(T), k = r(f, c, h);
    ...
    if (i.length) {
      ...
      if (l.status === 403) {
        if (l.headers.get("cf-mitigated") === "challenge") throw new Error(cr());
        const c = await l.json();
        if ((c == null ? void 0 : c.error) === "refresh") throw new Error($i());
        if ((c == null ? void 0 : c.error) === "color-not-owned") throw new Error(mi());
        if ((c == null ? void 0 : c.error) === "event-pixel-present") throw new Error(xn());
        I.refresh()
      } else if (l.status === 451) {
        const c = await i[0].json();
        c == null || c.err;
        const h = c == null ? void 0 : c.suspension;
        if (h === "ban") throw new Error(gd());
        if (h === "timeout") {
          const f = new Date(Date.now() + ((c == null ? void 0 : c.durationMs) ?? 0));
          throw new Error(Id({
  ...
  async getPixelAreaInfo({
    ...
    if (l.status !== 200) {
      ...
      throw console.error("Error while fetching pixel area info", f), new Error(o())
    }
  ...
  async verifyOtp(t) {
    ...
    if (e.status === 400) throw new Error(qa());
    if (e.status !== 200) throw new Error(o());
    return await e.json()
  }
  async updateMe(t) {
    ...
    if (e.status === 400) {
      ...
      if (a === "invalid_name") throw new Error(ss());
      if (a === "invalid_discord") throw new Error(Ja());
  ...
  async purchase(t) {
    ...
    if (e.status !== 200) throw e.status === 404 ? new Error(Yn()) : e.status === 403 ? new Error(bc()) : e.status === 409 ? new Error(Cu()) : new Error(o())
  }
  async getAlliance() {
  ...
  async createAlliance(t) {
    ...
    if (e.status === 400) {
      const r = await e.json();
      throw r.error === "max_characters" ? new Error(Tt()) : r.error === "name_taken" ? new Error(_t()) : r.error == "empty_name" ? new Error(Bt()) : new Error(o())
  ...
  async generatePixQrCode(t) {
    ...
    if (e.status === 400) {
      ...
      if (e.status === 451) throw new Error(Qe());
      if (e.status !== 200) throw new Error(o())
    }
    return await e.json()
  }
  ...
  async request(t, e) {
    ...
    try {
      ...
      throw console.error("Fetch error:", s), this.online = !1, new Error(Mn(), {
        cause: s
      })
    }
  ...
  async getUserTickets(t, e) {
    ...
    const h = await c.json(),
      f = Array.isArray(h == null ? void 0 : h.tickets) ? h.tickets : [];
    return f.sort((T, A) => new Date(A.createdAt).getTime() - new Date(T.createdAt).getTime()), f
  }
  ...
  mapTicketsToReportRows(t, e) {
    ...
    for (const c of t) {
      ...
      if (e === "received") {
        for (const f of c.reports) r.push({
          id: String(f.id),
          ticketId: String(c.id),
          createdAt: f.createdAt ?? c.createdAt,
          byUser: {
...
function el(n) {
  ...
  const f = new Uint8ClampedArray(c * h * 4);
  for (const {
      x: k,
      y: S,
      colorIdx: x
    ...
    of l) {
    const ae = (A = ne.colors) == null ? void 0 : A[x];
    if (!ae) throw new Error(`Unknown palette color index: ${x}`);
    const xe = k - a,
      H = ((S - s) * c + xe) * 4,
      [Te, Ee, Ae] = ae.rgb;
    f[H] = Te, f[H + 1] = Ee, f[H + 2] = Ae, f[H + 3] = x === 0 ? 0 : 255
  }
  return {
    data: f,
    width: c,
...
function xl() {
  const n = be("2025-09_pawtect");
  if (!n) throw new Error("pawtect experiment not found on load");
  n.variant !== "disabled" && (re || I.data && we($e).then(rl).catch(t => {
    ke = t, qe(t)
  }))
}
