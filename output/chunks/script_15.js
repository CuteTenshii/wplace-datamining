...
class y {
  constructor() {
    ...
    n(this, h, s(!0));
    n(this, b, s(p(Date.now())));
    n(this, f, s(void 0));
    setInterval(() => {
      r(a(this, b), Date.now(), !0)
...
l = new WeakMap, g = new WeakMap, u = new WeakMap, d = new WeakMap, c = new WeakMap, h = new WeakMap, b = new WeakMap, f = new WeakMap;
const U = new y;
