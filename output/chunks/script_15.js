...
var u = (n, e, a) => V(n, typeof e != "symbol" ? e + "" : e, a),
  Y = (n, e, a) => e.has(n) || q("Cannot " + a);
var d = (n, e, a) => (Y(n, e, "read from private field"), a ? a.call(n) : e.get(n)),
  g = (n, e, a) => e.has(n) ? q("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(n) : e.set(n, a);
import {
  aK as G,
  aL as b,
  g as h,
...
class Qa {
  ...
  async paint(e, a) {
    const t = Fa(e, r => `t=(${r.tile[0]},${r.tile[1]}),s=${r.season}`),
      s = (await Promise.all(Object.values(t).map(r => {
        const [l, _] = r[0].tile, S = r[0].season, J = {
          colors: r.map(L => L.colorIdx),
          coords: r.flatMap(L => L.pixel),
          t: a
        };
        return this.request(`/s${S}/pixel/${l}/${_}`, {
          method: "POST",
    ...
    if (s.length) {
      ...
      if (r.status === 403) {
        ...
        l == null || l.err;
        const _ = l == null ? void 0 : l.suspension;
        if (_ === "ban") throw new Error(xa());
        if (_ === "timeout") {
          const S = new Date(Date.now() + ((l == null ? void 0 : l.durationMs) ?? 0));
          throw new Error(Na({
  ...
  async getPixelInfo({
    ...
    const r = await this.request(`/s${e}/pixel/${a}/${t}?x=${c}&y=${s}`);
    if (r.status !== 200) {
  ...
  async purchase(e) {
    ...
    if (a.status !== 200) throw a.status === 404 ? new Error(Ce()) : a.status === 403 ? new Error(ke()) : a.status === 409 ? new Error(De()) : new Error(o())
  }
  async getAlliance() {
  ...
  async createAlliance(e) {
    ...
    if (a.status === 400) {
      const t = await a.json();
      throw t.error === "max_characters" ? new Error(Ge()) : t.error === "name_taken" ? new Error(Re()) : t.error == "empty_name" ? new Error($e()) : new Error(o())
  ...
  async updateAllianceHeadquarters(e, a) {
    ...
    if (t.status !== 200) throw t.status === 403 ? new Error(w()) : new Error(o())
  }
  ...
  async getModeratorTickets() {
    ...
    for (const t of a.tickets) t.reports.sort((c, s) => R[c.reason] - R[s.reason]);
    return a
  }
...
class et {
  ...
  set(e, a) {
    ...
    if (t >= this.bytes.length) {
      ...
      for (let _ = 0; _ < this.bytes.length; _++) r[_ + l] = this.bytes[_];
      this.bytes = r
    }
    const s = this.bytes.length - 1 - t;
    a ? this.bytes[s] = this.bytes[s] | 1 << c : this.bytes[s] = this.bytes[s] & ~(1 << c)
  }
  get(e) {
    const a = Math.floor(e / 8),
      t = e % 8,
      c = this.bytes.length;
    return a > c ? !1 : (this.bytes[c - 1 - a] & 1 << t) !== 0
  }
}
  ...
  constructor() {
    ...
    u(this, "create", e => {
      ...
      const {
        message: a,
        ...t
      } = e, c = typeof(e == null ? void 0 : e.id) == "number" || e.id && ((l = e.id) == null ? void 0 : l.length) > 0 ? e.id : F++, s = e.dismissable === void 0 ? !0 : e.dismissable, r = e.type === void 0 ? "default" : e.type;
      return U(() => {
        this.toasts.find(S => S.id === c) ? this.updateToast({
          id: c,
          data: e,
          type: r,
          message: a,
...
class St {
  constructor() {
    g(this, D, B(() => f.toasts.filter(e => !e.dismiss)))
  }
  get toasts() {
    return h(d(this, D))
  }
...
const ot = rt,
  st = Object.assign(ot, {
    ...
    dismiss: f.dismiss,
    loading: f.loading,
    getActiveToasts: () => f.toasts.filter(n => !n.dismiss)
  });
var A, I, C, M, O, k, x;
class it {
  constructor() {
    ...
    g(this, O, B(() => {
      ...
      const a = e.count + Math.max(($.now - this.lastFetch) / e.cooldownMs, 0);
      return Math.min(e.max, a)
    }));
    g(this, k, B(() => this.charges !== void 0 && this.data ? (1 - this.charges % 1) * this.data.charges.cooldownMs : void 0));
    g(this, x, B(() => {
      var e;
...
A = new WeakMap, I = new WeakMap, C = new WeakMap, M = new WeakMap, O = new WeakMap, k = new WeakMap, x = new WeakMap;
const ct = new it;
export {
  K as C, gt as P, Wa as S, j as a, o as b, z as c, f as d, bt as e, St as f, $ as g, ht as h, ma as i, wa as j, Ta as k, ha as l, Sa as m, yt as n, pt as o, wt as p, mt as q, ft as r, _t as s, st as t, ct as u
};