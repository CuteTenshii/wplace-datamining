    ...
    fe = c(o($), 2);
  {
    var _e = _ => {
      ...
      Ce(ne, 21, () => de, a => a.value, (a, r) => {
        ...
        }), Oe(i, [], d, () => (s(r).value, s(T)), P => h(T, P)), b(a, l)
      }), n(ne), n(H);
      var V = c(H, 2),
        ye = o(V);
      {
      ...
      var G = c(L, 2),
        Re = o(G, !0);
      n(G), n(oe), n(v), je(v, a => h(E, a), () => s(E)), k((a, r, l, d) => {
        ue(v, "action", pe[e.action]), z(A, e.paintedBy.id), z(O, e.latLon[0]), z(j, e.latLon[1]), z(N, e.zoom), Me(Y, 1, `font-medium ${a??""} flex gap-1.5`), f(be, e.paintedBy.name), f(he, `#${e.paintedBy.id??""}`), f(xe, `${r??""}:`), f(we, l), G.disabled = s(B), f(Re, d)
