...
const i = () => "Description",
  ...
  T = (t = {}, r = {}) => {
    const e = r.locale ?? n();
    return e === "en" ? i() : e === "pt" ? s() : e === "ch" ? c() : e === "de" ? p() : e === "es" ? o() : e === "fr" ? u() : e === "it" ? d() : e === "jp" ? f() : e === "pl" ? l() : e === "ru" ? _() : e === "uk" ? a() : b()
  },
  x = () => "Pixels painted",
  g = () => "Pixels pintados",
  y = () => "已绘制像素数",
  ...
  L = (t = {}, r = {}) => {
    const e = r.locale ?? n();
    return e === "en" ? x() : e === "pt" ? g() : e === "ch" ? y() : e === "de" ? D() : e === "es" ? h() : e === "fr" ? P() : e === "it" ? k() : e === "jp" ? w() : e === "pl" ? E() : e === "ru" ? I() : e === "uk" ? j() : m()
  };
export {
  T as d, L as p
};