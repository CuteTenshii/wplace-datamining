...
const c = () => "and",
  ...
  Yt = (r = {}, n = {}) => {
    const t = n.locale ?? e();
    return t === "en" ? c() : t === "pt" ? o() : t === "ch" ? u() : t === "de" ? i() : t === "es" ? _() : t === "fr" ? a() : t === "it" ? s() : t === "jp" ? f() : t === "pl" ? l() : t === "ru" ? p() : t === "uk" ? d() : h()
  },
  ...
  st = () => "Privacy Policy",
  ft = () => "Política de privacidade",
  lt = () => "隐私政策",
  pt = () => "Datenschutzerklärung",
  ...
  Zt = (r = {}, n = {}) => {
    const t = n.locale ?? e();
    return t === "en" ? st() : t === "pt" ? ft() : t === "ch" ? lt() : t === "de" ? pt() : t === "es" ? dt() : t === "fr" ? ht() : t === "it" ? yt() : t === "jp" ? mt() : t === "pl" ? vt() : t === "ru" ? gt() : t === "uk" ? bt() : wt()
  },
