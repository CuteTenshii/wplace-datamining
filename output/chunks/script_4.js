  ...
  var Z = void 0,
    Ee = Ze(() => {
      ...
      return tt(A, {
        ...
        if (b && (a.$$events = b), I && Ge(c, null), de = l, Z = s(c, a) || {}, de = !0, I && (x.nodes_end = F, F === null || F.nodeType !== te || F.data !== Je)) throw Ke(), K;
        r && Qe()
      }), () => {
        var Y;
        for (var c of D) {
          ...
          var d = L.get(c);
          --d === 0 ? (document.removeEventListener(c, q), L.delete(c)) : L.set(c, d)
        }
