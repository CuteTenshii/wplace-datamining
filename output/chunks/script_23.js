...
const Oe = (e, t) => {
  ...
  ve = (e, t, o) => {
    ...
    if (a === null) return;
    const p = t === 0 ? e.join(K) : e.slice(t).join(K),
      d = a.length;
    for (let u = 0; u < d; u++) {
      const h = a[u];
      if (h.validator(p)) return h.classGroupId
    }
  },
  ...
  qe = e => {
    ...
    const c = (m, a) => {
      o[m] = a, t++, t > e && (t = 0, r = o, o = Object.create(null))
    };
    return {
      get(m) {
        let a = o[m];
        if (a !== void 0) return a;
        if ((a = r[m]) !== void 0) return c(m, a), a
      },
      set(m, a) {
        m in o ? o[m] = a : c(m, a)
      }
    ...
    return e.orderSensitiveModifiers.forEach((o, r) => {
      ...
      for (let m = 0; m < o.length; m++) {
        const a = o[m],
          p = a[0] === "[",
          d = t.has(a);
        p || d ? (c.length > 0 && (c.sort(), r.push(...c), c = []), r.push(a)) : c.push(a)
      }
  ...
  oo = (e, ...t) => {
    ...
    const a = d => {
        ...
        return o = Ke(u), r = o.cache.get, c = o.cache.set, m = p, p(d)
      },
      p = d => {
        const u = r(d);
        if (u) return u;
    ...
    return {
      ...
      classGroups: {
        ...
        "text-decoration-thickness": [{
          decoration: [b, "from-font", "auto", n, O]
        }],
