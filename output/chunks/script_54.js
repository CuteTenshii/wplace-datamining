...
try {
  (function() {
    var r = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new r.Error().stack;
    e && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[e] = "23c42207-cc8d-425d-b481-4c6797677827", r._sentryDebugIdIdentifier = "sentry-dbid-23c42207-cc8d-425d-b481-4c6797677827")
  })()
} catch {}
...
const wt = () => "and",
  ...
  At = () => "Continuando, accetti i nostri",
  Ft = () => "続行すると、以下に同意したものとみなされます:",
  Nt = () => "Kontynuując, akceptujesz nasze",
  Ut = () => "Продолжая, вы соглашаетесь с нашими",
  qt = () => "Продовжуючи, ви погоджуєтеся з нашими",
  Rt = () => "Khi tiếp tục, bạn đồng ý với",
  Gt = (r = {}, e = {}) => {
    const t = e.locale ?? g();
    return t === "en" ? Mt() : t === "pt" ? Pt() : t === "ch" ? Dt() : t === "de" ? Bt() : t === "es" ? Kt() : t === "fr" ? St() : t === "it" ? At() : t === "jp" ? Ft() : t === "pl" ? Nt() : t === "ru" ? Ut() : t === "uk" ? qt() : Rt()
  },
  Ht = () => "Code of Conduct",
  ...
  ne = (r = {}, e = {}) => {
    const t = e.locale ?? g();
    return t === "en" ? Ht() : t === "pt" ? Ot() : t === "ch" ? Vt() : t === "de" ? Yt() : t === "es" ? Qt() : t === "fr" ? Xt() : t === "it" ? Zt() : t === "jp" ? Jt() : t === "pl" ? $t() : t === "ru" ? te() : t === "uk" ? ee() : re()
  },
  ...
  Se = () => "アカウントを移行",
  Ae = () => "Przenieś swoje konto",
  Fe = () => "Мигрировать аккаунт",
  Ne = () => "Перенести акаунт",
  Ue = () => "Di chuyển tài khoản",
  qe = (r = {}, e = {}) => {
    const t = e.locale ?? g();
    return t === "en" ? Le() : t === "pt" ? We() : t === "ch" ? Me() : t === "de" ? Pe() : t === "es" ? De() : t === "fr" ? Be() : t === "it" ? Ke() : t === "jp" ? Se() : t === "pl" ? Ae() : t === "ru" ? Fe() : t === "uk" ? Ne() : Ue()
  },
  Re = () => "Privacy Policy",
  Ge = () => "Política de privacidade",
  He = () => "隐私政策",
  ...
  Xe = () => "プライバシーポリシー",
  Ze = () => "Polityka prywatności",
  Je = () => "Политика конфиденциальности",
  $e = () => "Політика конфіденційності",
  tr = () => "Chính sách quyền riêng tư",
  er = (r = {}, e = {}) => {
    const t = e.locale ?? g();
    return t === "en" ? Re() : t === "pt" ? Ge() : t === "ch" ? He() : t === "de" ? Oe() : t === "es" ? Ve() : t === "fr" ? Ye() : t === "it" ? Qe() : t === "jp" ? Xe() : t === "pl" ? Ze() : t === "ru" ? Je() : t === "uk" ? $e() : tr()
  },
  rr = () => "Terms of Service",
...
function mr(r, e) {
  ...
  let p = Q(!1);
  mt(() => {
    if (H(p, !0), !G.turnstatileLoaded) {
      const n = document.createElement("script");
      n.type = "text/javascript", n.src = "https://challenges.cloudflare.com/turnstile/v0/api.js?render=explicit", n.async = !0, n.addEventListener("load", () => G.turnstatileLoaded = !0, {
        once: !0
