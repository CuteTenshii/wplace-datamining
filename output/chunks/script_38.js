...
try {
  (function() {
    var n = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new n.Error().stack;
    e && (n._sentryDebugIds = n._sentryDebugIds || {}, n._sentryDebugIds[e] = "29e1de51-aebd-42dd-a7d6-06325d11a0b4", n._sentryDebugIdIdentifier = "sentry-dbid-29e1de51-aebd-42dd-a7d6-06325d11a0b4")
  })()
} catch {}
const Nt = () => "Log Out",
  St = () => "Log Out",
...
function Pa(n, e) {
  let c = qe(e, ["$$slots", "$$events", "$$legacy"]);
  var k = Oa();
  Ae(k, () => ({
...
var Aa = E('<span class="badge badge-sm border-0"> </span>'),
  qa = E("<span> </span>"),
  Za = E('<span class="tooltip"><!></span>'),
  Ma = E('<span class="tooltip"><!></span>'),
  ja = E('<li><button class="text-error py-2 font-medium"> </button></li>'),
  Ga = E('<div><span class="flex gap-1.5"><span> </span> <span> </span></span> <!> <!> <!> <div class="dropdown dropdown-bottom max-sm:dropdown-bottom max-sm:dropdown-left"><button tabindex="0" class="btn btn-xs btn-circle btn-ghost"><!></button> <ul class="dropdown-content menu bg-base-100 z-1 mb-1 w-max gap-0.5 rounded-xl p-2.5 shadow-sm"><li><button class="text-error py-2 font-medium"> </button></li> <!></ul></div></div>'),
  Ha = E("<span> </span>"),
  Va = E('<span class="tooltip"><!></span>'),
  Wa = E('<span class="tooltip"><!></span>'),
  Fa = E('<li class="flex items-center gap-2 px-3 py-2"><!> <div class="min-w-0"><div class="flex flex-wrap items-center gap-1"><span><span> </span> <span> </span></span> <!> <!></div></div></li>'),
  Ja = E('<div class="border-base-300 mt-4 max-h-40 overflow-y-auto rounded-lg border"><ul class="divide-base-200 divide-y"></ul></div>'),
  Ka = E('<label class="flex gap-3"><input name="reason" class="radio radio-sm mt-1" type="radio"/> <div><div class="font-semibold"> </div> <div class="text-base-content/80 text-sm"> </div></div></label>'),
  Ya = E('<form method="POST"><input name="zoom" hidden=""/> <section class="flex gap-3"><!> <div class="min-w-0"><h2 class="text-xl font-semibold"><!></h2> <!></div></section> <!> <section class="mt-6"><h3 class="text-base-content/80 text-base"> </h3> <div class="mt-2 flex flex-col gap-3"></div></section> <section class="mt-6"><!></section> <section class="mt-3 flex justify-end gap-2"><button type="button" class="btn"> </button> <button class="btn btn-error"> </button></section></form>'),
  Qa = E('<dialog class="modal"><div class="modal-box max-h-[97%] max-w-xl"><form method="dialog"><button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button></form> <!></div> <form method="dialog" class="modal-backdrop"><button>close</button></form></dialog>');
...
function Lr(n, e) {
  ...
  async function je(y) {
    try {
      ...
      for (const b of y)
        if (b.id !== 0) try {
          await be.postReportUserName(b.id), U.success(Da())
        } catch {
          U.error(Z())
        }
    } catch {
  ...
  async function Ge(y) {
    try {
      ...
      for (const b of y)
        if (b.allianceId) try {
          await be.postReportAllianceName(b.allianceId), U.success(Ca())
        } catch {
          U.error(Z())
        }
    } catch {
    ...
    He = p(r(he), 2);
  {
    var Ve = y => {
        ...
        Fe = r(ce);
      {
        ...
        R(Fe, s => {
          e.action === "report-user" ? s(Je) : s(Ke, !1)
        })
      }
      a(ce);
      var Ye = p(ce, 2);
        ...
        var Qe = s => {
          ...
          var _ = p(d, 2);
          {
            var z = u => {
              var i = Aa(),
                N = r(i);
              a(i), T(() => x(N, `+${e.targets.length-1} more`)), v(u, i)
            };
            R(_, u => {
          ...
          var I = p(_, 2);
          {
            var B = u => {
              var i = qa(),
                N = r(i, !0);
              a(i), T((C, q) => {
                ne(i, 1, `badge badge-sm ml-0.5 border-0 ${C??""} ${q??""}`), x(N, t(L).allianceName)
              }, [() => Ue(t(L).allianceId), () => oe(t(L).allianceId)]), v(u, i)
            };
            R(I, u => {
              t(L).allianceId && t(L).allianceName && u(B)
            })
          }
          var M = p(I, 2);
          {
            var X = u => {
                ...
                }), a(i), T(C => j(i, "data-tip", C), [() => Be()]), v(u, i)
              },
              ve = u => {
                var i = ae(),
                  N = re(i);
                {
                  var C = q => {
                    ...
                    }), a(ee), T(nt => j(ee, "data-tip", nt), [() => Se()]), v(q, ee)
                  };
                  R(N, q => {
                    t(L).timedOut && q(C)
                  }, !0)
          ...
          var $ = p(V, 2),
            ...
            w = r(W);
          w.__click = async () => {
            await je(e.targets), document.activeElement.blur()
          };
          var D = r(w, !0);
          a(w), a(W);
          var P = p(W, 2);
          {
            var A = u => {
              var i = ja(),
                N = r(i);
              N.__click = async () => {
                await Ge(e.targets), document.activeElement.blur()
              };
              var C = r(N, !0);
              a(N), a(i), T(q => x(C, q), [() => Sa()]), v(u, i)
            };
            R(P, u => {
              e.targets.some(i => i.allianceId) && u(A)
            })
          }
          a($), a(H), a(o), T((u, i) => {
            ne(o, 1, `font-medium ${u??""} flex flex-wrap items-center gap-1.5`), x(l, t(L).name), x(h, `#${t(L).id??""}`), x(D, i)
          }, [() => oe(t(L).id), () => ka()]), v(s, o)
        };
        R(Ye, s => {
          t(L) && e.targets.length === 1 && s(Qe)
        })
      }
      a(ye), a(ie);
      var we = p(ie, 2);
          ...
          Le(d, 21, () => e.targets, g => g.id, (g, l) => {
            ...
            var H = p(I, 2);
            {
              var V = w => {
                var D = Ha(),
                  P = r(D, !0);
                a(D), T((A, u) => {
                  ne(D, 1, `badge badge-xs border-0 ${A??""} ${u??""}`), x(P, t(l).allianceName)
                }, [() => Ue(t(l).allianceId), () => oe(t(l).allianceId)]), v(w, D)
              };
              R(H, w => {
            ...
            var me = p(H, 2);
            {
              var $ = w => {
                  ...
                  }), a(D), T(A => j(D, "data-tip", A), [() => Be()]), v(w, D)
                },
                W = w => {
                  var D = ae(),
                    P = re(D);
                  {
                    var A = u => {
                      ...
                      }), a(i), T(C => j(i, "data-tip", C), [() => Se()]), v(u, i)
                    };
                    R(P, u => {
                      t(l).timedOut && u(A)
                    }, !0)
      ...
      a(pe), a(Te), a(b), vt(b, s => S(K, s), () => t(K)), T((s, o, d) => {
        ...
        const g = String(o.get("notes") ?? ""),
          l = e.targets.map(_ => _.id).filter(_ => _ !== 0);
        if (l.length === 0) {
          U.error(Z());
          return
        }
        try {
          if (S(O, !0), e.action === "report-user") {
            o.append("reportedUserId", String(l[0])), o.append("latitude", e.latLon[0].toString()), o.append("longitude", e.latLon[1].toString()), l.length > 1 && o.append("userIds", JSON.stringify(l));
            const _ = await e.image;
            o.append("image", _, `report-${Date.now()}.jpeg`);
            const z = await fetch(t(K).action, {
              method: "POST",
              body: o,
              credentials: "include"
            });
            ...
            const I = e.action === "ban" ? l.length > 1 ? zt() : Oe() : l.length > 1 ? Dt() : Ce();
            U.success(I), (h = e.onsuccess) == null || h.call(e, {
              action: e.action,
              userIds: [l[0]]
            }), k(!1)
          }
        } catch (_) {
          U.error((_ == null ? void 0 : _.message) ?? Z())
        } finally {
          S(O, !1)
        }
      }), _t(2, b, () => Et), v(y, b)
  ...
  a(he), it(2), a(G), ut(G, () => y => {
    Re(() => {
      k() ? y.show() : y.close()
    })
  }), ke("close", G, () => k(!1)), v(n, G), ct()
}
st(["click"]);
var Xa = Pe('<svg><path d="M480-320 280-520l56-58 104 104v-326h80v326l104-104 56 58-200 200ZM240-160q-33 0-56.5-23.5T160-240v-120h80v120h480v-120h80v120q0 33-23.5 56.5T720-160H240Z"></path></svg>');
...
export {
  zr as D, Lr as R, Pa as W, yr as a, Be as b, wr as c, kr as d, Oe as e, Z as f, Tr as l, Ir as p, qt as r, Rr as s, Ce as t
};