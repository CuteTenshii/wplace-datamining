...
const Ee = () => "Latest",
  ...
  Ue = (n = {}, e = {}) => {
    const t = e.locale ?? fe();
    return t === "en" ? Ee() : t === "pt" ? Oe() : t === "ch" ? je() : t === "de" ? Be() : t === "es" ? Fe() : t === "fr" ? De() : t === "it" ? Ne() : t === "jp" ? He() : t === "pl" ? We() : t === "ru" ? Ze() : t === "uk" ? Qe() : Ge()
  },
  Ye = () => "Patch notes",
...
var lt = (() => {
  ...
  Ft = f("reflink|nolink(?!\\()", "g").replace("reflink", Re).replace("nolink", Ae).getRegex(),
...
`, 1)[0],
                P;
              if (b = Z, this.options.pedantic ? (b = b.replace(this.rules.other.listReplaceNesting, "  "), P = b) : P = b.replace(this.rules.other.tabCharGlobal, "    "), ae.test(b) || ie.test(b) || Te.test(b) || $e.test(b) || T.test(b) || E.test(b)) break;
...
var bn = me('<span class="text-primary inline-flex items-center gap-1.5 text-[11px] font-semibold tracking-wide"><span class="relative flex size-1.5"><span class="bg-primary/60 absolute inline-flex size-full animate-ping rounded-full"></span> <span class="bg-primary relative inline-flex size-1.5 rounded-full"></span></span> </span>'),
  xn = me('<article><div class="flex items-center gap-3"><span class="text-primary text-lg font-bold tracking-wide"> </span> <!></div> <h2 class="mt-1 text-[0.9375rem] leading-snug font-bold tracking-tight"> </h2> <div class="patch-content mt-4 svelte-1pfqn89"></div></article>');
...
export {
  Gt as D, Cn as P, zn as W, Pn as a, $n as p, N as y
};