...
const s = () => "Our servers are down for maintenance. We should be back soon",
  ...
  m = () => "現在サーバーはメンテナンス中です。しばらくしてからまたお越しください。",
  f = () => "Nasze serwery są w trakcie konserwacji. Wkrótce wrócimy.",
  ...
  p = (n = {}, r = {}) => {
    const e = r.locale ?? t();
    return e === "en" ? s() : e === "pt" ? a() : e === "ch" ? o() : e === "de" ? i() : e === "es" ? c() : e === "fr" ? u() : e === "it" ? d() : e === "jp" ? m() : e === "pl" ? f() : e === "ru" ? _() : e === "uk" ? g() : l()
  };
export {
  p as m
};