...
try {
  (function() {
    var a = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new a.Error().stack;
    e && (a._sentryDebugIds = a._sentryDebugIds || {}, a._sentryDebugIds[e] = "2bdf6b0b-6be8-47c7-adbc-087285b24a69", a._sentryDebugIdIdentifier = "sentry-dbid-2bdf6b0b-6be8-47c7-adbc-087285b24a69")
  })()
} catch {}
...
var Vt = (a, e, r, s, m) => {
    _(e).show(), L(r, !0), $e.generatePixQrCode(s()).then(u => {
      L(m, u, !0)
    }).catch(u => {
      re.error(u.message)
    }).finally(() => {
    ...
    try {
      ...
      if (b) {
        const c = _(e).productId.toString(),
          i = (u = (m = (s = yt.products[c]) == null ? void 0 : s.items) == null ? void 0 : m[0]) == null ? void 0 : u.amount;
...
function Co(a, e) {
    ...
    S = n(t(h), 2);
  {
    var C = l => {
        ...
        const z = (F, v) => {
          ...
          var pt = n(ke, 2);
          {
            var vt = I => {
                ...
                var Ze = n(te, 2),
                  ue = t(Ze);
                ue.__click = [Vt, b, s, nt, c];
                var ft = t(ue);
                Qe(ft, {
                  class: "size-5"
                }), O(2), o(ue), o(Ze), o(ve), o(x), y(bt => {
                  Je(x, 1, `dropdown mt-3 ${lt()??""}`), w(ee, `R$${bt??""}`), ae(X, "action", `${Fe}/payment/create-checkout-session`), Le(P, Se()), D.disabled = _(s), ue.disabled = _(s)
              ...
              ut = I => {
                ...
                o(ee), o(x), y(() => {
                  ae(x, "action", `${Fe}/payment/create-checkout-session`), Le(T, Se()), ee.disabled = _(s)
                }), fe("submit", x, () => {
                  L(s, !0), setTimeout(() => L(s, !1), 3e3)
                }), d(I, x)
              };
          ...
          o(we), y((I, x) => {
            w(it, `${I??""} `), w(ct, `+${x??""} bonus`)
          }, [() => (J() + $()).toLocaleString("en-US"), () => $().toLocaleString("en-US")]), d(F, we)
        };
        var H = t(K),
          V = t(H);
        z(V, () => ({
      ...
      o(g), y((z, F, v, J) => w(Y, z), [() => Xe(), () => je(), () => Ne(Ae.url.origin), () => Oe()]), d(l, g)
    };
    M(S, l => {
      se.data && l(C)
    })
  ...
  var tt = n(ge, 2);
  {
    var ot = l => {
        ...
        var V = n(H, 2),
          ce = t(V);
        ce.__click = [eo, c], o(V), o(K), o(Y);
        var W = n(Y, 2),
          G = t(W);
        G.__click = [to, c, i], o(W), y(pe => {
  ...
  o(qe), o(Pe), o(Z), ht(Z, l => L(b, l), () => _(b)), y(l => w(Q, l), [() => Pt()]), fe("close", f, () => {
    r(!1)
  }), fe("close", Z, () => {
    setTimeout(() => {
      L(c, void 0)
