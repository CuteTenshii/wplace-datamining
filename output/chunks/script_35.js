...
function O(t = "", e = Y, s = J, a = Q) {
  const o = a(t),
    d = o % P * (360 / P);
  return [...Array(t ? 25 : 0)].reduce((f, I, l) => o & 1 << l % 15 ? f + `<rect x="${l>14?7-~~(l/5):~~(l/5)}" y="${l%5}" width="1" height="1"/>` : f, `<svg viewBox="-1.5 -1.5 8 8" xmlns="http://www.w3.org/2000/svg" fill="hsl(${d} ${e}% ${s}%)" shape-rendering="crispEdges">`) + "</svg>"
}
var k, r, m, c, u, T, z;
(k = globalThis.customElements) != null && k.get("minidenticon-svg") || (z = globalThis.customElements) == null || z.define("minidenticon-svg", (r = class extends HTMLElement {
  ...
  connectedCallback() {
    w(this, u, T).call(this), x(this, c, !0)
  }
  attributeChangedCallback() {
    p(this, c) && w(this, u, T).call(this)
  }
}, m = new WeakMap, c = new WeakMap, u = new WeakSet, T = function() {
  var o;
