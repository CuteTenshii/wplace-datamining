...
var Nt = (q, t, e) => t in q ? St(q, t, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: e
}) : q[t] = e;
var y = (q, t, e) => Nt(q, typeof t != "symbol" ? t + "" : t, e),
  tt = (q, t, e) => t.has(q) || At("Cannot " + e);
var V = (q, t, e) => (tt(q, t, "read from private field"), e ? e.call(q) : t.get(q)),
  ...
  B = (q, t, e) => (tt(q, t, "access private method"), e);
import {
  g as H,
  T as Et,
  t as Ct,
...
const Rt = () => "Download WPlace from the Google Play Store.",
  ...
  ne = (q = {}, t = {}) => {
    const e = t.locale ?? K();
    return e === "en" ? Rt() : e === "pt" ? Jt() : e === "ch" ? Kt() : e === "de" ? Qt() : e === "es" ? Zt() : e === "fr" ? Xt() : e === "it" ? Ht() : e === "jp" ? $t() : e === "pl" ? te() : e === "ru" ? ee() : e === "uk" ? qe() : re()
  },
  ...
  Te = () => "Перезагрузите страницу и попробуйте снова.",
  ve = () => "Перезавантажте сторінку та спробуйте ще раз.",
  De = () => "Hãy tải lại trang và thử lại.",
  Ie = (q = {}, t = {}) => {
    const e = t.locale ?? K();
    return e === "en" ? ye() : e === "pt" ? fe() : e === "ch" ? he() : e === "de" ? me() : e === "es" ? we() : e === "fr" ? Pe() : e === "it" ? Be() : e === "jp" ? be() : e === "pl" ? Ee() : e === "ru" ? Te() : e === "uk" ? ve() : De()
  },
  ...
  Me = () => "Dein Browser kann keine Google-Play-Käufe verarbeiten. Lege Google Chrome als Standardbrowser deines Geräts fest und öffne WPlace erneut, um Droplets zu kaufen.",
  Se = () => "Tu navegador no puede procesar compras de Google Play. Establece Google Chrome como navegador predeterminado del dispositivo y vuelve a abrir WPlace para comprar Droplets.",
  ...
  xe = (q = {}, t = {}) => {
    const e = t.locale ?? K();
    return e === "en" ? Ge() : e === "pt" ? ke() : e === "ch" ? je() : e === "de" ? Me() : e === "es" ? Se() : e === "fr" ? Ne() : e === "it" ? Ce() : e === "jp" ? Le() : e === "pl" ? ze() : e === "ru" ? Ue() : e === "uk" ? Ye() : Oe()
  },
  ...
  gt = (q = {}, t = {}) => {
    const e = t.locale ?? K();
    return e === "en" ? _e() : e === "pt" ? Fe() : e === "ch" ? We() : e === "de" ? Re() : e === "es" ? Je() : e === "fr" ? Ke() : e === "it" ? Qe() : e === "jp" ? Ze() : e === "pl" ? Xe() : e === "ru" ? He() : e === "uk" ? $e() : tq()
  },
...
const yq = "[object RegExp]",
  ...
  Mq = "[object Uint32Array]",
  Sq = "[object BigUint64Array]",
  Nq = "[object Int8Array]",
...
class Wq {
  constructor(t = {}) {
    ...
    e !== void 0 && (l(this, S, r), l(this, W, Tt(n => {
  ...
  get current() {
    var t;
    return (t = V(this, W)) == null || t.call(this), V(this, S) ? Fq(V(this, S)) : null
  }
}
...
var b, E, N, T, j, I, Q, m, G, C, R, J, Z, f, U, Y, st, Mt;
class jt {
  constructor(t, e, r = {}) {
    p(this, f);
    p(this, b);
    ...
    p(this, Z, t => {
      var e;
      t.key !== V(this, E) || t.newValue === null || (l(this, b, B(this, f, U).call(this, t.newValue)), (e = V(this, I)) == null || e.call(this))
    });
    const {
      storage: n = "local",
      serializer: a = {
    ...
    if (l(this, b, e), l(this, E, t), l(this, N, a), l(this, m, i), l(this, C, c), l(this, R, s), l(this, J, n), c === void 0) return;
    const u = Qq(n, c);
    l(this, T, u);
    const g = u.getItem(t);
    g !== null ? l(this, b, B(this, f, U).call(this, g)) : i && B(this, f, Y).call(this, e), B(this, f, st).call(this)
  }
  get current() {
    var e, r, n, a;
    ...
    let t;
    if (V(this, m)) {
      const s = (r = V(this, T)) == null ? void 0 : r.getItem(V(this, E));
      t = s ? B(this, f, U).call(this, s) : V(this, b)
    } else t = V(this, b);
    return kt(t, t, V(this, Q), (n = V(this, j)) == null ? void 0 : n.bind(this), (a = V(this, I)) == null ? void 0 : a.bind(this), B(this, f, Y).bind(this))
  }
  set current(t) {
    var e;
  ...
  disconnect() {
    var e, r;
    if (!V(this, m)) return;
    const t = (e = V(this, T)) == null ? void 0 : e.getItem(V(this, E));
    t && l(this, b, B(this, f, U).call(this, t)), l(this, m, !1), (r = V(this, T)) == null || r.removeItem(V(this, E)), B(this, f, Mt).call(this)
  }
  connect() {
    V(this, m) || (l(this, m, !0), B(this, f, Y).call(this, V(this, b)), B(this, f, st).call(this))
  }
}
b = new WeakMap, E = new WeakMap, N = new WeakMap, T = new WeakMap, j = new WeakMap, I = new WeakMap, Q = new WeakMap, m = new WeakMap, G = new WeakMap, C = new WeakMap, R = new WeakMap, J = new WeakMap, Z = new WeakMap, f = new WeakSet, U = function(t) {
  try {
    return V(this, N).deserialize(t)
  } catch (e) {
    console.error(`Error when parsing "${t}" from persisted store "${V(this,E)}"`, e);
    return
  }
}, Y = function(t) {
  var e;
  ...
  try {
    t !== void 0 && ((e = V(this, T)) == null || e.setItem(V(this, E), V(this, N).serialize(t)))
  } catch (r) {
    console.error(`Error when writing value from persisted store "${V(this,E)}" to ${V(this,T)}`, r)
  }
}, st = function() {
  !V(this, C) || !V(this, m) || l(this, j, Tt(t => (l(this, I, t), l(this, G, V(this, m) && V(this, R) && V(this, J) === "local" ? ot(V(this, C), "storage", V(this, Z)) : void 0), () => {
    var e;
...
const A = class A {
  ...
  static shouldRecover() {
    var t, e;
    return D() && ((t = A.checkout) == null ? void 0 : t.startedAt) && Date.now() - ((e = A.checkout) == null ? void 0 : e.startedAt) <= 3 * Et.day
  }
  static isRunning() {
    var t;
...
`))
  ...
  static async createPayment(t) {
    ...
    if (!((w = rt.data) != null && w.id)) throw new L("No user id");
    ...
    async function g() {
      ...
      if ((h = i == null ? void 0 : i.details) != null && h.purchaseToken) try {
        ...
        return await u("success"), await o.refresh(), d.openCheckoutDialog(M)
      } catch (M) {
        await u("fail", M)
      }
    }
  ...
  static isTWALoaded() {
    return !!(rt.data && o.service && o.forceTWA.current !== !1)
  }
  static async load() {
    var t;
    if (D()) {
  ...
  static async getPurchasesAfter() {
    ...
    return t ? (await et.listPlayPurchaseHistory()).purchases.sort((s, i) => Date.parse(i.updatedAt) - Date.parse(s.updatedAt)).filter(s => Date.parse(s.updatedAt) > t) : []
  }
  static get hasTWAFlag() {
    const t = new URLSearchParams(window.location.search).get("twa") ?? void 0;
    return V(this, X).has(t)
  }
  ...
  static printPriceBySKU(t) {
    ...
    const r = {
      value: ((n = qt(t)) == null ? void 0 : n.price) * zt / 100,
      currency: "USD"
    };
    return [r.currency, Number(r.value).toFixed(2)].join(" ")
  }
};
X = new WeakMap, y(o, "pattern", /^android-app:[/][/]([^/?]+)(.+)?$/), y(o, "forceTWA", new jt("twa:force_twa", void 0, {
  syncTabs: !1,
  storage: "session"
...
})), p(o, X, new Set([1, !0].map(String))), y(o, "onInit", async t => {
...
function lr(q) {
  ...
  if (c) {
    const [w, h, P, M] = c.split(",").map($ => parseFloat($));
    [w, h, P, M].every($ => Number.isFinite($)) && (t.area = {
      south: w,
      west: h,
      north: P,
      east: M
...
(q => {
  function t() {
    for (let r = 0; r < 50; r++) history.pushState({}, "");
    history.go(-49)
  }
  q.reset = t
})(Vt || (Vt = {}));
...
function dr() {
  ...
  if (D()) {
    history.length > 1 && Vt.reset(), queueMicrotask(async () => {
      await k.onInit(t)
    });
    const e = () => {
...
export {
  ar as A, d as T, k as a, Vr as b, xe as c, Aq as d, pr as e, lr as f, cr as g, cq as h, Ar as i, D as j, ur as l, ir as p, dr as s, sr as u, Jq as w
};