...
try {
  (function() {
    var f = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      r = new f.Error().stack;
    r && (f._sentryDebugIds = f._sentryDebugIds || {}, f._sentryDebugIds[r] = "b912c3d0-6233-408c-a981-8c3d450845ab", f._sentryDebugIdIdentifier = "sentry-dbid-b912c3d0-6233-408c-a981-8c3d450845ab")
  })()
} catch {}
let k = null;
...
function He(f, r, e, s, u, d = null) {
  ...
  function n() {
    Re(p, i, c, T, t, u, r, s, e), d !== null && (i.length === 0 ? o ? ne(o) : o = F(() => d(t)) : o !== null && Te(o, () => {
      o = null
    }))
  }
  se(() => {
    ...
    if (N) {
      for (var g = null, _, a = 0; a < v; a++) {
        ...
        var l = i[a],
          h = s(l, a);
        _ = P(S, c, g, null, l, h, a, u, r, e), c.items.set(h, _), g = _
      }
      v > 0 && q(K())
    }
    if (N) v === 0 && d && (o = F(() => d(t)));
      ...
      for (a = 0; a < v; a += 1) {
        ...
        D ? (r & (O | L)) !== 0 && ie(D, l, a, r) : (_ = P(null, c, null, null, l, h, a, u, r, e, !0), T.set(h, _)), C.add(h)
      }
...
function Re(f, r, e, s, u, d, t, c, m) {
  ...
  var b = (t & Ae) !== 0,
    ...
    g, _, a, l;
  if (b)
    for (l = 0; l < y; l += 1) g = r[l], _ = c(g, l), a = T.get(_), a !== void 0 && ((Q = a.a) == null || Q.measure(), (v ?? (v = new Set)).add(a));
  for (l = 0; l < y; l += 1) {
    if (g = r[l], _ = c(g, l), a = T.get(_), a === void 0) {
      ...
      if (h !== void 0) {
        ...
        n = P(M, e, n, n === null ? e.first : n.next, g, _, l, d, t, m)
      }
      T.set(_, n), E = [], w = [], i = n.next;
      continue
    }
    if (o && ie(a, g, l, t), (a.e.f & X) !== 0 && (ne(a.e), b && ((W = a.a) == null || W.unfix(), (v ?? (v = new Set)).delete(a))), a !== i) {
      if (p !== void 0 && p.has(a)) {
        if (E.length < w.length) {
          ...
          var H = E[0],
            Y = E[E.length - 1];
          for (I = 0; I < E.length; I += 1) B(E[I], D, u);
...
function P(f, r, e, s, u, d, t, c, m, b, o) {
  var y = k,
    T = (m & O) !== 0,
    x = (m & we) === 0,
    i = T ? x ? be(u, !1, !1) : j(u) : u,
    p = (m & L) === 0 ? t : j(t),
    n = {
      i: p,
      v: i,
  ...
  try {
    ...
    return n.e = F(() => c(f, i, p, b), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    k = y
  }
}
