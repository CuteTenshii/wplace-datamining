  ...
  for (l = 0; l < y; l += 1) {
    if (g = r[l], _ = c(g, l), a = T.get(_), a === void 0) {
      ...
      if (h !== void 0) {
        ...
        n = P(M, e, n, n === null ? e.first : n.next, g, _, l, d, t, b)
      }
      T.set(_, n), E = [], w = [], i = n.next;
      continue
    }
    if (o && ie(a, g, l, t), (a.e.f & X) !== 0 && (ne(a.e), m && ((W = a.a) == null || W.unfix(), (v ?? (v = new Set)).delete(a))), a !== i) {
      if (p !== void 0 && p.has(a)) {
...
function P(f, r, e, s, u, d, t, c, b, m, o) {
  var y = k,
    T = (b & O) !== 0,
    x = (b & we) === 0,
  ...
  try {
    ...
    return n.e = F(() => c(f, i, p, m), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    k = y
  }
}
