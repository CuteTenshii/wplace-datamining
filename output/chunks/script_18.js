...
try {
  (function() {
    var f = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      r = new f.Error().stack;
    r && (f._sentryDebugIds = f._sentryDebugIds || {}, f._sentryDebugIds[r] = "01f8ff69-4b9d-4d22-9019-c979022a88e5", f._sentryDebugIdIdentifier = "sentry-dbid-01f8ff69-4b9d-4d22-9019-c979022a88e5")
  })()
} catch {}
let B = null;
  ...
  se(() => {
    ...
    if (N) {
      for (var A = null, _, a = 0; a < v; a++) {
        ...
        var l = i[a],
          h = s(l, a);
        _ = W(M, c, A, null, l, h, a, u, r, e), c.items.set(h, _), A = _
      }
      v > 0 && V(Q())
    }
    if (N) v === 0 && d && (o = U(() => d(t)));
      ...
      for (a = 0; a < v; a += 1) {
        ...
        D ? (r & (O | L)) !== 0 && ie(D, l, a, r) : (_ = W(null, c, null, null, l, h, a, u, r, e, !0), w.set(h, _)), x.add(h)
      }
  ...
  for (l = 0; l < y; l += 1) {
    if (A = r[l], _ = c(A, l), a = w.get(_), a === void 0) {
      ...
      if (h !== void 0) {
        ...
        n = W(R, e, n, n === null ? e.first : n.next, A, _, l, d, t, m)
      }
      w.set(_, n), E = [], T = [], i = n.next;
      continue
    }
    if (o && ie(a, A, l, t), (a.e.f & k) !== 0 && (ne(a.e), b && ((z = a.a) == null || z.unfix(), (v ?? (v = new Set)).delete(a))), a !== i) {
      if (p !== void 0 && p.has(a)) {
...
function W(f, r, e, s, u, d, t, c, m, b, o) {
  var y = B,
    w = (m & O) !== 0,
    S = (m & Te) === 0,
