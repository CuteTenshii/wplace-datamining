...
function He(f, r, e, s, u, d = null) {
  ...
  function n() {
    Re(b, i, _, T, t, u, r, s, e), d !== null && (i.length === 0 ? o ? ne(o) : o = F(() => d(t)) : o !== null && Te(o, () => {
      o = null
    }))
  }
  se(() => {
...
function Re(f, r, e, s, u, d, t, _, m) {
  ...
  for (l = 0; l < y; l += 1) {
    ...
    if (o && ie(a, g, l, t), (a.e.f & X) !== 0 && (ne(a.e), E && ((W = a.a) == null || W.unfix(), (v ?? (v = new Set)).delete(a))), a !== i) {
      ...
      for (p = [], w = []; i !== null && i.k !== c;)(i.e.f & X) === 0 && (b ?? (b = new Set)).add(i), w.push(i), i = i.next;
      if (i === null) continue;
      a = i
    }
...
function P(f, r, e, s, u, d, t, _, m, E, o) {
  ...
  try {
    ...
    return n.e = F(() => _(f, i, b, E), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    k = y
  }
}
