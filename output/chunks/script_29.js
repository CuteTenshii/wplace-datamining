...
const vt = () => "Log Out",
  gt = () => "Log Out",
  Jr = (t = {}, e = {}) => (e.locale ?? l()) === "en" ? vt() : gt(),
  bt = () => "Copy",
  ht = () => "Copiar",
  Qr = (t = {}, e = {}) => (e.locale ?? l()) === "en" ? bt() : ht(),
  yt = () => "Report User",
  xt = () => "Reportar usuário",
...
export {
  nn as D, rn as R, wr as W, Jr as a, Lt as b, Qr as c, tn as d, $r as l, Xr as p, wt as r, en as s, Rt as t
};