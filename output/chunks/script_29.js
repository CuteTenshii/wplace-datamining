...
try {
  (function() {
    var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      o = new e.Error().stack;
    o && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[o] = "81094ca1-35d6-4d86-9edb-eab3065b5a57", e._sentryDebugIdIdentifier = "sentry-dbid-81094ca1-35d6-4d86-9edb-eab3065b5a57")
  })()
} catch {}
const Ee = 9,
  no = 95,
...
}, oe = new WeakMap, D = new WeakMap, H = new WeakSet, be = function() {
  var a;
  const r = A.observedAttributes.map(d => this.getAttribute(d) || void 0),
    t = r.join(",");
  this.innerHTML = (a = ae(A, oe))[t] ?? (a[t] = Be(...r))
}, Te(A, "observedAttributes", ["username", "saturation", "lightness"]), K(A, oe, {}), A));
var lo = xe("<div><!></div>");
...
function $o(e, o) {
  ...
  }), () => ro(Do("border-base-300 size-20 rounded-full border-2", o.class))]), ue(e, r), Ue()
}
export {
  $o as P, co as a, Do as t
};