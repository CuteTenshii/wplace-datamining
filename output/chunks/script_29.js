...
try {
  (function() {
    var r = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      s = new r.Error().stack;
    s && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[s] = "121f539d-e77f-4fef-933f-00f44c125632", r._sentryDebugIdIdentifier = "sentry-dbid-121f539d-e77f-4fef-933f-00f44c125632")
  })()
} catch {}
...
function Me(r, s) {
  ...
  const l = v => {
    ...
    e(c), w(Z => h(H, `${Z??""} `), [() => s.value.toLocaleString(navigator.language)]), n(v, c)
  };
...
function na(r, s) {
      ...
      var G = o(S, 2);
      {
        const q = (O, p) => {
            ...
            Ut = t(Tt);
          {
            var ie = I => {
              var m = qt();
              w(M => h(m, `${M??""} Droplets`), [() => at().toLocaleString(navigator.language)]), n(I, m)
            };
            P(Ut, I => {
              st() && I(ie)
            })
          ...
          var ve = o(Tt, 2);
          {
            var ce = I => {
                ...
                var At = o(rt, 2),
                  _t = t(At);
                _t.__click = () => {
                  f(b).show(), L(a, !0), jt.generatePixQrCode(re()).then(nt => {
                    L(i, nt, !0)
                  }).catch(nt => {
                    dt.error(nt.message)
                  }).finally(() => {
                ...
                Wt(ue, {
                  class: "size-5"
                }), Q(2), e(_t), e(At), e(gt), e(m), w(nt => {
                  $t(m, 1, `dropdown mt-3 ${le()??""}`), h(ot, `R$${nt??""}`), vt(N, "action", `${Ft}/payment/create-checkout-session`), Mt(z, Bt()), D.disabled = f(a), _t.disabled = f(a)
              ...
              pe = I => {
                ...
                e(ot), e(m), w(() => {
                  vt(m, "action", `${Ft}/payment/create-checkout-session`), Mt(M, Bt()), ot.disabled = f(a)
                }), xt("submit", m, () => {
                  L(a, !0), setTimeout(() => L(a, !1), 3e3)
                }), n(I, m)
              };
  ...
  var ae = o(kt, 2);
  {
    var se = d => {
        ...
        $.__click = async () => {
          ...
          try {
            ...
            if (j) {
              const et = f(i).productId.toString(),
                bt = (tt = (mt = (T = xe.products[et]) == null ? void 0 : T.items) == null ? void 0 : mt[0]) == null ? void 0 : tt.amount;
              await it.refresh(), bt ? Xt(`payment/success?droplets=${bt}`) : Xt("payment/success")
          ...
          h(ct, `R$${T??""}`), vt(ut, "src", f(i).qrCode), Mt(E, f(i).pixCode), $.disabled = f(v)
  ...
  e(Ht), e(Pt), e(A), ge(A, d => L(b, d), () => f(b)), w(d => h(W, d), [() => he()]), xt("close", u, () => {
    l(!1)
  }), xt("close", A, () => {
    setTimeout(() => {
      L(i, void 0)
...
function va(r, s) {
  ...
  var H = t(u, !0);
  e(u), e(a), w(C => {
    be(k, `--angle: ${f(l)??""}deg; --color: var(--color-secondary)`), g = $t(u, 1, "text-primary-content bg-secondary absolute bottom-0 flex items-center justify-center rounded-full px-[5px] py-0 text-xs font-bold", null, g, {
      "left-0": s.level > 99,
      "-left-1": s.level > 99
    }), h(H, C)
...
export {
  Ce as A, Me as D, ia as I, va as P, la as U, Dt as a, na as b, da as r
};