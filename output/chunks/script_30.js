...
function ps(o, t) {
  ...
  const e = _ => {
    ...
    a(u), B(q => j(H, `${q??""} `), [() => t.value.toLocaleString(navigator.language)]), s(_, u)
  };
...
function ut(o, t) {
  ...
  const e = C => {
          ...
          var D = c(I, 2);
          {
            var S = z => {
              ...
              var te = c(P, 2),
                ue = i(te, !0);
              a(te), a(b), B(() => {
                j(ce, t.receipt.total.label), j(ue, t.receipt.total.value)
              }), s(z, k)
            };
            A(D, z => {
              t.receipt.total && z(S)
      ...
      var xe = c(Ve, 2);
      {
        ...
        A(xe, d => {
          t.buttonRow ? d(Te) : t.primary && d(Be, 1)
        })
      }
      var Me = c(xe, 2);
      {
      ...
      a(ee), a(m), B(() => {
        Z = he(q, 1, "wp-badge svelte-ifq4hh", null, Z, {
...
function Ys(o, t) {
  ...
  const l = typeof navigator < "u" ? navigator.language : "en-US",
    h = u => u.toLocaleString(l),
    y = T(() => {
      var u;
      return (u = ve.data) == null ? void 0 : u.droplets
    }),
    w = T(() => n(y) !== void 0 ? {
      rows: r() ? [{
        label: Sr(),
...
function ri(o, t) {
  ...
  lt(() => {
    ...
    const m = L => {
      ...
      const F = (ee = L.data) == null ? void 0 : ee.fscPopupMessage;
      if (F) {
    ...
    return q.id = "fsc-api", q.src = "https://sbl.onfastspring.com/sbl/1.0.7/fastspring-builder.min.js", q.setAttribute("data-storefront", e), q.setAttribute("data-popup-webhook-received", "__fsp_wh__"), q.onload = async () => {
      const L = await je.meEmail();
      f.fastspring.builder.push({
        reset: !0,
        products: [{
...
function mi(o, t) {
  ...
  lt(async () => {
    ...
    try {
      r = await f.initEmbeddedCheckout({
        fetchClientSecret: async () => t.clientSecret,
        onComplete: async () => {
          var m;
          r == null || r.destroy(), r = void 0, v(l, !0), (m = t.onComplete) == null || m.call(t)
        }
      }), r.mount(e)
    } catch {
...
function al(o, t) {
  ...
  function F() {
    v(L, !0), localStorage.setItem(Z, "1"), v(q, !0), v(m, "other")
  }
  lt(() => {
    if (v(L, !!localStorage.getItem(Z)), !!localStorage.getItem("fscBackFromCheckout")) {
      localStorage.removeItem("fscBackFromCheckout");
      const U = Number(localStorage.getItem("wplace_fs_droplets")) || 0;
      history.replaceState({}, "", window.location.pathname), v(_, !0), ne(U)
    }
  });
  let ee = null;
  async function ne(M) {
    ...
    ee = U, v(_, !0);
    for (let Y = 0; Y < 2; Y++) {
      if (Y !== 0 && await new Promise(Q => setTimeout(Q, 2e3)), U.cancelled) {
        v(_, !1);
        return
      }
      try {
        const Q = await je.getLastFastspringOrder();
        if (!Q) continue;
        if (!Q.read) {
          if (U.cancelled) {
            v(_, !1);
          ...
          v(_, !1), v(w, !1), v(h, M, !0), v(y, !0), await ve.refresh(), await je.markFastspringOrderAsRead(Q.id);
          return
        }
      } catch {}
    }
    v(_, !1), U.cancelled || v(w, !0)
  }
  async function oe(M) {
    if (ee && (ee.cancelled = !0), v(u, M, !0), localStorage.setItem("wplace_fs_droplets", String(M.droplets + M.bonus)), n(L)) {
      v(m, "other"), v(q, !0), v(r, "checkout");
      return
    }
    v(m, "stripe"), v(l, !0);
    try {
      await (async U => {
        v(f, U.clientSecret, !0), v(E, U.sessionId, !0)
      })(await je.createEmbeddedCheckout(M.stripeLookupkey)), v(r, "checkout")
    } catch (U) {
      wt.error(U.message ?? "Unexpected error")
    } finally {
      v(l, !1)
    }
  }
  ...
  function ae() {
    v(r, "products"), v(u, null), v(f, null), v(E, null), localStorage.removeItem("wplace_fs_droplets")
  }
  async function se() {
    v(h, n(u).droplets + n(u).bonus);
    const M = n(E);
    ...
    R = i(x);
  {
    ...
    let U = T(() => n(r) === "products" ? "max-w-2xl" : "max-w-5xl max-h-[min(91.6vh,57rem)]"),
      Y = T(() => n(r) === "checkout" ? "px-0 sm:px-0 pt-0 pb-4" : ""),
      Q = T(() => n(r) === "products"),
      Ae = T(() => n(r) !== "checkout"),
      Ve = T(() => n(r) === "checkout"),
      $e = T(() => n(r) === "products");
    Qe(R, {
      ...
      onclose: () => {
        setTimeout(() => {
          v(r, "products"), v(u, null), v(f, null), v(E, null), v(m, "stripe"), v(q, !1)
        }, 100)
      },
      get open() {
        return e()
                  ...
                  var te = c(P, 2);
                  {
                    var ue = N => {
                      ...
                      ri(ke, {
                        ...
                        oncomplete: async ie => {
                          try {
                            const fe = n(u).droplets + n(u).bonus;
                            if (ie) {
                              const {
                                orderId: $
                              } = await je.refreshFastspringSession(ie);
                              await ve.refresh(), $ && await je.markFastspringOrderAsRead($), localStorage.removeItem("fscBackFromCheckout")
                            }
                            ae(), e(!1), v(h, fe), v(y, !0)
                          } catch {
                            wt.warning(os())
...
function cl([o, t], [e, r]) {
  ...
  let u = h - y,
    f = o,
    E = t;
  for (; l.push([f, E]), !(f === e && E === r);) {
    const H = 2 * u;
    H > -y && (u -= y, f += w), H < h && (u += h, E += _)
  }
  return l
}
