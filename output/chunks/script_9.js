const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["./CBjhvmFu.js", "./CX37corp.js", "./C76L4MyB.js"]))) => i.map(i => d[i]);
import {
  At as e,
  Ft as t,
  It as n,
...
var Ws = 6e3,
  ...
  qs = class {
    ...
    async request(e, t) {
      ...
      if (a.headers.get(`x-device-reattest`) && d(() => import(`./CBjhvmFu.js`).then(e => e.n).then(e => e.IOSAppServices.reattest()), __vite__mapDeps([0, 1, 2]), import.meta.url), a.status === I.FORBIDDEN && a.headers.get(`x-block-reason`) === `tor`) throw Error(f.tor_blocked());
