...
var it = `theme`,
  ...
  x = new class {
    ...
    set theme(e) {
      l(t(ht, this), e, !0), localStorage.setItem(it, e), document.documentElement.setAttribute(`data-theme`, e)
    }
    get now() {
      return i(t(gt, this))
    }
    get captcha() {
      return yt ? i(t(_t, this)) : {
    ...
    constructor() {
      r(this, at, c(!1)), r(this, ot, c(!1)), r(this, st, c(!1)), r(this, ct, c(!1)), r(this, lt, c(!1)), r(this, ut, c(0)), r(this, dt, c(!1)), r(this, ft, c(e(vt()))), r(this, pt, c(null)), r(this, mt, c(!1)), r(this, ht, c(`custom-winter`)), r(this, gt, c(e(Date.now()))), r(this, _t, c(void 0)), setInterval(() => {
        l(t(gt, this), Date.now(), !0)
...
var Ct = 3,
  ...
  S = new class {
    constructor() {
      r(this, wt, c(null)), r(this, Tt, c(0))
    }
    get current() {
      return i(t(wt, this))
    }
...
var Lt = new WeakMap,
  ...
  zt = class {
    ...
    constructor(e) {
      s(this, `url`, void 0), r(this, Lt, c(!0)), r(this, Rt, c(null)), this.url = e
    }
...
var Gn = typeof document < `u`,
  ...
  Xn = class {
    constructor() {
      r(this, qn, c(e([]))), r(this, Jn, c(e([]))), r(this, Yn, e => {
        ...
        let {
          message: n,
          ...r
        } = e, i = typeof(e == null ? void 0 : e.id) == `number` || e.id && ((t = e.id) == null ? void 0 : t.length) > 0 ? e.id : Kn++, o = e.dismissable === void 0 || e.dismissable, s = e.type === void 0 ? `default` : e.type;
        return a(() => {
        ...
        let n = t(Yn, this).call(this, e.toastId);
        if (n === null) {
          this.heights.push(e);
          return
        }
...
var $n = new WeakMap,
  er = class {
    constructor() {
      r(this, $n, n(() => I.toasts.filter(e => !e.dismiss)))
    }
    get toasts() {
      return i(t($n, this))
    }
...
var Or = class {
  constructor() {
    s(this, `interval`, void 0), s(this, `storagesEmpty`, !1), s(this, `storages`, [new Q, new Ar, new jr, new Mr]), s(this, `pawtectLoaded`, void 0), s(this, `pawtectError`, void 0)
  }
  init() {
...
s(Q, `KEY`, `ui_layout_v3`), s(Q, `XOR_KEY`, `wplace-prefs`);
var Ar = class e {
  get() {
    try {
...
s(Ar, `KEY`, `nav.cursor`), s(Ar, `SHIFT`, 13);
var jr = class e {
  get() {
...
s(jr, `KEY`, `_pf_uid`), s(jr, `MAX_AGE`, 31536e3);
var Mr = class {
    constructor() {
