...
try {
  (function() {
    var s = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new s.Error().stack;
    e && (s._sentryDebugIds = s._sentryDebugIds || {}, s._sentryDebugIds[e] = "76d68df2-2601-4386-a2bd-9fabe8d22a28", s._sentryDebugIdIdentifier = "sentry-dbid-76d68df2-2601-4386-a2bd-9fabe8d22a28")
  })()
} catch {}
...
function Co(s, e) {
  ...
  var tt = n(ge, 2);
  {
    var ot = l => {
        ...
        W.__click = [$t, c, i], o(V), y(pe => {
          w(le, `R$${pe??""}`), ae(de, "src", m(c).qrCode), Le(H, m(c).pixCode), W.disabled = m(i)
  ...
  o(qe), o(Pe), o(U), ht(U, l => L(_, l), () => m(_)), y(l => w(Q, l), [() => kt()]), fe("close", f, () => {
    r(!1)
  }), fe("close", U, () => {
    setTimeout(() => {
      L(c, void 0)
