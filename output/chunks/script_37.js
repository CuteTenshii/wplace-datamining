const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["./MlLQ9_xx.js", "./B6mxrfTb.js", "./DhUcoEdH.js", "./C_h5gzC1.js", "./CMBoreem.js", "./-d8bC4tg.js"]))) => i.map(i => d[i]);
import {
  At as e,
  Ct as t,
  D as n,
...
var I = k(`Haptics`, {
    web: () => T(() => import(`./MlLQ9_xx.js`).then(e => new e.HapticsWeb), __vite__mapDeps([0, 1, 2, 3, 4, 5]), import.meta.url)
  }),
  L, R = {
    success: {
      pattern: [{
...
var K = 0,
  q = (L = class e {
    constructor(e) {
      y(this, `hapticLabel`, null), y(this, `domInitialized`, !1), y(this, `instanceId`, void 0), y(this, `debug`, void 0), y(this, `showSwitch`, void 0), y(this, `rafId`, null), y(this, `patternResolve`, null), y(this, `audioCtx`, null), y(this, `audioFilter`, null), y(this, `audioGain`, null), y(this, `audioBuffer`, null), this.instanceId = ++K, this.debug = (e == null ? void 0 : e.debug) ?? !1, this.showSwitch = (e == null ? void 0 : e.showSwitch) ?? !1
    }
    async trigger(t = [{
      duration: 25,
      intensity: .7
  ...
  }, y(L, `isSupported`, typeof navigator < `u` && typeof navigator.vibrate == `function`), L),
  J = navigator.maxTouchPoints > 0 ? new q : null,
  Y = D.isNativePlatform() && D.isPluginAvailable(`Haptics`),
  X = {
    success: M.Success,
    warning: M.Warning,
    error: M.Error
...
function Z(e) {
  if (!A.haptics) return;
  let t = typeof e == `string` ? X[e] : void 0;
  if (!Y) {
    J == null || J.trigger(e);
    return
  }
...
function se(e = 1) {
  return e < .5 ? N.Light : e < .8 ? N.Medium : N.Heavy
}
...
async function ce(e) {
  for (let {
    ...
    of e) r && await Q(r), t >= oe ? await I.vibrate({
    duration: t
  }).catch(() => {}) : I.impact({
    style: se(n)
  }).catch(() => {}), await Q(t)
}
var le = new Set([`$$slots`, `$$events`, `$$legacy`, `value`, `fontSize`, `color`, `weight`, `mono`, `width`]),
  ue = f(`<canvas></canvas>`);

function $(t, n) {
  a(n, !0);
  let r = m(n, `width`, 15, 0),
    o = _(n, le),
    c = s(() => Math.ceil(n.fontSize)),
    u = e(null),
    d = window.devicePixelRatio ?? 1;
  C(() => {
    let e = b(u).getContext(`2d`);
    e.textBaseline = `top`, e.font = `${n.weight??`normal`} ${n.fontSize}px ${n.mono?`"Geist Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace`:`"Geist", ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"`}`, e.fillStyle = n.color ?? `#394e6a`, e.setTransform(d, 0, 0, d, 0, 0), e.clearRect(0, 0, r(), b(c)), e.fillText(n.value, 0, 0);
    let t = e.measureText(n.value);
    r(Math.ceil(t.actualBoundingBoxRight)), l(c, t.actualBoundingBoxDescent)
  });
  var f = ue();
  S(f, () => ({
    width: r() * d,
    height: b(c) * d,
    style: `width: ${r()??``}px; height: ${b(c)??``}px`,
    ...o
  })), g(f, e => l(u, e), () => b(u)), i(t, f), v()
}
var de = new Set([`$$slots`, `$$events`, `$$legacy`, `loading`, `charges`, `chargeMax`, `cooldownMs`, `showCooldown`, `maxWidth`, `compact`, `onclick`]),
  fe = f(`<span class="text-sm font-semibold tabular-nums opacity-90 sm:mt-px"> </span>`),
  pe = f(`<!> <div class="flex items-center gap-2 whitespace-nowrap"> <!></div>`, 1),
  me = f(`<span class="text-xl leading-none font-semibold" aria-hidden="true">&infin;</span>`),
  he = f(`<span><!></span>`),
  ge = f(`<span> </span>`),
  _e = f(`<span><!> <!></span>`),
  ve = f(`<!> <div><span> </span> <!></div>`, 1),
  ye = f(`<span class="loading loading-spinner center-absolute absolute"></span>`),
  be = f(`<button><div><!></div> <!></button>`);

function xe(f, y) {
  a(y, !0);
  let C = m(y, `showCooldown`, 3, !0),
    T = m(y, `compact`, 3, !1),
    D = _(y, de),
    k = e(0),
    M = e(void 0),
    N = e(void 0),
    I = s(() => y.cooldownMs ?? O.cooldown),
    L = s(() => A.theme === `dark` ? `rgba(255, 255, 255, 0.3)` : `#394e6a33`),
    R = s(() => {
      let e = O.timeoutUntil;
  ...
  F(() => [y.loading, y.maxWidth], () => {
    l(N, void 0), requestAnimationFrame(() => {
      if (!b(M)) return;
      let e = b(M).offsetWidth;
      !y.loading && y.maxWidth !== void 0 && e + 20 > y.maxWidth ? l(N, 16 * (y.maxWidth / e) * .8) : l(N, void 0)
    })
  });
  var B = be(),
    V = e => {
      var t;
      Z(`heavy`), (t = y.onclick) == null || t.call(y, e)
    };
  S(B, () => ({
    ...D,
    onclick: V,
    class: `btn btn-lg sm:btn-xl relative ${b(R)?b(R).isBan?`btn-error`:`btn-warning`:`btn-primary`} ${y.class??``}`,
    style: `max-width: ${y.maxWidth?`${y.maxWidth}px`:`none`}
	${b(N)?`;font-size: ${b(N)}px`:``}`
  }));
  var H = t(B);
  let U;
  var W = t(H),
    G = e => {
      ...
      var a = u(r, 2),
        ...
        l = e => {
          var n = fe(),
            r = t(n, !0);
          x(n), p(e => o(r, e), [() => z(b(R).countdown)]), i(e, n)
        };
      d(c, e => {
        b(R).countdown && e(l)
      }), x(a), p(e => o(s, `${e??``} `), [() => b(R).isBan ? j.banned() : j.timeout()]), i(e, n)
    },
    K = e => {
      var a = ve(),
        f = w(a);
      {
        let e = s(() => T() ? `size-6 shrink-0 max-sm:hidden` : `size-6`);
        P(f, {
          get class() {
            return b(e)
          }
      ...
      var v = u(g, 2),
        S = e => {
          let a = s(() => y.chargeMax ?? O.data.charges.max),
            c = s(() => y.chargeMax === void 0 && O.data.charges.infinite);
          var f = _e();
          let m;
          var h = t(f),
            g = e => {
            ...
            _ = e => {
              ...
              var u = t(o);
              {
                let e = s(() => T() ? `max-w-full object-contain` : void 0),
                  t = s(() => b(N) ?? 16),
                  n = s(() => `${Math.floor(y.charges)}/${b(a)}`),
                  r = s(() => y.disabled ? b(L) : `#ffffff`);
                $(u, {
                  get class() {
                    return b(e)
                  },
              ...
              x(o), p(e => {
                r(o, `width: ${e??``}px`), c = n(o, 1, ``, null, c, {
                  "min-w-0": T()
                })
              }, [() => (Math.floor(b(k) / 5) + 1) * 5]), i(e, o)
            };
          d(h, e => {
            b(c) ? e(g) : e(_, -1)
          });
          var v = u(h, 2),
            S = e => {
              ...
              var s = t(r);
              x(r), p(e => {
                a = n(r, 1, `w-7 text-xs`, null, a, {
                  "shrink-0": T()
                }), o(s, `(${e??``})`)
              }, [() => E(b(I))]), i(e, r)
            };
          d(v, e => {
            !b(c) && C() && y.charges < b(a) && b(I) !== void 0 && e(S)
          }), x(f), p(() => m = n(f, 1, `flex items-center gap-1 sm:mt-px`, null, m, {
            "min-w-0": T(),
            "max-w-full": T()
          })), i(e, f)
        };
      d(v, e => {
        y.charges !== void 0 && O.data && e(S)
      }), x(m), p((e, t) => {
        n(m, 1, c(T() ? `flex min-w-0 items-center gap-2 whitespace-nowrap max-sm:flex-col max-sm:gap-0` : `flex items-center gap-2 whitespace-nowrap`)), n(g, 1, c(T() ? `max-w-full truncate` : void 0)), h(g, `title`, e), o(_, t)
      }, [() => T() ? j.paint() : void 0, () => j.paint()]), i(e, a)
    };
  d(W, e => {
    b(R) ? e(G) : e(K, -1)
  }), x(H), g(H, e => l(M, e), () => b(M));
  ...
  d(q, e => {
    y.loading && e(J)
  }), x(B), p(() => U = n(H, 1, `flex items-center gap-1.5`, null, U, {
    "min-w-0": T(),
    "max-w-full": T()
  })), i(f, B), v()
}
export {
  Z as i, $ as n, ie as r, xe as t
};