...
const _e = le,
  ...
  Ce = () => "Eraser",
  Le = () => "Borracha",
  ca = (l = {}, a = {}) => (a.locale ?? pt()) === "en" ? Ce() : Le();
var Ie = R('<svg><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"></path></svg>');

function ze(l, a) {
  let s = W(a, ["$$slots", "$$events", "$$legacy"]);
  var o = Ie();
  A(o, () => ({
...
var Me = R('<svg><path d="M480-100q-133 0-226.5-92T160-416q0-63 24.5-120.5T254-638l226-222 226 222q45 44 69.5 101.5T800-416q0 132-93.5 224T480-100Z"></path></svg>');
...
var Pe = w('<span class="btn btn-xs btn-circle btn-primary ml-0.5 size-5"><!></span>'),
  qe = w('<span class="flex items-center gap-1"><!> <span class="text-primary text-base font-semibold"> <span class="text-xs max-sm:hidden">Droplets</span></span> <!></span>'),
  De = w('<button class="badge badge-lg border-base-content/10 right-tooltip cursor-pointer border-2 pl-1 pr-1"><!></button>'),
...
function Te(l, a) {
  ...
  const s = n => {
    ...
    e(i), z(T => I(q, `${T??""} `), [() => a.value.toLocaleString("en-US")]), v(n, i)
  };
...
var Ee = (l, a, s, o, _) => {
  ...
  je = (l, a) => {
    var s;
    navigator.clipboard.writeText(((s = b(a)) == null ? void 0 : s.pixCode) ?? ""), K.success("Código PIX copiado")
  },
  Oe = async (l, a, s) => {
    var o, _, p;
    if (!b(a)) {
...
function da(l, a) {
    ...
    y = r(t(u), 2);
  {
    var q = d => {
      ...
      {
        const L = (at, m) => {
          let Lt = () => m == null ? void 0 : m().droplets,
            ut = () => m == null ? void 0 : m().bonus,
            It = () => m == null ? void 0 : m().price,
            zt = () => m == null ? void 0 : m().stripeLookupkey,
            Kt = () => m == null ? void 0 : m().productId,
            Wt = () => m == null ? void 0 : m().dropdownClass;
          var mt = Re(),
            _t = t(mt),
            Mt = t(_t);
          yt(Mt, {
            ...
            qt = t(ft);
          {
            var Gt = k => {
              var g = ie();
              z(P => I(g, `${P??""} Droplets`), [() => Lt().toLocaleString("en-US")]), v(k, g)
            };
            S(qt, k => {
              ut() && k(Gt)
            })
          ...
          var $t = r(ft, 2);
          {
            var te = k => {
                ...
                var St = r(V, 2),
                  rt = t(St);
                rt.__click = [Ee, p, o, Kt, c];
                var oe = t(rt);
                Ht(oe, {
                  class: "size-5"
                }), U(2), e(rt), e(St), e(ot), e(g), z(se => {
                  Ft(g, 1, `dropdown mt-3 ${Wt()??""}`), I(Q, `R$${se??""}`), it(st, "action", `${Bt}/payment/create-checkout-session`), ht(bt, zt()), gt.disabled = b(o), rt.disabled = b(o)
                }, [() => (It() * 4).toFixed(2).replace(".", ",")]), lt("submit", st, () => {
              ...
              ee = k => {
                ...
                var Q = r(P, 2),
                  ot = t(Q);
                e(Q), e(g), z(V => {
                  it(g, "action", `${Bt}/payment/create-checkout-session`), ht(P, zt()), Q.disabled = b(o), I(ot, `$${V??""}`)
                }, [() => It().toFixed(2)]), lt("submit", g, () => {
                  C(o, !0), setTimeout(() => C(o, !1), 3e3)
                }), v(k, g)
              };
            S($t, k => {
          ...
          e(mt), z((k, g) => {
            I(Yt, `${k??""} `), I(Jt, `+${g??""} bonus`)
          }, [() => (Lt() + ut()).toLocaleString("en-US"), () => ut().toLocaleString("en-US")]), v(at, mt)
        };
        var E = t(j),
          O = t(E);
        L(O, () => ({
  ...
  var Xt = r(vt, 2);
  {
    var Nt = d => {
        ...
        var X = r(F, 2),
          N = t(X);
        N.__click = [Oe, c, f], e(X), z(et => {
          I(G, `R$${et??""}`), it($, "src", b(c).qrCode), ht(E, b(c).pixCode), N.disabled = b(f)
  ...
  e(kt), e(Y), e(D), pe(D, d => C(p, d), () => b(p)), z(d => I(T, d), [() => he()]), lt("close", i, () => {
    s(!1)
  }), lt("close", D, () => {
    setTimeout(() => {
      C(c, void 0)
...
var Ve = R('<svg><path d="M690-240h190v80H610l80-80Zm-500 80-85-85q-23-23-23.5-57t22.5-58l440-456q23-24 56.5-24t56.5 23l199 199q23 23 23 57t-23 57L520-160H190Z"></path></svg>'),
  Ke = R('<svg><path d="M690-240h190v80H610l80-80Zm-500 80-85-85q-23-23-23.5-57t22.5-58l440-456q23-24 56.5-24t56.5 23l199 199q23 23 23 57t-23 57L520-160H190Zm296-80 314-322-198-198-442 456 64 64h262Zm-6-240Z"></path></svg>');

function pa(l, a) {
  let s = W(a, ["$$slots", "$$events", "$$legacy", "filled"]);
  var o = Ut(),
    _ = dt(o);
  {
    var p = f => {
...
function va([l, a], [s, o]) {
  ...
  for (; _.push([u, y]), !(u === s && y === o);) {
    const q = 2 * i;
    q > -c && (i -= c, u += f), q < p && (i += p, y += n)
  }
  return _
}
var We = w('<img class="pixelated bg-base-200" alt="User profile"/>'),
  Ye = w('<div class="relative w-max"><div class="bg-base-content/20 size-12 rounded-full"></div> <div class="level-fill center-absolute absolute size-12 rotate-[215deg] rounded-full svelte-zhy0pt"></div> <div class="avatar center-absolute absolute"><div class="size-10 rounded-full"><!></div></div> <div> </div></div>');
...
function ua(l, a) {
  ...
  var q = t(u, !0);
  e(u), e(o), z((x, M) => {
    de(_, `--angle: ${b(s)??""}deg; --color: var(--color-secondary)`), y = Ft(u, 1, "text-primary-content bg-secondary absolute bottom-0 flex items-center justify-center rounded-full px-[5px] py-0 text-xs font-bold", null, y, x), I(q, M)
  }, [() => ({
    "left-0": a.level > 99,
    "-left-1": a.level > 99
