...
(function() {
  try {
    ...
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "4f8485e3-6e56-4abf-804f-d2f6ffee0156", t._sentryDebugIdIdentifier = "sentry-dbid-4f8485e3-6e56-4abf-804f-d2f6ffee0156")
  } catch {}
})();
const E = "true",
  A = "https://maps.wplace.live/styles/liberty",
...
class I {
  constructor() {
    ...
    s(this, u, n(p(_())));
    s(this, d, n(!1));
    s(this, h, n("custom-winter"));
    s(this, f, n(!0));
    s(this, c, n(p(Date.now())));
    s(this, b, n(void 0));
    setInterval(() => {
      o(a(this, c), Date.now(), !0)
  ...
  set theme(e) {
    o(a(this, h), e, !0), localStorage.setItem(L, e), document.documentElement.setAttribute("data-theme", e)
  }
...
l = new WeakMap, g = new WeakMap, u = new WeakMap, d = new WeakMap, h = new WeakMap, f = new WeakMap, c = new WeakMap, b = new WeakMap;
const B = new I;
