...
function Q(f, r, e, s, u, d, t, c, m, b, o) {
  var y = B,
    T = (m & O) !== 0,
    x = (m & we) === 0,
  ...
  try {
    ...
    return n.e = P(() => c(f, i, p, b), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    B = y
  }
}
