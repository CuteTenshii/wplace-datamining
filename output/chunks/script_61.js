...
- Added a toggle to hide or show pixel crosshairs while painting in alliance headquarters and the alliance asset editor.

## Improvements

- Redesigned Mobile Paint Mode to use less screen space, with painting tools arranged more compactly, a shorter collapsed panel, and a scrollable grid of square colors that leaves more room for the canvas.
- Improved the mobile Paint button to show Paint, cooldown, and current/max charges more clearly.
- Picking a premium color now keeps the palette compact and places the selected color at the start of the grid.

## Fixes

- The "Show only selected color pixels" preference now stays saved when opening or changing overlays.
- Fixed unwanted horizontal scrolling in the mobile color palette while keeping vertical scrolling available.
- Fixed the Pixel-art Studio moving with the last finger when finishing a pinch zoom. After a pinch, lift your fingers and touch again to pan.
`,
  fe = e({
    default: () => pe
  }),
...
- Increase horizontal padding on overlay build hud.
- Centralized gear icon on overlay build hud.
`,
  me = e({
    default: () => he
  }),
...
`,
  Le = Object.entries(Object.assign({
    ...
    "./markdown/1.4.5 - 🎨 Alliance Canvas Tools and Map Display.md": P,
    ...
    "./markdown/1.6.14 - 👨‍👩‍👧‍👦 Alliance Adjustments and Fixes.md": ve,
    "./markdown/1.6.15 - 🛠️ Push Notification Recovery.md": be,
    "./markdown/1.6.2 - 🖼️ Layer Opacity & Overlay Peek.md": Se,
    "./markdown/1.6.3 - 🖼️ Overlay Studio Reliability and Imports.md": we,
    "./markdown/1.6.4 - 🛠️ Alliance Award Eligibility.md": Ee,
    "./markdown/1.6.5 - 🎨 Overlay Studio and Alliance Tools.md": $,
    "./markdown/1.6.6 - 🛠️ Alliance Overlay Details.md": ke,
    "./markdown/1.6.7 - 🛠️ Overlay Performance and Alliance Reliability.md": je,
    "./markdown/1.6.8 - 🎨 Studio Controls and Event Wrap-up.md": Ne,
    "./markdown/1.6.9 - 🧑‍🎨 More Studio Tools and Collapsible Palette.md": Fe
  })).map(([e, t]) => {
    var n, r;
