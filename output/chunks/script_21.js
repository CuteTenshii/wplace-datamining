...
(function() {
  try {
    ...
    a && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[a] = "d72c9ee2-cfea-43e6-8a93-b54788d8f65a", e._sentryDebugIdIdentifier = "sentry-dbid-d72c9ee2-cfea-43e6-8a93-b54788d8f65a")
  } catch {}
})();
...
function xe(e, a, l, t, h, s = null) {
  ...
  var C = fe(() => {
      ...
      if (f === 0 && s && !r && (v ? r = V(() => s(u)) : (r = V(() => s(ee ?? (ee = F()))), r.f |= m)), f > _.size && ve(), k && f > 0 && z(W()), !v)
        if (D) {
