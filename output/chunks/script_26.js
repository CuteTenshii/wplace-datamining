...
function ve(t, e) {
  ...
  var D = b(_, 2);
  {
    var A = a => {
      var n = ne(),
        m = o(n, !0);
      l(n), x(() => h(m, e.max - s(d))), v(a, n)
    };
    E(D, a => {
      e.max !== void 0 && a(A)
    })
  }
  l(w), l(f), x(() => h(M, s(i))), B(u, r), v(t, f), C()
}
export {
