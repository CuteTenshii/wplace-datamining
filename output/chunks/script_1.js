...
try {
  (function() {
    var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      t = new e.Error().stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e8c1fdb7-319a-4291-84f1-91e9c6203b4e", e._sentryDebugIdIdentifier = "sentry-dbid-e8c1fdb7-319a-4291-84f1-91e9c6203b4e")
  })()
} catch {}
const q = [];
...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && Y.delete(Ve(e)), Zt(e, t));
const Y = new Map;
...
var gt;
const x = ((gt = globalThis.__sveltekit_evaboe) == null ? void 0 : gt.base) ?? "";
var mt;
const cn = ((mt = globalThis.__sveltekit_evaboe) == null ? void 0 : mt.assets) ?? x,
...
function lt() {}
let Ge, Oe, me, j, je, E;
globalThis.__sveltekit_evaboe.data;
const ye = [],
  _e = [];
let T = null;
const he = new Map,
...
async function nr(e, t, n) {
  ...
  n ? (r(), await Kn(je, n)) : (await X({
    type: "enter",
    url: qe(E.hash ? Yn(new URL(location.href)) : location.href),
    replace_state: !0
  }), r()), Hn()
}
...
async function Ye(e, t, n, a) {
  ...
  const s = await X({
    ...
    nav_token: a,
    accept: () => {
      t.invalidateAll && (We = !0, r = [...ut.keys()]), t.invalidate && t.invalidate.forEach(Gn)
    }
  });
...
async function Se({
  ...
  try {
    ...
    if (o instanceof Fe) return Ye(new URL(o.location, location.href), {}, 0);
    throw o
  }
}
async function Bn(e) {
...
async function X({
  ...
  if (h.type === "redirect")
    ...
    else return await Ye(new URL(h.location, t).href, {}, o + 1, c), !1;
  ...
  !a && !I && Wn(t), ft = !0, h.props.page && Object.assign(L, h.props.page), te = !1, e === "popstate" && Pt(U), f.fulfil(void 0), z.forEach(g => g(f.navigation)), $.navigating.set(Q.current = null)
}
...
function ar(e, t = {}) {
  return e = new URL(qe(e)), e.origin !== de ? Promise.reject(new Error("goto: invalid URL")) : Ye(e, t, 0)
}
...
function Hn() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", n => {
    ...
    if (p !== void 0 && y) {
      ...
      if (W = !0, Me(S), e(r), !c.replace_state) return;
      W = !1
    }
