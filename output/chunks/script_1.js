...
var ve;
const U = ((ve = globalThis.__sveltekit_127zkb6) == null ? void 0 : ve.base) ?? "";
var ye;
const dn = ((ye = globalThis.__sveltekit_127zkb6) == null ? void 0 : ye.assets) ?? U ?? "",
  hn = "1781558011880",
...
async function Gn(t, e, n) {
  var i, o, s, c;
  if (globalThis.__sveltekit_127zkb6.data) {
    const {
      q: l = {},
      p: f = {},
      l: h = {},
      f: _ = {}
    } = globalThis.__sveltekit_127zkb6.data;
...
async function H({
  ...
  if (Lt) {
    ...
    const Nt = k && await k;
    Nt ? L = Nt.commit() : (X = null, Ct.$set(p.props), X && Object.assign(p.props.page, X), Ie(p.props.page), L = (W = He) == null ? void 0 : W()), re = !0
