...
var ve;
const U = ((ve = globalThis.__sveltekit_1vpq117) == null ? void 0 : ve.base) ?? "";
var ye;
const dn = ((ye = globalThis.__sveltekit_1vpq117) == null ? void 0 : ye.assets) ?? U ?? "",
  hn = "1781830835217",
...
async function Gn(t, e, n) {
  var i, o, s, c;
  if (globalThis.__sveltekit_1vpq117.data) {
    const {
      q: l = {},
      p: f = {},
      l: h = {},
      f: _ = {}
    } = globalThis.__sveltekit_1vpq117.data;
...
async function H({
  ...
  if (Lt) {
    ...
    const Nt = k && await k;
    Nt ? L = Nt.commit() : (X = null, Ct.$set(p.props), X && Object.assign(p.props.page, X), Ie(p.props.page), L = (K = He) == null ? void 0 : K()), re = !0
