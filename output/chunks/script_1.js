...
try {
  (function() {
    var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new t.Error().stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "75ebed91-b1ae-499f-85a2-f06d21c0c331", t._sentryDebugIdIdentifier = "sentry-dbid-75ebed91-b1ae-499f-85a2-f06d21c0c331")
  })()
} catch {}
const q = [];
...
var ge;
const x = ((ge = globalThis.__sveltekit_1iad2tz) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_1iad2tz) == null ? void 0 : me.assets) ?? x,
...
function le() {}
let Gt, Ot, mt, j, jt, E;
globalThis.__sveltekit_1iad2tz.data;
const yt = [],
  _t = [];
let T = null;
const ht = new Map,
...
async function X({
  ...
  !a && !I && Kn(e), fe = !0, h.props.page && Object.assign(L, h.props.page), et = !1, t === "popstate" && Pe(U), f.fulfil(void 0), Y.forEach(g => g(f.navigation)), $.navigating.set(Q.current = null)
}
...
async function Hn(t, {
  ...
  try {
    const f = a.map(async (u, h) => {
        const A = o[h];
        return A != null && A.uses && (A.uses = Fe(A.uses)), Yt({
          loader: E.nodes[u],
          url: l,
          params: r,
          route: s,
