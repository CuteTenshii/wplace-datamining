...
try {
  (function() {
    var t = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      e = new t.Error().stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "a5557bd1-12fe-4fe0-a27c-34c05e9cdac9", t._sentryDebugIdIdentifier = "sentry-dbid-a5557bd1-12fe-4fe0-a27c-34c05e9cdac9")
  })()
} catch {}
const q = [];
...
window.fetch = (t, e) => ((t instanceof Request ? t.method : (e == null ? void 0 : e.method) || "GET") !== "GET" && z.delete(Vt(t)), Ze(t, e));
const z = new Map;
...
var ge;
const x = ((ge = globalThis.__sveltekit_14kw9yt) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_14kw9yt) == null ? void 0 : me.assets) ?? x,
...
function le() {}
let Gt, Ot, mt, j, jt, E;
globalThis.__sveltekit_14kw9yt.data;
const yt = [],
  _t = [];
let T = null;
const ht = new Map,
...
function vt({
  ...
  t.pathname = Ye(t.pathname, o), t.search = t.search;
  const c = {
    type: "loaded",
    state: {
      url: t,
...
function je({
  ...
  return et || Yt.forEach(o => o(i)), r ? null : s
}
async function X({
  type: t,
  url: e,
  ...
  if (!h) {
    ...
    h = await $e(e, {
      id: null
    }, await Y(new Bt(404, "Not Found", `Not found: ${e.pathname}`), {
      url: e,
      params: {},
      route: {
        id: null
...
function ar(t, e = {}) {
  return t = new URL(qt(t)), t.origin !== dt ? Promise.reject(new Error("goto: invalid URL")) : zt(t, e, 0)
}
