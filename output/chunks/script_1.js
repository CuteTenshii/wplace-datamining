...
var ge;
const x = ((ge = globalThis.__sveltekit_abgzg3) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_abgzg3) == null ? void 0 : me.assets) ?? x,
...
function le() {}
let Gt, Ot, mt, j, jt, A;
globalThis.__sveltekit_abgzg3.data;
const _t = [],
  yt = [];
let L = null;
const dt = new Map,
...
async function St({
  ...
  try {
    ...
    if (o instanceof Bt) return Wt(new URL(o.location, location.href), {}, 0);
    throw o
  }
}
async function Fn(t) {
...
async function X({
  ...
  if (!d) {
    ...
    d = await $e(e, {
      id: null
    }, await z(new Ft(404, "Not Found", `Not found: ${e.pathname}`), {
      url: e,
      params: {},
      route: {
        id: null
...
async function Hn(t, {
  ...
  try {
    const f = a.map(async (u, d) => {
        const E = o[d];
        return E != null && E.uses && (E.uses = Be(E.uses)), Yt({
          loader: A.nodes[u],
          url: l,
          params: r,
          route: s,
