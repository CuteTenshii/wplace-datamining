...
try {
  (function() {
    var e = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      t = new e.Error().stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "97069cfd-d055-4796-8e64-a59c7ec3ef37", e._sentryDebugIdIdentifier = "sentry-dbid-97069cfd-d055-4796-8e64-a59c7ec3ef37")
  })()
} catch {}
const M = [];
...
function De(e, t = Te) {
  ...
  function r(o) {
    if (Gt(e, o) && (e = o, n)) {
      const c = !M.length;
      for (const l of a) l[1](), M.push(l, e);
      if (c) {
...
var gt;
const x = ((gt = globalThis.__sveltekit_soef8e) == null ? void 0 : gt.base) ?? "";
var mt;
const cn = ((mt = globalThis.__sveltekit_soef8e) == null ? void 0 : mt.assets) ?? x,
...
function pe(e) {
  let t = null,
    ...
    i = null,
    o = e;
  for (; o && o !== document.documentElement;) a === null && (a = q(o, "preload-code")), r === null && (r = q(o, "preload-data")), t === null && (t = q(o, "keepfocus")), n === null && (n = q(o, "noscroll")), s === null && (s = q(o, "reload")), i === null && (i = q(o, "replacestate")), o = kt(o);
...
function fn() {
  ...
  async function a() {
    ...
    try {
      ...
      if (!r.ok) return !1;
      const i = (await r.json()).version !== Mt;
...
function lt() {}
let Ge, Oe, me, j, je, E;
globalThis.__sveltekit_soef8e.data;
const ye = [],
  _e = [];
let T = null;
const he = new Map,
...
async function nr(e, t, n) {
  ...
  n ? (r(), await Kn(je, n)) : (await X({
    type: "enter",
    url: Me(E.hash ? zn(new URL(location.href)) : location.href),
    replace_state: !0
  }), r()), Hn()
}
...
async function X({
  ...
  if (jn(), qe(m), xt(u), h.props.page.url.pathname !== t.pathname && (t.pathname = h.props.page.url.pathname), i = n ? n.state : i, !n) {
    const g = s ? 0 : 1,
      _ = {
        [G]: S += g,
        [Z]: U += g,
...
function ar(e, t = {}) {
  return e = new URL(Me(e)), e.origin !== de ? Promise.reject(new Error("goto: invalid URL")) : ze(e, t, 0)
}
...
function Hn() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", n => {
  ...
  }), (t = navigator.connection) != null && t.saveData || Mn(), j.addEventListener("click", async n => {
    ...
    if (p !== void 0 && y) {
      ...
      if (Y = !0, qe(S), e(r), !c.replace_state) return;
      Y = !1
    }
