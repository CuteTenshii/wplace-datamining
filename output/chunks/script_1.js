...
window.fetch = (t, e) => ((t instanceof Request ? t.method : (e == null ? void 0 : e.method) || "GET") !== "GET" && Y.delete(Ft(t)), Ze(t, e));
const Y = new Map;
...
var ge;
const x = ((ge = globalThis.__sveltekit_1510v5q) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_1510v5q) == null ? void 0 : me.assets) ?? x,
...
function le() {}
let Gt, Ot, mt, j, jt, A;
globalThis.__sveltekit_1510v5q.data;
const _t = [],
  yt = [];
let L = null;
const dt = new Map,
...
async function rr(t, e, n) {
  ...
  n ? (r(), await Kn(jt, n)) : (await X({
    type: "enter",
    url: Vt(A.hash ? Yn(new URL(location.href)) : location.href),
    replace_state: !0
  }), r()), Hn()
}
...
function or(t, e = {}) {
  return t = new URL(Vt(t)), t.origin !== ht ? Promise.reject(new Error("goto: invalid URL")) : Yt(t, e, 0)
}
