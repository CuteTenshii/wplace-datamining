...
var ge;
const T = ((ge = globalThis.__sveltekit_1w7x7b0) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_1w7x7b0) == null ? void 0 : me.assets) ?? T,
...
function le() {}
let Gt, Ot, mt, j, jt, A;
globalThis.__sveltekit_1w7x7b0.data;
const _t = [],
  wt = [];
let L = null;
const dt = new Map,
...
function Vn(t) {
  return Ke(A.hash ? t.hash.replace(/^#/, "").replace(/[?#].+/, "") : t.pathname.slice(T.length)) || "/"
}
...
async function X({
  ...
  let d = _ && await Oe(_);
  if (!d) {
    if (kt(e, T, A.hash)) return await K(e);
    d = await $e(e, {
      id: null
  ...
  !a && !I && Wn(e), fe = !0, d.props.page && Object.assign(U, d.props.page), et = !1, t === "popstate" && Pe(x), f.fulfil(void 0), z.forEach(g => g(f.navigation)), $.navigating.set(Q.current = null)
}
