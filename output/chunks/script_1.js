...
var ge;
const x = ((ge = globalThis.__sveltekit_1uwfkew) == null ? void 0 : ge.base) ?? "";
var me;
const cn = ((me = globalThis.__sveltekit_1uwfkew) == null ? void 0 : me.assets) ?? x,
...
function le() {}
let Gt, Ot, mt, j, jt, k;
globalThis.__sveltekit_1uwfkew.data;
const _t = [],
  wt = [];
let L = null;
const dt = new Map,
...
async function rr(t, e, n) {
  ...
  n ? (r(), await Kn(jt, n)) : (await X({
    type: "enter",
    url: qt(k.hash ? Yn(new URL(location.href)) : location.href),
    replace_state: !0
  }), r()), Hn()
}
...
async function Kn(t, {
  ...
  try {
    const f = a.map(async (u, d) => {
        const A = o[d];
        return A != null && A.uses && (A.uses = Be(A.uses)), zt({
          loader: k.nodes[u],
          url: l,
          params: r,
          route: s,
