...
function I(q) {
  let V = 0,
    ...
    o;
  return () => {
    M() && (E(A), n(() => (V === 0 && (o = m(() => q(() => w(A)))), V += 1, () => {
      u(() => {
        V -= 1, V === 0 && (o == null || o(), o = void 0, w(A))
      })
    })))
  }
}
const Y = "data:audio/mpeg;base64,",
  ...
  G = "" + new URL("../assets/notification.CPyrWqU1.mp3", import.meta.url).href,
...
function d() {
  const q = {
    ...
    bigPlop: new Audio(Y),
    smallDropplet: new Audio(T),
    droppletAndPlop: new Audio(c),
    notification1: new Audio(G)
  };
...
export {
  L as A, U as a, J as b, I as c, v as g, x as p, Q as s
};