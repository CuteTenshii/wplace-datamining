...
function i(q) {
  ...
  return new Promise((e, s) => {
    try {
      ...
      a || s(new Error("Service Workers are not supported/enabled in your browser. Some features might not work properly."));
      const r = t => {
        var o;
        ((o = t.data) == null ? void 0 : o.id) === V && (e(void 0), a.removeEventListener("message", r))
      };
