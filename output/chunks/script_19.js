...
function C(q) {
  return q == null || Tq.includes(typeof q) ? !0 : Array.isArray(q) ? q.every(V => C(V)) : typeof q == "object" ? Object.getPrototypeOf(q) === Object.prototype : !1
}
const S = Symbol("box"),
...
function IV(...q) {
  ...
  return typeof V.style == "object" && (V.style = $q(V.style).replaceAll(`
...
class AV {
  constructor(V = {}) {
    ...
    t !== void 0 && (y(this, w, e), y(this, b, aq(n => {
  ...
  get current() {
    var V;
    return (V = f(this, b)) == null || V.call(this), f(this, w) ? nV(f(this, w)) : null
  }
}
...
function xV(q, V) {
  return {
    [cq()]: t => Dq(q) ? (q.current = t, I(() => V == null ? void 0 : V(t)), () => {
      "isConnected" in t && t.isConnected || (q.current = null, V == null || V(null))
    }) : (q(t), I(() => V == null ? void 0 : V(t)), () => {
...
export {
  pV as A, mV as B, hq as C, bq as D, dV as a, TV as b, xV as c, YV as d, GV as e, CV as f, PV as g, EV as h, Mq as i, UV as j, bV as k, yV as l, IV as m, kV as n, $q as o, SV as p, LV as q, vV as r, DV as s, yq as t, MV as u, hV as v, rV as w, wV as x, BV as y, gV as z
};