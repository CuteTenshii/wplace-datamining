...
function i(q) {
  ...
  return new Promise((w, s) => {
    try {
      ...
      const g = a => {
        var A;
        ((A = a.data) == null ? void 0 : A.id) === V && (w(void 0), o.removeEventListener("message", g))
      };
      o.addEventListener("message", g);
      const r = navigator.serviceWorker.controller;
      r ? r.postMessage(e) : navigator.serviceWorker.ready.then(a => {
        const A = a.active;
...
export {
  Y as A, p as a, G as c, L as g, T as p, I as s
};