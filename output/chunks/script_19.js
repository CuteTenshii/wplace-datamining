...
function J(f, r, e, s, u, d, t, c, m, b, o) {
  var D = X,
    w = (m & O) !== 0,
    C = (m & Te) === 0,
  ...
  try {
    ...
    return n.e = G(() => c(f, i, p, b), N), n.e.prev = e && e.e, n.e.next = s && s.e, e === null ? o || (r.first = n) : (e.next = n, e.e.next = n.e), s !== null && (s.prev = n, s.e.prev = n.e), n
  } finally {
    X = D
  }
}
