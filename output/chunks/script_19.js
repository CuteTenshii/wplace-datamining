...
try {
  (function() {
    var q = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      V = new q.Error().stack;
    V && (q._sentryDebugIds = q._sentryDebugIds || {}, q._sentryDebugIds[V] = "c9585314-63af-4772-98c7-741644934924", q._sentryDebugIdIdentifier = "sentry-dbid-c9585314-63af-4772-98c7-741644934924")
  })()
} catch {}
...
function T() {
  const q = {
    plop: new Audio(Y),
    smallPlop: new Audio(G),
    bigPlop: new Audio(d),
    smallDropplet: new Audio(p),
    droppletAndPlop: new Audio(D),
...
function a(q) {
  ...
  return new Promise((e, s) => {
    try {
      ...
      i || s(new Error("Service Workers are not supported/enabled in your browser. Some features might not work properly."));
      const r = t => {
        var o;
        ((o = t.data) == null ? void 0 : o.id) === V && (e(void 0), i.removeEventListener("message", r))
      };
      i.addEventListener("message", r);
      const n = navigator.serviceWorker.controller;
      n ? n.postMessage(A) : navigator.serviceWorker.ready.then(t => {
        const o = t.active;
...
export {
  f as A, C as a, U as b, L as c, b as g, x as p, J as s
};