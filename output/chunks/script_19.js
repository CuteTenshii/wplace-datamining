...
try {
  (function() {
    var r = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {},
      i = new r.Error().stack;
    i && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[i] = "7c67736b-0128-4eeb-ac03-3c6563cef062", r._sentryDebugIdIdentifier = "sentry-dbid-7c67736b-0128-4eeb-ac03-3c6563cef062")
  })()
} catch {}
...
function Or(r, i, f, e, a = !1, t = !1) {
  ...
  for (const l in f) {
    ...
    if (l === "class") {
      ...
      Tr(r, N, c, e, i == null ? void 0 : i[T], f[T]), s[l] = c, s[T] = f[T];
      continue
    }
    if (l === "style") {
      Ir(r, c, i == null ? void 0 : i[I], f[I]), s[l] = c, s[I] = f[I];
      continue
    }
    var _ = s[l];
