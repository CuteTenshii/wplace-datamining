...
const qe = () => "Click to reveal",
  ...
  Da = () => "<strong>One account per person.</strong> Using bots, scripts, browser automation, or any exploit to gain an unfair advantage is strictly prohibited.<br>Painting in Wplace using <strong>virtual machines, residential proxies, multi-accounting browsers, or any automation tool</strong> is not advised and may lead to <strong>permanent bans</strong>.<br><br><strong>Warning:</strong> sharing a device with family or other people can cause accounts to be flagged as multi-accounting and result in suspension.",
  Pa = () => "<strong>Uma conta por pessoa.</strong> Usar bots, scripts, automação de navegador ou qualquer exploit para obter vantagem injusta é estritamente proibido.<br>Pintar no Wplace por meio de <strong>máquinas virtuais, proxies residenciais, navegadores multi-conta ou qualquer ferramenta de automação</strong> não é recomendado e pode levar a <strong>banimentos permanentes</strong>.<br><br><strong>Aviso:</strong> compartilhar um dispositivo com familiares ou outras pessoas pode fazer com que contas sejam sinalizadas como multi-contas e resultar em suspensão.",
  Sa = () => "<strong>每人只能使用一个账号。</strong>使用机器人、脚本、浏览器自动化或任何漏洞获取不公平优势的行为严格禁止。<br>不建议通过<strong>虚拟机、住宅代理、多账号浏览器或任何自动化工具</strong>在 Wplace 上绘画，此举可能导致<strong>永久封禁</strong>。<br><br><strong>警告：</strong>与家人或他人共用设备可能导致账号被标记为多账号并被封禁。",
  qa = () => "<strong>Ein Konto pro Person.</strong> Die Verwendung von Bots, Skripten, Browser-Automatisierung oder sonstigen Exploits, um einen unfairen Vorteil zu erlangen, ist strengstens verboten.<br>Das Malen in Wplace über <strong>virtuelle Maschinen, Residential-Proxys, Multi-Accounting-Browser oder andere Automatisierungstools</strong> wird nicht empfohlen und kann zu <strong>permanenten Sperren</strong> führen.<br><br><strong>Warnung:</strong> Wenn du ein Gerät mit Familienmitgliedern oder anderen Personen teilst, können Konten als Multi-Accounting markiert und gesperrt werden.",
  Ga = () => "<strong>Una cuenta por persona.</strong> Usar bots, scripts, automatización de navegador o cualquier exploit para obtener una ventaja injusta está estrictamente prohibido.<br>Pintar en Wplace mediante <strong>máquinas virtuales, proxies residenciales, navegadores multicuenta o cualquier herramienta de automatización</strong> no se recomienda y puede conllevar <strong>baneos permanentes</strong>.<br><br><strong>Advertencia:</strong> compartir un dispositivo con familiares u otras personas puede hacer que las cuentas sean marcadas como multicuenta y resulten en suspensión.",
  Ua = () => "<strong>Un seul compte par personne.</strong> L'utilisation de bots, de scripts, d'automatisation de navigateur ou de toute exploitation de faille pour obtenir un avantage déloyal est strictement interdite.<br>Peindre sur Wplace via <strong>des machines virtuelles, des proxys résidentiels, des navigateurs multi-comptes ou tout outil d'automatisation</strong> n'est pas recommandé et peut entraîner des <strong>bannissements permanents</strong>.<br><br><strong>Avertissement :</strong> partager un appareil avec sa famille ou d'autres personnes peut entraîner le signalement des comptes comme multi-comptes et leur suspension.",
  La = () => "<strong>Un account per persona.</strong> L'uso di bot, script, automazione del browser o qualsiasi exploit per ottenere un vantaggio sleale è severamente vietato.<br>Dipingere su Wplace tramite <strong>macchine virtuali, proxy residenziali, browser multi-account o qualsiasi strumento di automazione</strong> non è consigliato e può portare a <strong>ban permanenti</strong>.<br><br><strong>Attenzione:</strong> condividere un dispositivo con familiari o altre persone può far sì che gli account vengano segnalati come multi-account e portare a una sospensione.",
  Aa = () => "<strong>1人につき1アカウント。</strong>ボット、スクリプト、ブラウザ自動化、またはその他のエクスプロイトを使用して不当な優位を得ることは厳しく禁止されています。<br><strong>仮想マシン、住宅プロキシ、マルチアカウントブラウザ、その他の自動化ツール</strong>を使って Wplace で描画することは推奨されておらず、<strong>永久BAN</strong>につながる可能性があります。<br><br><strong>警告：</strong>家族や他の人とデバイスを共有すると、アカウントがマルチアカウントとして検出され、利用停止になる可能性があります。",
  Na = () => "<strong>Jedno konto na osobę.</strong> Używanie botów, skryptów, automatyzacji przeglądarki lub jakichkolwiek exploitów w celu uzyskania nieuczciwej przewagi jest surowo zabronione.<br>Malowanie w Wplace przy użyciu <strong>maszyn wirtualnych, proxy residential, przeglądarek multi-kontowych lub jakichkolwiek narzędzi automatyzacji</strong> jest odradzane i może prowadzić do <strong>permanentnych banów</strong>.<br><br><strong>Ostrzeżenie:</strong> dzielenie urządzenia z rodziną lub innymi osobami może spowodować oznaczenie kont jako multi-konta i ich zawieszenie.",
  Ma = () => "<strong>Один аккаунт на человека.</strong> Использование ботов, скриптов, автоматизации браузера или любых эксплойтов для получения нечестного преимущества строго запрещено.<br>Рисование в Wplace через <strong>виртуальные машины, резидентные прокси, мультиаккаунт-браузеры или любые инструменты автоматизации</strong> не рекомендуется и может привести к <strong>перманентной блокировке</strong>.<br><br><strong>Предупреждение:</strong> совместное использование устройства с членами семьи или другими людьми может привести к тому, что аккаунты будут помечены как мультиаккаунты и заблокированы.",
  Ia = () => "<strong>Один акаунт на людину.</strong> Використання ботів, скриптів, автоматизації браузера або будь-яких експлойтів для отримання нечесної переваги суворо заборонено.<br>Малювання у Wplace через <strong>віртуальні машини, резидентні проксі, мультиакаунт-браузери або будь-які інструменти автоматизації</strong> не рекомендується і може призвести до <strong>перманентного блокування</strong>.<br><br><strong>Попередження:</strong> спільне використання пристрою з родиною або іншими людьми може призвести до того, що акаунти будуть позначені як мультиакаунти та заблоковані.",
  Ra = () => "<strong>Mỗi người một tài khoản.</strong> Sử dụng bot, script, tự động hóa trình duyệt hoặc bất kỳ lỗi khai thác nào để có lợi thế không công bằng đều bị nghiêm cấm.<br>Vẽ trên Wplace thông qua <strong>máy ảo, proxy dân cư, trình duyệt đa tài khoản hoặc bất kỳ công cụ tự động hóa nào</strong> không được khuyến khích và có thể dẫn đến <strong>cấm vĩnh viễn</strong>.<br><br><strong>Cảnh báo:</strong> chia sẻ thiết bị với gia đình hoặc người khác có thể khiến tài khoản bị gắn cờ là đa tài khoản và dẫn đến đình chỉ.",
  Ba = (n = {}, r = {}) => {
    const e = r.locale ?? t();
