...
`,
  ke = Object.entries(Object.assign({
    ...
    "./markdown/1.6.2 - 🖼️ Layer Opacity & Overlay Peek.md": me,
    "./markdown/1.6.3 - 🖼️ Overlay Studio Reliability and Imports.md": ge,
    "./markdown/1.6.4 - 🛠️ Alliance Award Eligibility.md": ve,
    "./markdown/1.6.5 - 🎨 Overlay Studio and Alliance Tools.md": be,
    "./markdown/1.6.6 - 🛠️ Alliance Overlay Details.md": xe,
    "./markdown/1.6.7 - 🛠️ Overlay Performance and Alliance Reliability.md": Ce,
    "./markdown/1.6.8 - 🎨 Studio Controls and Event Wrap-up.md": Te,
    "./markdown/1.6.9 - 🧑‍🎨 More Studio Tools and Collapsible Palette.md": De
  })).map(([e, t]) => {
    var n, r;
