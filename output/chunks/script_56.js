...
`,
  ...
  o = `This update brings several improvements and fixes for a smoother experience:
...
`,
  ...
  c = `This patch focuses on interface stability across devices and a better moderation workflow:
...
`,
  ...
  u = `Import any image and position it over the map as a painting guide! Access overlays from the **new button in the main sidebar**.
...
`,
  ...
  f = `With v1.3.0, we’re reducing the moderation intervention and giving more freedom to the players to better match Wplace’s core idea: a living canvas shaped by the community.
...
`,
  re = Object.entries(Object.assign({
    ...
    "./markdown/1.1.2 - 🧰 UI Fixes & Moderation Improvements.md": s,
    "./markdown/1.2.0 - 🖼️ Pixel Overlays & Achievement Frames.md": l,
    "./markdown/1.3.0 - 🛠️ Moderation Adjustments, Hotspots and Improved Anti-Cheat System.md": d,
    "./markdown/1.3.1 - 🛠️  Hotfixes and Opt-out from Hotspots copy.md": p,
    "./markdown/1.3.2 - 🤖 Anti-cheat improvements and Google Drive overlay sync.md": h,
    "./markdown/1.3.3 - ⚽ World Cup Predictions and Cosmetics & Anti-cheat Improvements.md": _,
    "./markdown/1.4.0 - 🛡️ The New Alliance System.md": y,
    "./markdown/1.4.1 - 🛡️ Alliance System Fixes.md": x,
    "./markdown/1.4.10 - 🛠️ Mobile Overlay Rendering.md": C,
    "./markdown/1.4.11 - 🛠️ Phone Verification Fixes.md": T,
    "./markdown/1.4.12 - 🛠️ Alliance Overlay Reliability.md": D,
    "./markdown/1.4.2 - 🛠️ Headquarters Preview Reliability.md": k,
    "./markdown/1.4.3 - 🛠️ Alliance Usability Fixes.md": ee,
