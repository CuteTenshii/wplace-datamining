const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["./MxFa45x8.js", "./BF0ksztN.js", "./DhUcoEdH.js", "./4EQeTfjb.js", "./CdYDHRdK.js", "./-d8bC4tg.js"]))) => i.map(i => d[i]);
import {
  At as e,
  Ct as t,
  D as n,
...
var I = j(`Haptics`, {
    web: () => E(() => import(`./MxFa45x8.js`).then(e => new e.HapticsWeb), __vite__mapDeps([0, 1, 2, 3, 4, 5]), import.meta.url)
  }),
  L, R = {
    success: {
      pattern: [{
...
var K = 0,
  q = (L = class e {
    constructor(e) {
      b(this, `hapticLabel`, null), b(this, `domInitialized`, !1), b(this, `instanceId`, void 0), b(this, `debug`, void 0), b(this, `showSwitch`, void 0), b(this, `rafId`, null), b(this, `patternResolve`, null), b(this, `audioCtx`, null), b(this, `audioFilter`, null), b(this, `audioGain`, null), b(this, `audioBuffer`, null), this.instanceId = ++K, this.debug = (e == null ? void 0 : e.debug) ?? !1, this.showSwitch = (e == null ? void 0 : e.showSwitch) ?? !1
    }
    async trigger(t = [{
      duration: 25,
      intensity: .7
  ...
  }, b(L, `isSupported`, typeof navigator < `u` && typeof navigator.vibrate == `function`), L),
...
function Z(e) {
  if (!M.haptics) return;
  let t = typeof e == `string` ? ie[e] : void 0;
  if (!Y) {
    J == null || J.trigger(e);
    return
  }
...
async function le(e) {
  for (let {
    ...
    of e) r && await Q(r), t >= se ? await I.vibrate({
    duration: t
  }).catch(() => {}) : I.impact({
    style: ce(n)
  }).catch(() => {}), await Q(t)
}
var ue = new Set([`$$slots`, `$$events`, `$$legacy`, `value`, `fontSize`, `color`, `weight`, `mono`, `width`]),
  de = f(`<canvas></canvas>`);
...
function $(t, n) {
  ...
  C(f, () => ({
    width: r() * d,
    height: x(c) * d,
    style: `width: ${r()??``}px; height: ${x(c)??``}px`,
    ...o
  })), g(f, e => l(u, e), () => x(u)), i(t, f), y()
}
var fe = new Set([`$$slots`, `$$events`, `$$legacy`, `loading`, `charges`, `chargeMax`, `cooldownMs`, `showCooldown`, `maxWidth`, `compact`, `onclick`]),
  pe = f(`<span class="text-sm font-semibold tabular-nums opacity-90 sm:mt-px"> </span>`),
  me = f(`<!> <div class="flex items-center gap-2 whitespace-nowrap"> <!></div>`, 1),
  he = f(`<span class="paint-button-balance text-xl leading-none font-semibold svelte-naszew" aria-hidden="true">&infin;</span>`),
  ge = f(`<span><!></span>`),
  _e = f(`<span> </span>`),
  ve = f(`<span><!> <!></span>`),
  ye = f(`<!> <div><span> </span> <!></div>`, 1),
  be = f(`<span class="loading loading-spinner center-absolute absolute"></span>`),
  xe = f(`<button><div><!></div> <!></button>`);
...
function Se(f, b) {
  ...
  let w = m(b, `showCooldown`, 3, !0),
    ...
    L = s(() => M.theme === `dark` ? `rgba(255, 255, 255, 0.3)` : `#394e6a33`),
    R = s(() => {
  ...
  re(() => [b.loading, b.maxWidth], () => {
    l(F, void 0), requestAnimationFrame(() => {
      if (!x(P)) return;
      let e = x(P).offsetWidth;
      !b.loading && b.maxWidth !== void 0 && e + 20 > b.maxWidth ? l(F, 16 * (b.maxWidth / e) * .8) : l(F, void 0)
    })
  });
  var B = xe(),
    V = e => {
    ...
    G = e => {
      ...
      var a = u(r, 2),
        ...
        l = e => {
          var n = pe(),
            r = t(n, !0);
          S(n), p(e => o(r, e), [() => z(x(R).countdown)]), i(e, n)
        };
      d(c, e => {
        x(R).countdown && e(l)
      }), S(a), p(e => o(s, `${e??``} `), [() => x(R).isBan ? N.banned() : N.timeout()]), i(e, n)
    },
    K = e => {
      var a = ye(),
        f = T(a);
      {
        let e = s(() => E() ? `paint-button-brush size-6 shrink-0 max-sm:hidden` : `size-6`);
        te(f, {
          get class() {
            return x(e)
          }
        ...
        y = e => {
          ...
          var h = t(f),
            ...
            _ = e => {
              ...
              var u = t(o);
              {
                let e = s(() => E() ? `max-w-full object-contain` : void 0),
                  t = s(() => x(F) ?? 16),
                  n = s(() => `${Math.floor(b.charges)}/${x(a)}`),
                  r = s(() => b.disabled ? x(L) : `#ffffff`);
                $(u, {
                  get class() {
                    return x(e)
                  },
              ...
              S(o), p(e => {
                c = n(o, 1, `paint-button-balance svelte-naszew`, null, c, {
                  "min-w-0": E()
                }), r(o, `width: ${e??``}px`)
              }, [() => (Math.floor(x(j) / 5) + 1) * 5]), i(e, o)
            };
          d(h, e => {
            x(c) ? e(g) : e(_, -1)
          });
          ...
          }), S(f), p(() => m = n(f, 1, `paint-button-charges flex items-center gap-1 sm:mt-px svelte-naszew`, null, m, {
            "min-w-0": E(),
            "max-w-full": E()
          })), i(e, f)
        };
  ...
  d(q, e => {
    b.loading && e(J)
  }), S(B), p(() => U = n(H, 1, `paint-button-content flex items-center gap-1.5 svelte-naszew`, null, U, {
    "min-w-0": E(),
    "max-w-full": E()
  })), i(f, B), y()
}
export {
  Z as i, $ as n, X as r, Se as t
};